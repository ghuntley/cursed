...
// Targets: demonstrate_self_hosting in self_hosting_compiler/main.csd:450
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_self_hosting(buffer, data, size);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_self_hosting(data, 0);        // Zero size
        // demonstrate_self_hosting(data, 1);        // Single byte
        // demonstrate_self_hosting(data, size);     // Full size
        // demonstrate_self_hosting(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_self_hosting
