...
// Targets: test_validate_entity in stdlib/database_orm/test_database_orm.csd:348
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // test_validate_entity(cursed_code);
...
// Additional test functions for test_validate_entity
