...
// Targets: parse_examples in src/tools/doc_generator.rs:442
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test parse_examples with fuzzed input
    // Example: parse_examples(allocator, input);
    // Example: parse_examples(input, size);
...
// Additional test functions for parse_examples
