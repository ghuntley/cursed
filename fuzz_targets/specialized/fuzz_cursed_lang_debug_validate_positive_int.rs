...
// Targets: debug_validate_positive_int in stdlib/debug_tea/mod.csd:185
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // debug_validate_positive_int(cursed_code);
...
// Additional test functions for debug_validate_positive_int
