...
// Targets: validate_key_exchange_params in src/stdlib/packages/crypto_asymmetric/key_exchange.rs:143
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_key_exchange_params(cursed_code);
...
// Additional test functions for validate_key_exchange_params
