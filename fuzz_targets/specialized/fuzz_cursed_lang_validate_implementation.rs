...
// Targets: validate_implementation in src/type_system/generic_interfaces.rs:386
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_implementation(cursed_code);
...
// Additional test functions for validate_implementation
