...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test track_thread_destroyed with temp file
    // Example: track_thread_destroyed(temp_path);
    // Example: track_thread_destroyed(temp_path, data, size);
