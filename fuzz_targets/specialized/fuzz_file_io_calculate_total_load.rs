...
// Targets: calculate_total_load in src/runtime/preemptive_scheduler.rs:746
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test calculate_total_load with temp file
    // Example: calculate_total_load(temp_path);
    // Example: calculate_total_load(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // calculate_total_load(path);
}


// Additional test functions for calculate_total_load
