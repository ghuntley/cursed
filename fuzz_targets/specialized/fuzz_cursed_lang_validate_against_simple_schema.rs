...
// Targets: validate_against_simple_schema in stdlib/configz/mod_with_arrays.csd:499
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_against_simple_schema(cursed_code);
...
// Additional test functions for validate_against_simple_schema
