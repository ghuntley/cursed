...
// Targets: all_profiles in src/optimization/config.rs:848
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test all_profiles with temp file
    // Example: all_profiles(temp_path);
    // Example: all_profiles(temp_path, data, size);
...
// Additional test functions for all_profiles
