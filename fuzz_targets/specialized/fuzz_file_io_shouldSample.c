...
// Targets: shouldSample in src-zig/memory_profiler_aggregation.zig:657
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test shouldSample with temp file
    // Example: shouldSample(temp_path);
    // Example: shouldSample(temp_path, data, size);
...
// Additional test functions for shouldSample
