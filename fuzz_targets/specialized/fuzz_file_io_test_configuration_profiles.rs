...
// Targets: test_configuration_profiles in stdlib/testz/parallel_runner_config.csd:413
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_configuration_profiles with temp file
    // Example: test_configuration_profiles(temp_path);
    // Example: test_configuration_profiles(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // test_configuration_profiles(path);
}


// Additional test functions for test_configuration_profiles
