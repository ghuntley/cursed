...
// Targets: validate_plugin_config in stdlib/plugin_vibes/mod.csd:290
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_plugin_config(cursed_code);
...
// Additional test functions for validate_plugin_config
