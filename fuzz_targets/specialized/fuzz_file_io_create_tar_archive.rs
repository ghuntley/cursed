...
// Targets: create_tar_archive in stdlib/zip_zilla/mod.csd:93
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test create_tar_archive with temp file
    // Example: create_tar_archive(temp_path);
    // Example: create_tar_archive(temp_path, data, size);
...
// Additional test functions for create_tar_archive
