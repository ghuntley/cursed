...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test create_config_from_cli with temp file
    // Example: create_config_from_cli(temp_path);
    // Example: create_config_from_cli(temp_path, data, size);
