...
// Targets: demonstrate_complex_patterns in examples/type_switch_advanced.csd:524
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_complex_patterns(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_complex_patterns(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_complex_patterns(data, 0);        // Zero size
        // demonstrate_complex_patterns(data, 1);        // Single byte
        // demonstrate_complex_patterns(data, size);     // Full size
        // demonstrate_complex_patterns(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_complex_patterns
