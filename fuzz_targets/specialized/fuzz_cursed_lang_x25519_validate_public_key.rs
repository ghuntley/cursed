...
// Targets: x25519_validate_public_key in src/stdlib/packages/crypto_asymmetric/x25519.rs:210
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // x25519_validate_public_key(cursed_code);
...
// Additional test functions for x25519_validate_public_key
