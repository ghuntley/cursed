...
// Targets: template_with_unsafe_input in examples/html_escaping.csd:67
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // template_with_unsafe_input(cursed_code);
...
// Additional test functions for template_with_unsafe_input
