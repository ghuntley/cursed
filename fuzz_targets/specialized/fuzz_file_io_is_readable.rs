...
// Targets: is_readable in stdlib/fs/mod.csd:551
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test is_readable with temp file
    // Example: is_readable(temp_path);
    // Example: is_readable(temp_path, data, size);
...
// Additional test functions for is_readable
