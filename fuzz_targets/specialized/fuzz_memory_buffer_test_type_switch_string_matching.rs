...
// Targets: test_type_switch_string_matching in tests/type_switch_tests.rs:58
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // test_type_switch_string_matching(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // test_type_switch_string_matching(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // test_type_switch_string_matching(data, 0);        // Zero size
        // test_type_switch_string_matching(data, 1);        // Single byte
        // test_type_switch_string_matching(data, size);     // Full size
        // test_type_switch_string_matching(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for test_type_switch_string_matching
