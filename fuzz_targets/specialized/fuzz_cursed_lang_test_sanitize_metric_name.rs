...
// Targets: test_sanitize_metric_name in src/metrics/prometheus_exporter.rs:842
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // test_sanitize_metric_name(cursed_code);
...
// Additional test functions for test_sanitize_metric_name
