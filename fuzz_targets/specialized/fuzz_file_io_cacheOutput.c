...
// Targets: cacheOutput in src-zig/performance_optimizer.zig:81
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test cacheOutput with temp file
    // Example: cacheOutput(temp_path);
    // Example: cacheOutput(temp_path, data, size);
...
// Additional test functions for cacheOutput
