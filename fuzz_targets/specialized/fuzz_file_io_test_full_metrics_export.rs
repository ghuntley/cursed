...
// Targets: test_full_metrics_export in src/metrics/prometheus_test.rs:98
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_full_metrics_export with temp file
    // Example: test_full_metrics_export(temp_path);
    // Example: test_full_metrics_export(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // test_full_metrics_export(path);
}


// Additional test functions for test_full_metrics_export
