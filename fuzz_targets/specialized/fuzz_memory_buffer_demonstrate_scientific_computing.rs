...
// Targets: demonstrate_scientific_computing in examples/math_advanced_demo.csd:276
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_scientific_computing(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_scientific_computing(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_scientific_computing(data, 0);        // Zero size
        // demonstrate_scientific_computing(data, 1);        // Single byte
        // demonstrate_scientific_computing(data, size);     // Full size
        // demonstrate_scientific_computing(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_scientific_computing
