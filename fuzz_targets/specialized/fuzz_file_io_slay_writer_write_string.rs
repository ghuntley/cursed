...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test slay_writer_write_string with temp file
    // Example: slay_writer_write_string(temp_path);
    // Example: slay_writer_write_string(temp_path, data, size);
