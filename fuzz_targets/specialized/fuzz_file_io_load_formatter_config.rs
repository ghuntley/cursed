...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_formatter_config with temp file
    // Example: load_formatter_config(temp_path);
    // Example: load_formatter_config(temp_path, data, size);
