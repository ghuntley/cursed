...
// Targets: save_arm64_context in src/runtime/goroutine_context.rs:804
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test save_arm64_context with temp file
    // Example: save_arm64_context(temp_path);
    // Example: save_arm64_context(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // save_arm64_context(path);
}


// Additional test functions for save_arm64_context
