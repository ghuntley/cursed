...
// Targets: validate_timezone_conversion in stdlib/timez/timezone_database.csd:716
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_timezone_conversion(cursed_code);
...
// Additional test functions for validate_timezone_conversion
