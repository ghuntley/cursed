...
// Targets: append_file_simulation in stdlib/ioz_enhanced/mod.csd:392
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test append_file_simulation with temp file
    // Example: append_file_simulation(temp_path);
    // Example: append_file_simulation(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // append_file_simulation(path);
}


// Additional test functions for append_file_simulation
