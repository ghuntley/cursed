...
// Targets: test_file_create in stdlib/filesystem_complete/test_filesystem_complete.csd:28
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_file_create with temp file
    // Example: test_file_create(temp_path);
    // Example: test_file_create(temp_path, data, size);
...
// Additional test functions for test_file_create
