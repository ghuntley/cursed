...
// Targets: validate_pause_times in benchmarks/heap_stress_benchmark.rs:296
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_pause_times(cursed_code);
...
// Additional test functions for validate_pause_times
