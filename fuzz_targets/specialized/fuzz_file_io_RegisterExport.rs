...
// Targets: RegisterExport in stdlib/plug_vibes/mod.csd:535
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test RegisterExport with temp file
    // Example: RegisterExport(temp_path);
    // Example: RegisterExport(temp_path, data, size);
...
// Additional test functions for RegisterExport
