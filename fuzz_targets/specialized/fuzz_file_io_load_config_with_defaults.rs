...
// Targets: load_config_with_defaults in stdlib/configz/mod_complex.csd:578
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_config_with_defaults with temp file
    // Example: load_config_with_defaults(temp_path);
    // Example: load_config_with_defaults(temp_path, data, size);
...
// Additional test functions for load_config_with_defaults
