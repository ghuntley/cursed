...
// Targets: io_file_exists in stdlib/io_simple/mod_broken.csd:180
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test io_file_exists with temp file
    // Example: io_file_exists(temp_path);
    // Example: io_file_exists(temp_path, data, size);
