...
// Targets: saveToFile in stdlib/package_manager/mod.csd:164
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test saveToFile with temp file
    // Example: saveToFile(temp_path);
    // Example: saveToFile(temp_path, data, size);
