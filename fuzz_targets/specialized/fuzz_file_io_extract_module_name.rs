...
// Targets: extract_module_name in docs_production/html/api/generate_docs.csd:383
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test extract_module_name with temp file
    // Example: extract_module_name(temp_path);
    // Example: extract_module_name(temp_path, data, size);
