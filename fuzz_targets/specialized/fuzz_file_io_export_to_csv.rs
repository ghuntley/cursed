...
// Targets: export_to_csv in src/performance/visualization.rs:748
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test export_to_csv with temp file
    // Example: export_to_csv(temp_path);
    // Example: export_to_csv(temp_path, data, size);
...
// Additional test functions for export_to_csv
