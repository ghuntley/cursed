...
// Targets: validate_interface_hierarchy in src/type_system/interface_inheritance.rs:512
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_interface_hierarchy(cursed_code);
...
// Additional test functions for validate_interface_hierarchy
