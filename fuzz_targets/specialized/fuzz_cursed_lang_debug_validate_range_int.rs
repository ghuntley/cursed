...
// Targets: debug_validate_range_int in stdlib/debug_tea/mod.csd:176
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // debug_validate_range_int(cursed_code);
...
// Additional test functions for debug_validate_range_int
