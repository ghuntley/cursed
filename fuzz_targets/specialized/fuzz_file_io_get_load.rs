...
// Targets: get_load in src/runtime/preemptive_scheduler.rs:1281
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test get_load with temp file
    // Example: get_load(temp_path);
    // Example: get_load(temp_path, data, size);
...
// Additional test functions for get_load
