...
// Targets: create_test_program_with_imports in src/imports/tests.rs:55
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test create_test_program_with_imports with temp file
    // Example: create_test_program_with_imports(temp_path);
    // Example: create_test_program_with_imports(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // create_test_program_with_imports(path);
}


// Additional test functions for create_test_program_with_imports
