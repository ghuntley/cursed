...
// Targets: WriteData in stdlib/slay_io/test_slay_io.csd:57
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test WriteData with temp file
    // Example: WriteData(temp_path);
    // Example: WriteData(temp_path, data, size);
...
// Additional test functions for WriteData
