...
// Targets: load_runtime_config in stdlib/testz/parallel_runner_config.csd:92
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_runtime_config with temp file
    // Example: load_runtime_config(temp_path);
    // Example: load_runtime_config(temp_path, data, size);
...
// Additional test functions for load_runtime_config
