...
// Targets: is_file_check in stdlib/ioz_enhanced/mod.csd:157
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test is_file_check with temp file
    // Example: is_file_check(temp_path);
    // Example: is_file_check(temp_path, data, size);
...
// Additional test functions for is_file_check
