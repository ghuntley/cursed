...
// Targets: test_export_formats in src/ffi/profiling.rs:601
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_export_formats with temp file
    // Example: test_export_formats(temp_path);
    // Example: test_export_formats(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // test_export_formats(path);
}


// Additional test functions for test_export_formats
