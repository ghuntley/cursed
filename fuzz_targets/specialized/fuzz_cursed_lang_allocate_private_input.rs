...
// Targets: allocate_private_input in src/stdlib/packages/crypto_zk/circuit_builder.rs:206
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // allocate_private_input(cursed_code);
...
// Additional test functions for allocate_private_input
