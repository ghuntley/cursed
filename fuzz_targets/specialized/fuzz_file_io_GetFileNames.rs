...
// Targets: GetFileNames in stdlib/embed_that/mod.csd:117
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test GetFileNames with temp file
    // Example: GetFileNames(temp_path);
    // Example: GetFileNames(temp_path, data, size);
...
// Additional test functions for GetFileNames
