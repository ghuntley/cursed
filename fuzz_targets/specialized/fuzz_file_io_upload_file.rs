...
// Targets: upload_file in stdlib/package_manager/mod.csd:655
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test upload_file with temp file
    // Example: upload_file(temp_path);
    // Example: upload_file(temp_path, data, size);
