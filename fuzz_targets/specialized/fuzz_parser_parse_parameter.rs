...
// Targets: parse_parameter in stdlib/formatter/mod.csd:803
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test parse_parameter with fuzzed input
    // Example: parse_parameter(allocator, input);
    // Example: parse_parameter(input, size);
