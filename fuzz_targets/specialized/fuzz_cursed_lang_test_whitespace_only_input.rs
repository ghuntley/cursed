...
// Targets: test_whitespace_only_input in stdlib/formatter/test_formatter.csd:402
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // test_whitespace_only_input(cursed_code);
...
// Additional test functions for test_whitespace_only_input
