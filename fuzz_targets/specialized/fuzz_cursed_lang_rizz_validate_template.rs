...
// Targets: rizz_validate_template in stdlib/rizz_template/mod.csd:231
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // rizz_validate_template(cursed_code);
...
// Additional test functions for rizz_validate_template
