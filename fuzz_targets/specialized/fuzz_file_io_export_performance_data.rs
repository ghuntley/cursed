...
// Targets: export_performance_data in src/optimization/comprehensive_performance_system.rs:404
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test export_performance_data with temp file
    // Example: export_performance_data(temp_path);
    // Example: export_performance_data(temp_path, data, size);
...
// Additional test functions for export_performance_data
