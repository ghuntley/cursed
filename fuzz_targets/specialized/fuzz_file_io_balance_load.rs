...
// Targets: balance_load in src/runtime/async/scheduler.rs:663
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test balance_load with temp file
    // Example: balance_load(temp_path);
    // Example: balance_load(temp_path, data, size);
...
// Additional test functions for balance_load
