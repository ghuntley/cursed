...
// Targets: demonstrate_real_world_usage in examples/csv_mood_demo.csd:387
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_real_world_usage(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_real_world_usage(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_real_world_usage(data, 0);        // Zero size
        // demonstrate_real_world_usage(data, 1);        // Single byte
        // demonstrate_real_world_usage(data, size);     // Full size
        // demonstrate_real_world_usage(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_real_world_usage
