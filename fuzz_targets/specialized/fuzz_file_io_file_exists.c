...
// Targets: file_exists in src-zig/runtime_functions.zig:231
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test file_exists with temp file
    // Example: file_exists(temp_path);
    // Example: file_exists(temp_path, data, size);
...
// Additional test functions for file_exists
