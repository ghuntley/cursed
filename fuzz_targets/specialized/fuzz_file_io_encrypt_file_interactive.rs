...
// Targets: encrypt_file_interactive in examples/file_encryption.csd:126
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test encrypt_file_interactive with temp file
    // Example: encrypt_file_interactive(temp_path);
    // Example: encrypt_file_interactive(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // encrypt_file_interactive(path);
}


// Additional test functions for encrypt_file_interactive
