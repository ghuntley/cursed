...
// Targets: is_small_file in stdlib/ioz_enhanced/mod.csd:177
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test is_small_file with temp file
    // Example: is_small_file(temp_path);
    // Example: is_small_file(temp_path, data, size);
...
// Additional test functions for is_small_file
