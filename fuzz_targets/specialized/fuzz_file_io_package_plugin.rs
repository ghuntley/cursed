...
// Targets: package_plugin in stdlib/plugin_vibes/mod.csd:385
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test package_plugin with temp file
    // Example: package_plugin(temp_path);
    // Example: package_plugin(temp_path, data, size);
...
// Additional test functions for package_plugin
