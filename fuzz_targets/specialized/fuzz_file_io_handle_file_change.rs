...
// Targets: handle_file_change in examples/watch_build_example.csd:215
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test handle_file_change with temp file
    // Example: handle_file_change(temp_path);
    // Example: handle_file_change(temp_path, data, size);
...
// Additional test functions for handle_file_change
