...
// Targets: create_realistic_project_structure in examples/package_manager_usage_demo.rs:340
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // create_realistic_project_structure(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // create_realistic_project_structure(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // create_realistic_project_structure(data, 0);        // Zero size
        // create_realistic_project_structure(data, 1);        // Single byte
        // create_realistic_project_structure(data, size);     // Full size
        // create_realistic_project_structure(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for create_realistic_project_structure
