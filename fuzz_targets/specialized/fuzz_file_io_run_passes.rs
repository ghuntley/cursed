...
// Targets: run_passes in src/optimization/pgo/pgo_passes.rs:348
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test run_passes with temp file
    // Example: run_passes(temp_path);
    // Example: run_passes(temp_path, data, size);
...
// Additional test functions for run_passes
