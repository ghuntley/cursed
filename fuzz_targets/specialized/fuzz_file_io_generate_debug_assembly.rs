...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test generate_debug_assembly with temp file
    // Example: generate_debug_assembly(temp_path);
    // Example: generate_debug_assembly(temp_path, data, size);
