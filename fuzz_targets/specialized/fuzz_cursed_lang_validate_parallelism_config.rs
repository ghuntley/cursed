...
// Targets: validate_parallelism_config in stdlib/testz/parallel_runner_config.csd:192
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_parallelism_config(cursed_code);
...
// Additional test functions for validate_parallelism_config
