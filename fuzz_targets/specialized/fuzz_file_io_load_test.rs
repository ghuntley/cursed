...
// Targets: load_test in stdlib/performance_testing/mod.csd:5
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_test with temp file
    // Example: load_test(temp_path);
    // Example: load_test(temp_path, data, size);
...
// Additional test functions for load_test
