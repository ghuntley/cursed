...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test exported_cursed_print with temp file
    // Example: exported_cursed_print(temp_path);
    // Example: exported_cursed_print(temp_path, data, size);
