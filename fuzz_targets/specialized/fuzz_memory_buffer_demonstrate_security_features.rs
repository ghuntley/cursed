...
// Targets: demonstrate_security_features in examples/secure_metrics_example.rs:79
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_security_features(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_security_features(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_security_features(data, 0);        // Zero size
        // demonstrate_security_features(data, 1);        // Single byte
        // demonstrate_security_features(data, size);     // Full size
        // demonstrate_security_features(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_security_features
