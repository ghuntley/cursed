...
// Targets: benchmark_basic_memory_allocation in benchmarks/cursed/compiler/memory_usage_bench.csd:6
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // benchmark_basic_memory_allocation(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // benchmark_basic_memory_allocation(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // benchmark_basic_memory_allocation(data, 0);        // Zero size
        // benchmark_basic_memory_allocation(data, 1);        // Single byte
        // benchmark_basic_memory_allocation(data, size);     // Full size
        // benchmark_basic_memory_allocation(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for benchmark_basic_memory_allocation
