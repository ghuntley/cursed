...
// Targets: shutdown in src-zig/parallel_compilation.zig:551
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test shutdown with temp file
    // Example: shutdown(temp_path);
    // Example: shutdown(temp_path, data, size);
...
// Additional test functions for shutdown
