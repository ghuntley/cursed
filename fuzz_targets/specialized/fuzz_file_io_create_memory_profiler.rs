...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test create_memory_profiler with temp file
    // Example: create_memory_profiler(temp_path);
    // Example: create_memory_profiler(temp_path, data, size);
