...
// Targets: ws_validate_handshake_request in stdlib/websocketz/mod.csd:294
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // ws_validate_handshake_request(cursed_code);
...
// Additional test functions for ws_validate_handshake_request
