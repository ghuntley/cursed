...
// Targets: createSpan in src-zig/simple_diagnostics_integration.zig:69
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test createSpan with temp file
    // Example: createSpan(temp_path);
    // Example: createSpan(temp_path, data, size);
...
// Additional test functions for createSpan
