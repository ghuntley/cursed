...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test ws_connection_is_open with temp file
    // Example: ws_connection_is_open(temp_path);
    // Example: ws_connection_is_open(temp_path, data, size);
