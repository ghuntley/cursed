...
// Targets: did_open in src/lsp/minimal_server.rs:289
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test did_open with temp file
    // Example: did_open(temp_path);
    // Example: did_open(temp_path, data, size);
...
// Additional test functions for did_open
