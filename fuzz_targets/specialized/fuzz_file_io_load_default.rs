...
// Targets: load_default in src/package_manager/config.rs:301
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_default with temp file
    // Example: load_default(temp_path);
    // Example: load_default(temp_path, data, size);
...
// Additional test functions for load_default
