...
// Targets: debug_execute in src/tools/mod.rs:221
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test debug_execute with temp file
    // Example: debug_execute(temp_path);
    // Example: debug_execute(temp_path, data, size);
