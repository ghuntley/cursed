...
// Targets: demonstrate_basic_arithmetic in examples/stdlib_examples/mathz_example.csd:24
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_basic_arithmetic(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_basic_arithmetic(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_basic_arithmetic(data, 0);        // Zero size
        // demonstrate_basic_arithmetic(data, 1);        // Single byte
        // demonstrate_basic_arithmetic(data, size);     // Full size
        // demonstrate_basic_arithmetic(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_basic_arithmetic
