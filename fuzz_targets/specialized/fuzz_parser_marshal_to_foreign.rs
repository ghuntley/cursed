...
// Targets: marshal_to_foreign in src/ffi/multi_language.rs:596
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test marshal_to_foreign with fuzzed input
    // Example: marshal_to_foreign(allocator, input);
    // Example: marshal_to_foreign(input, size);
