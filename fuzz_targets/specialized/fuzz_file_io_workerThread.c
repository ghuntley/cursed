...
// Targets: workerThread in src-zig/windows_iocp_poller.zig:342
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test workerThread with temp file
    // Example: workerThread(temp_path);
    // Example: workerThread(temp_path, data, size);
...
// Additional test functions for workerThread
