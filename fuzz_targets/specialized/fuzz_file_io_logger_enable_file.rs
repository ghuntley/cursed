...
// Targets: logger_enable_file in stdlib/plugin_system/example_plugin.csd:349
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test logger_enable_file with temp file
    // Example: logger_enable_file(temp_path);
    // Example: logger_enable_file(temp_path, data, size);
...
// Additional test functions for logger_enable_file
