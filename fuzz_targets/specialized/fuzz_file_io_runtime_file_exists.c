...
// Targets: runtime_file_exists in src-zig/runtime_functions.zig:464
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test runtime_file_exists with temp file
    // Example: runtime_file_exists(temp_path);
    // Example: runtime_file_exists(temp_path, data, size);
...
// Additional test functions for runtime_file_exists
