...
// Targets: reload_configuration in examples/watch_build_example.csd:367
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test reload_configuration with temp file
    // Example: reload_configuration(temp_path);
    // Example: reload_configuration(temp_path, data, size);
...
// Additional test functions for reload_configuration
