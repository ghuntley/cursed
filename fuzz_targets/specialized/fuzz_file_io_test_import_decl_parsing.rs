...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_import_decl_parsing with temp file
    // Example: test_import_decl_parsing(temp_path);
    // Example: test_import_decl_parsing(temp_path, data, size);
