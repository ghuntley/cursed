...
// Targets: load_module in src/imports/module_loader.rs:80
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_module with temp file
    // Example: load_module(temp_path);
    // Example: load_module(temp_path, data, size);
