...
// Targets: yield_now in src/runtime/goroutine.rs:76
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test yield_now with temp file
    // Example: yield_now(temp_path);
    // Example: yield_now(temp_path, data, size);
...
// Additional test functions for yield_now
