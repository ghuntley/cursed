...
// Targets: is_ready in src/runtime/async/event_loop.rs:71
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test is_ready with temp file
    // Example: is_ready(temp_path);
    // Example: is_ready(temp_path, data, size);
...
// Additional test functions for is_ready
