...
// Targets: export_metrics in src/codegen/llvm/performance_monitor.rs:624
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test export_metrics with temp file
    // Example: export_metrics(temp_path);
    // Example: export_metrics(temp_path, data, size);
