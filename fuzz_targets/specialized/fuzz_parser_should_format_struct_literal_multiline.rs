...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test should_format_struct_literal_multiline with fuzzed input
    // Example: should_format_struct_literal_multiline(allocator, input);
    // Example: should_format_struct_literal_multiline(input, size);
