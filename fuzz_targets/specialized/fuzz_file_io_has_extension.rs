...
// Targets: has_extension in stdlib/path/mod.csd:440
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test has_extension with temp file
    // Example: has_extension(temp_path);
    // Example: has_extension(temp_path, data, size);
...
// Additional test functions for has_extension
