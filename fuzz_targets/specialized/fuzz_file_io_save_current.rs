...
// Targets: save_current in src/runtime/context_abstraction.rs:108
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test save_current with temp file
    // Example: save_current(temp_path);
    // Example: save_current(temp_path, data, size);
...
// Additional test functions for save_current
