...
// Targets: demonstrate_optimization in examples/math_advanced_demo.csd:55
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_optimization(buffer, data, size);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_optimization(data, 0);        // Zero size
        // demonstrate_optimization(data, 1);        // Single byte
        // demonstrate_optimization(data, size);     // Full size
        // demonstrate_optimization(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_optimization
