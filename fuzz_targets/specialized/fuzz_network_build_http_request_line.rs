...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test packet parsing
    // Test build_http_request_line with network data
    // Example: build_http_request_line(data, size);
    // Example: build_http_request_line(sockfd, data, size);
...
void test_socket_operations(const uint8_t *data, size_t size) {
    ...
    // build_http_request_line(sockfd, data, size);
