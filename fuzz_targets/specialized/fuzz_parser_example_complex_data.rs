...
// Targets: example_complex_data in stdlib/testz/examples.csd:31
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test example_complex_data with fuzzed input
    // Example: example_complex_data(allocator, input);
    // Example: example_complex_data(input, size);
...
// Additional test functions for example_complex_data
