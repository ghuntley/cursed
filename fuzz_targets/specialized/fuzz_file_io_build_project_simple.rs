...
// Targets: build_project_simple in stdlib/build_system_simple/mod.csd:24
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test build_project_simple with temp file
    // Example: build_project_simple(temp_path);
    // Example: build_project_simple(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // build_project_simple(path);
}


// Additional test functions for build_project_simple
