...
// Targets: Parsed in stdlib/hashtag/mod.csd:342
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test Parsed with fuzzed input
    // Example: Parsed(allocator, input);
    // Example: Parsed(input, size);
...
// Additional test functions for Parsed
