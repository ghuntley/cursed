...
// Targets: language_name in src/ffi/multi_language.rs:16
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test language_name with temp file
    // Example: language_name(temp_path);
    // Example: language_name(temp_path, data, size);
