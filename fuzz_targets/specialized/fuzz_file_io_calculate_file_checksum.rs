...
// Targets: calculate_file_checksum in stdlib/package_manager/registry_client.csd:574
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test calculate_file_checksum with temp file
    // Example: calculate_file_checksum(temp_path);
    // Example: calculate_file_checksum(temp_path, data, size);
