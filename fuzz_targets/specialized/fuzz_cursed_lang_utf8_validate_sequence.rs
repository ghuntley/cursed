...
// Targets: utf8_validate_sequence in stdlib/unicode/string_integration.csd:377
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // utf8_validate_sequence(cursed_code);
...
// Additional test functions for utf8_validate_sequence
