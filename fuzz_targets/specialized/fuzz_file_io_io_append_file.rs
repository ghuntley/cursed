...
// Targets: io_append_file in src/execution/runtime_functions.rs:884
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test io_append_file with temp file
    // Example: io_append_file(temp_path);
    // Example: io_append_file(temp_path, data, size);
...
// Additional test functions for io_append_file
