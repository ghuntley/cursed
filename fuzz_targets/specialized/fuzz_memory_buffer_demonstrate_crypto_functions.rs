...
// Targets: demonstrate_crypto_functions in examples/stdlib_docs_demo.csd:212
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_crypto_functions(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_crypto_functions(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_crypto_functions(data, 0);        // Zero size
        // demonstrate_crypto_functions(data, 1);        // Single byte
        // demonstrate_crypto_functions(data, size);     // Full size
        // demonstrate_crypto_functions(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_crypto_functions
