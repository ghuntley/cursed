...
// Targets: demonstrate_basic_type_switch in examples/type_switch_basic.csd:8
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_basic_type_switch(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_basic_type_switch(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_basic_type_switch(data, 0);        // Zero size
        // demonstrate_basic_type_switch(data, 1);        // Single byte
        // demonstrate_basic_type_switch(data, size);     // Full size
        // demonstrate_basic_type_switch(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_basic_type_switch
