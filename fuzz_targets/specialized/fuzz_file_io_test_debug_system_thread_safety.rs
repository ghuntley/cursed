...
// Targets: test_debug_system_thread_safety in src/runtime/debug_output_tests.rs:228
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_debug_system_thread_safety with temp file
    // Example: test_debug_system_thread_safety(temp_path);
    // Example: test_debug_system_thread_safety(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // test_debug_system_thread_safety(path);
}


// Additional test functions for test_debug_system_thread_safety
