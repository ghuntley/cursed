...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test demonstrate_basic_export with temp file
    // Example: demonstrate_basic_export(temp_path);
    // Example: demonstrate_basic_export(temp_path, data, size);
