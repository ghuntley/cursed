...
// Targets: unmarshal_from_foreign in src/ffi/multi_language.rs:627
// Risk Level: high
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test unmarshal_from_foreign with fuzzed input
    // Example: unmarshal_from_foreign(allocator, input);
    // Example: unmarshal_from_foreign(input, size);
