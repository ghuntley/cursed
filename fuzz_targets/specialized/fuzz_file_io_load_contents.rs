...
// Targets: load_contents in src/runtime/debug_manager.rs:186
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_contents with temp file
    // Example: load_contents(temp_path);
    // Example: load_contents(temp_path, data, size);
...
// Additional test functions for load_contents
