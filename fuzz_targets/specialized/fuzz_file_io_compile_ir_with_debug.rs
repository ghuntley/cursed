...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test compile_ir_with_debug with temp file
    // Example: compile_ir_with_debug(temp_path);
    // Example: compile_ir_with_debug(temp_path, data, size);
