...
// Targets: demonstrate_memory_management in examples/stdlib_docs_demo.csd:468
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_memory_management(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_memory_management(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_memory_management(data, 0);        // Zero size
        // demonstrate_memory_management(data, 1);        // Single byte
        // demonstrate_memory_management(data, size);     // Full size
        // demonstrate_memory_management(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_memory_management
