...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test construct_build_command with temp file
    // Example: construct_build_command(temp_path);
    // Example: construct_build_command(temp_path, data, size);
