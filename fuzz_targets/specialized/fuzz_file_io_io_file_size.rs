...
// Targets: io_file_size in src/execution/runtime_functions.rs:949
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test io_file_size with temp file
    // Example: io_file_size(temp_path);
    // Example: io_file_size(temp_path, data, size);
...
// Additional test functions for io_file_size
