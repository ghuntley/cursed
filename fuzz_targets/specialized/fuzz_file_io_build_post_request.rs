...
// Targets: build_post_request in stdlib/httpz/mod.csd:61
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test build_post_request with temp file
    // Example: build_post_request(temp_path);
    // Example: build_post_request(temp_path, data, size);
...
// Additional test functions for build_post_request
