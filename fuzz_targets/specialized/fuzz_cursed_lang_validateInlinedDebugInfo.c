...
// Targets: validateInlinedDebugInfo in src-zig/inlined_function_debug.zig:348
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validateInlinedDebugInfo(cursed_code);
...
// Additional test functions for validateInlinedDebugInfo
