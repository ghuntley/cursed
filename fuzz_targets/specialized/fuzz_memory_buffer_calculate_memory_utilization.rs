...
// Targets: calculate_memory_utilization in src/memory/adaptive_gc.rs:532
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // calculate_memory_utilization(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // calculate_memory_utilization(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // calculate_memory_utilization(data, 0);        // Zero size
        // calculate_memory_utilization(data, 1);        // Single byte
        // calculate_memory_utilization(data, size);     // Full size
        // calculate_memory_utilization(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for calculate_memory_utilization
