...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test tab_writer_pad_string with temp file
    // Example: tab_writer_pad_string(temp_path);
    // Example: tab_writer_pad_string(temp_path, data, size);
