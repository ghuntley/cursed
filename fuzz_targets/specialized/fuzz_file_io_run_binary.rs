...
// Targets: run_binary in benchmarks/cursed/compiler/compilation_speed_bench.csd:463
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test run_binary with temp file
    // Example: run_binary(temp_path);
    // Example: run_binary(temp_path, data, size);
...
// Additional test functions for run_binary
