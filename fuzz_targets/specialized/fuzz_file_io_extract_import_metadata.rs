...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test extract_import_metadata with temp file
    // Example: extract_import_metadata(temp_path);
    // Example: extract_import_metadata(temp_path, data, size);
