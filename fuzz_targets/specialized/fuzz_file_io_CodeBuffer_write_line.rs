...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test CodeBuffer_write_line with temp file
    // Example: CodeBuffer_write_line(temp_path);
    // Example: CodeBuffer_write_line(temp_path, data, size);
