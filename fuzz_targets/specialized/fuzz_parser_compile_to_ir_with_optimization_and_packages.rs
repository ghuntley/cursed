...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test compile_to_ir_with_optimization_and_packages with fuzzed input
    // Example: compile_to_ir_with_optimization_and_packages(allocator, input);
    // Example: compile_to_ir_with_optimization_and_packages(input, size);
