...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test demonstrate_complex_patterns with fuzzed input
    // Example: demonstrate_complex_patterns(allocator, input);
    // Example: demonstrate_complex_patterns(input, size);
