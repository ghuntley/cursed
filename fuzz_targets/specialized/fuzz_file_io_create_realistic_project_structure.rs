...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test create_realistic_project_structure with temp file
    // Example: create_realistic_project_structure(temp_path);
    // Example: create_realistic_project_structure(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // create_realistic_project_structure(path);
}
