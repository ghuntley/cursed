...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_config_from_string with temp file
    // Example: load_config_from_string(temp_path);
    // Example: load_config_from_string(temp_path, data, size);
