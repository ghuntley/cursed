...
// Targets: validateVariableDeclaration in simple_type_check_demo.zig:87
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validateVariableDeclaration(cursed_code);
...
// Additional test functions for validateVariableDeclaration
