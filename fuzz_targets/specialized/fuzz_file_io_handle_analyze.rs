...
// Targets: handle_analyze in src/cli/debug_cli.rs:297
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test handle_analyze with temp file
    // Example: handle_analyze(temp_path);
    // Example: handle_analyze(temp_path, data, size);
...
// Additional test functions for handle_analyze
