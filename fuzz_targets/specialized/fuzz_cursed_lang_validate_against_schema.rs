...
// Targets: validate_against_schema in stdlib/configz/mod_complex.csd:197
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_against_schema(cursed_code);
...
// Additional test functions for validate_against_schema
