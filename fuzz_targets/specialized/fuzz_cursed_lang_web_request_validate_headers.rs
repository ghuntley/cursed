...
// Targets: web_request_validate_headers in stdlib/web/mod.csd:1113
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // web_request_validate_headers(cursed_code);
...
// Additional test functions for web_request_validate_headers
