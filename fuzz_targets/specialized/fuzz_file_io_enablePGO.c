...
// Targets: enablePGO in src-zig/optimization_engine.zig:130
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test enablePGO with temp file
    // Example: enablePGO(temp_path);
    // Example: enablePGO(temp_path, data, size);
...
// Additional test functions for enablePGO
