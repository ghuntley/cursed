...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test save_config_to_string with temp file
    // Example: save_config_to_string(temp_path);
    // Example: save_config_to_string(temp_path, data, size);
