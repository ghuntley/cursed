...
// Targets: demonstrate_signal_processing in examples/math_advanced_demo.csd:89
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_signal_processing(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_signal_processing(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_signal_processing(data, 0);        // Zero size
        // demonstrate_signal_processing(data, 1);        // Single byte
        // demonstrate_signal_processing(data, size);     // Full size
        // demonstrate_signal_processing(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_signal_processing
