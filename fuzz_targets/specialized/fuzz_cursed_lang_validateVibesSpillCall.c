...
// Targets: validateVibesSpillCall in simple_type_check_demo.zig:110
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validateVibesSpillCall(cursed_code);
...
// Additional test functions for validateVibesSpillCall
