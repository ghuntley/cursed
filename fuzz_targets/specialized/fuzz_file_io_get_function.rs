...
// Targets: get_function in src/ffi/wasm_bridge.rs:88
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test get_function with temp file
    // Example: get_function(temp_path);
    // Example: get_function(temp_path, data, size);
