...
// Targets: link_executable in src/build_system/build_pipeline.rs:678
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test link_executable with temp file
    // Example: link_executable(temp_path);
    // Example: link_executable(temp_path, data, size);
...
// Additional test functions for link_executable
