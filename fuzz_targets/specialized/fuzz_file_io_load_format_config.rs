...
// Targets: load_format_config in stdlib/formatter/cli_integration.csd:131
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_format_config with temp file
    // Example: load_format_config(temp_path);
    // Example: load_format_config(temp_path, data, size);
...
// Additional test functions for load_format_config
