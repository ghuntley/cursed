...
// Targets: load_effective_config in stdlib/formatter/formatter_cli.csd:160
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_effective_config with temp file
    // Example: load_effective_config(temp_path);
    // Example: load_effective_config(temp_path, data, size);
...
// Additional test functions for load_effective_config
