...
// Targets: demonstrate_numerical_methods in examples/math_comprehensive_demo.csd:310
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_numerical_methods(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_numerical_methods(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_numerical_methods(data, 0);        // Zero size
        // demonstrate_numerical_methods(data, 1);        // Single byte
        // demonstrate_numerical_methods(data, size);     // Full size
        // demonstrate_numerical_methods(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_numerical_methods
