...
// Targets: check_unused_imports in src/tools/linter.rs:1989
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test check_unused_imports with temp file
    // Example: check_unused_imports(temp_path);
    // Example: check_unused_imports(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // check_unused_imports(path);
}


// Additional test functions for check_unused_imports
