...
// Targets: is_abs in stdlib/filesystem_complete/mod.csd:802
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test is_abs with temp file
    // Example: is_abs(temp_path);
    // Example: is_abs(temp_path, data, size);
...
// Additional test functions for is_abs
