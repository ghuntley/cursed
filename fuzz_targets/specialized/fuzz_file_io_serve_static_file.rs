...
// Targets: serve_static_file in stdlib/web_vibez/mod.csd:628
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test serve_static_file with temp file
    // Example: serve_static_file(temp_path);
    // Example: serve_static_file(temp_path, data, size);
