...
// Targets: is_applicable in src/optimization/pgo/pgo_passes.rs:302
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test is_applicable with temp file
    // Example: is_applicable(temp_path);
    // Example: is_applicable(temp_path, data, size);
...
// Additional test functions for is_applicable
