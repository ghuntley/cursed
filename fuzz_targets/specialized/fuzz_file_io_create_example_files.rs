...
// Targets: create_example_files in src/tools/mod.rs:302
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test create_example_files with temp file
    // Example: create_example_files(temp_path);
    // Example: create_example_files(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // create_example_files(path);
}


// Additional test functions for create_example_files
