...
// Targets: validate_api_contract in stdlib/contract_testing/mod.csd:20
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_api_contract(cursed_code);
...
// Additional test functions for validate_api_contract
