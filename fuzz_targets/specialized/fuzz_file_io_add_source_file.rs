...
// Targets: add_source_file in src/runtime/debug_manager.rs:321
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test add_source_file with temp file
    // Example: add_source_file(temp_path);
    // Example: add_source_file(temp_path, data, size);
