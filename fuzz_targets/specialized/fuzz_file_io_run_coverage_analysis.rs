...
// Targets: run_coverage_analysis in stdlib/coverage_analysis/mod.csd:429
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test run_coverage_analysis with temp file
    // Example: run_coverage_analysis(temp_path);
    // Example: run_coverage_analysis(temp_path, data, size);
