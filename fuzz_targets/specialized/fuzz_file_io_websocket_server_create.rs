...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test websocket_server_create with temp file
    // Example: websocket_server_create(temp_path);
    // Example: websocket_server_create(temp_path, data, size);
