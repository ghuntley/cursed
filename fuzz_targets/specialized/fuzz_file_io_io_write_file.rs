...
// Targets: io_write_file in src/execution/runtime_functions.rs:690
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test io_write_file with temp file
    // Example: io_write_file(temp_path);
    // Example: io_write_file(temp_path, data, size);
...
// Additional test functions for io_write_file
