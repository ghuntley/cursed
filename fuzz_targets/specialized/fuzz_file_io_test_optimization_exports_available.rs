...
// Targets: test_optimization_exports_available in tests/test_lib_exports.rs:34
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_optimization_exports_available with temp file
    // Example: test_optimization_exports_available(temp_path);
    // Example: test_optimization_exports_available(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // test_optimization_exports_available(path);
}


// Additional test functions for test_optimization_exports_available
