...
// Targets: test_edge_case_inputs in stdlib/token_vibe/test_token_vibe.csd:484
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // test_edge_case_inputs(cursed_code);
...
// Additional test functions for test_edge_case_inputs
