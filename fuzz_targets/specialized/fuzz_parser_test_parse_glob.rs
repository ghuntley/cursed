...
// Targets: test_parse_glob in stdlib/text_aesthetic/test_text_aesthetic.csd:329
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_parse_glob with fuzzed input
    // Example: test_parse_glob(allocator, input);
    // Example: test_parse_glob(input, size);
...
// Additional test functions for test_parse_glob
