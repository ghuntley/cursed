...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test analyze_memory_patterns with temp file
    // Example: analyze_memory_patterns(temp_path);
    // Example: analyze_memory_patterns(temp_path, data, size);
