...
// Targets: demonstrate_build_optimization in examples/performance_optimization_showcase.rs:153
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_build_optimization(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_build_optimization(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_build_optimization(data, 0);        // Zero size
        // demonstrate_build_optimization(data, 1);        // Single byte
        // demonstrate_build_optimization(data, size);     // Full size
        // demonstrate_build_optimization(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_build_optimization
