...
// Targets: string_compare_ignore_case in stdlib/string_simple/mod.csd:134
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // string_compare_ignore_case(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // string_compare_ignore_case(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // string_compare_ignore_case(data, 0);        // Zero size
        // string_compare_ignore_case(data, 1);        // Single byte
        // string_compare_ignore_case(data, size);     // Full size
        // string_compare_ignore_case(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for string_compare_ignore_case
