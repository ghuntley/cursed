...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_buffered_reader with temp file
    // Example: test_buffered_reader(temp_path);
    // Example: test_buffered_reader(temp_path, data, size);
