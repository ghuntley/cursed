...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_lexer_buffer_overflow_protection with fuzzed input
    // Example: test_lexer_buffer_overflow_protection(allocator, input);
    // Example: test_lexer_buffer_overflow_protection(input, size);
