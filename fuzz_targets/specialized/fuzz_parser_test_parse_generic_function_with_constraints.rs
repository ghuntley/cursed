...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_parse_generic_function_with_constraints with fuzzed input
    // Example: test_parse_generic_function_with_constraints(allocator, input);
    // Example: test_parse_generic_function_with_constraints(input, size);
