...
// Targets: demo_file_encryption in examples/xchacha20_poly1305_demo.csd:257
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test demo_file_encryption with temp file
    // Example: demo_file_encryption(temp_path);
    // Example: demo_file_encryption(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // demo_file_encryption(path);
}


// Additional test functions for demo_file_encryption
