...
// Targets: create_sample_files in examples/parallel_compilation_demo.rs:45
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test create_sample_files with temp file
    // Example: create_sample_files(temp_path);
    // Example: create_sample_files(temp_path, data, size);
...
// Additional test functions for create_sample_files
