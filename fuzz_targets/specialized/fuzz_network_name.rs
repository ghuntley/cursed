...
// Targets: name in src/stdlib/packages/db_sql/drivers.rs:73
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test packet parsing
    // Test name with network data
    // Example: name(data, size);
    // Example: name(sockfd, data, size);
