...
// Targets: validate_error_config in stdlib/error_handling/mod.csd:129
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_error_config(cursed_code);
...
// Additional test functions for validate_error_config
