...
// Targets: write_output_file in self_hosting_compiler/main.csd:195
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test write_output_file with temp file
    // Example: write_output_file(temp_path);
    // Example: write_output_file(temp_path, data, size);
...
// Additional test functions for write_output_file
