...
// Targets: write_secure in src/security/network_secure.rs:367
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test write_secure with temp file
    // Example: write_secure(temp_path);
    // Example: write_secure(temp_path, data, size);
...
// Additional test functions for write_secure
