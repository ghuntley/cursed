...
// Targets: set_breakpoint in src/runtime/debug_manager.rs:334
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test set_breakpoint with temp file
    // Example: set_breakpoint(temp_path);
    // Example: set_breakpoint(temp_path, data, size);
