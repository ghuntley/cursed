...
// Targets: load_module_source in src/bootstrap/stage2/module_resolver.csd:42
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_module_source with temp file
    // Example: load_module_source(temp_path);
    // Example: load_module_source(temp_path, data, size);
...
// Additional test functions for load_module_source
