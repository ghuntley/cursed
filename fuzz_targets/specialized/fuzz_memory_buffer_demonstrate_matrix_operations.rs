...
// Targets: demonstrate_matrix_operations in examples/math_advanced_demo.csd:166
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_matrix_operations(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_matrix_operations(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_matrix_operations(data, 0);        // Zero size
        // demonstrate_matrix_operations(data, 1);        // Single byte
        // demonstrate_matrix_operations(data, size);     // Full size
        // demonstrate_matrix_operations(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_matrix_operations
