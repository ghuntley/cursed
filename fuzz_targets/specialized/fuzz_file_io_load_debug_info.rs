...
// Targets: load_debug_info in src/debug/simple_dwarf_integration.rs:24
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_debug_info with temp file
    // Example: load_debug_info(temp_path);
    // Example: load_debug_info(temp_path, data, size);
...
// Additional test functions for load_debug_info
