...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test import_ast_from_json with temp file
    // Example: import_ast_from_json(temp_path);
    // Example: import_ast_from_json(temp_path, data, size);
