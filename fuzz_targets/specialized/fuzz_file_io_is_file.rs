...
// Targets: is_file in stdlib/filez/mod.csd:676
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test is_file with temp file
    // Example: is_file(temp_path);
    // Example: is_file(temp_path, data, size);
...
// Additional test functions for is_file
