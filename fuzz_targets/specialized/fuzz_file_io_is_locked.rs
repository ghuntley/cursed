...
// Targets: is_locked in stdlib/fs/mod.csd:680
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test is_locked with temp file
    // Example: is_locked(temp_path);
    // Example: is_locked(temp_path, data, size);
...
// Additional test functions for is_locked
