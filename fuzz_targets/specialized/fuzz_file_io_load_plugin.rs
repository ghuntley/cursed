...
// Targets: load_plugin in stdlib/plugin_vibes_simple/mod.csd:6
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_plugin with temp file
    // Example: load_plugin(temp_path);
    // Example: load_plugin(temp_path, data, size);
...
// Additional test functions for load_plugin
