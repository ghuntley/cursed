...
// Targets: validate_environment_config in stdlib/testz/parallel_runner_config.csd:167
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_environment_config(cursed_code);
...
// Additional test functions for validate_environment_config
