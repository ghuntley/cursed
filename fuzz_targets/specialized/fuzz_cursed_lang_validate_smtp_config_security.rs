...
// Targets: validate_smtp_config_security in stdlib/smtp_tea/mod.csd:452
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_smtp_config_security(cursed_code);
...
// Additional test functions for validate_smtp_config_security
