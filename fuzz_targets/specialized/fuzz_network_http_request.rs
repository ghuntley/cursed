...
// Targets: http_request in stdlib/web_vibez/mod.csd:210
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test packet parsing
    // Test http_request with network data
    // Example: http_request(data, size);
    // Example: http_request(sockfd, data, size);
