...
// Targets: write_binary in stdlib/io/mod.csd:426
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test write_binary with temp file
    // Example: write_binary(temp_path);
    // Example: write_binary(temp_path, data, size);
...
// Additional test functions for write_binary
