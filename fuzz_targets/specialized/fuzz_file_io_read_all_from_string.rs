...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test read_all_from_string with temp file
    // Example: read_all_from_string(temp_path);
    // Example: read_all_from_string(temp_path, data, size);
