...
// Targets: demonstrate_build_integration in examples/file_watcher_demo.csd:275
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_build_integration(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_build_integration(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_build_integration(data, 0);        // Zero size
        // demonstrate_build_integration(data, 1);        // Single byte
        // demonstrate_build_integration(data, size);     // Full size
        // demonstrate_build_integration(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_build_integration
