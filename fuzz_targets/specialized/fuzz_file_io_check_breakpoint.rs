...
// Targets: check_breakpoint in stdlib/debugz/mod.csd:461
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test check_breakpoint with temp file
    // Example: check_breakpoint(temp_path);
    // Example: check_breakpoint(temp_path, data, size);
