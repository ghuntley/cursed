...
// Targets: write_float in stdlib/serialization/mod.csd:195
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test write_float with temp file
    // Example: write_float(temp_path);
    // Example: write_float(temp_path, data, size);
...
// Additional test functions for write_float
