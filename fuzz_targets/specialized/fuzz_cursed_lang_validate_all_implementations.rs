...
// Targets: validate_all_implementations in src/codegen/llvm/interface_type_checking.rs:91
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_all_implementations(cursed_code);
...
// Additional test functions for validate_all_implementations
