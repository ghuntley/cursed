...
// Targets: rollback_to_savepoint in stdlib/database_drivers/postgresql.csd:559
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test rollback_to_savepoint with temp file
    // Example: rollback_to_savepoint(temp_path);
    // Example: rollback_to_savepoint(temp_path, data, size);
