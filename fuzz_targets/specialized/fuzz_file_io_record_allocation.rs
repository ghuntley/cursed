...
// Targets: record_allocation in src/memory/pool_optimization.rs:799
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test record_allocation with temp file
    // Example: record_allocation(temp_path);
    // Example: record_allocation(temp_path, data, size);
