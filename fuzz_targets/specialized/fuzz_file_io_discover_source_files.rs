...
// Targets: discover_source_files in src/coverage/simple_collector.rs:64
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test discover_source_files with temp file
    // Example: discover_source_files(temp_path);
    // Example: discover_source_files(temp_path, data, size);
...
// Additional test functions for discover_source_files
