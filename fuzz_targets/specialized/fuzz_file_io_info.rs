...
// Targets: info in stdlib/path/mod.csd:461
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test info with temp file
    // Example: info(temp_path);
    // Example: info(temp_path, data, size);
...
// Additional test functions for info
