...
// Targets: web_request_validate_body in stdlib/web/mod.csd:1128
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // web_request_validate_body(cursed_code);
...
// Additional test functions for web_request_validate_body
