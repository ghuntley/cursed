...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test create_job_with_priority with temp file
    // Example: create_job_with_priority(temp_path);
    // Example: create_job_with_priority(temp_path, data, size);
