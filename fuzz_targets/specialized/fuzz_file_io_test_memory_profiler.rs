...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_memory_profiler with temp file
    // Example: test_memory_profiler(temp_path);
    // Example: test_memory_profiler(temp_path, data, size);
