...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test compile_source_to_wasm with temp file
    // Example: compile_source_to_wasm(temp_path);
    // Example: compile_source_to_wasm(temp_path, data, size);
