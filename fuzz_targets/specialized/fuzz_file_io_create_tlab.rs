...
// Targets: create_tlab in src/runtime/heap_optimizer.rs:520
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test create_tlab with temp file
    // Example: create_tlab(temp_path);
    // Example: create_tlab(temp_path, data, size);
...
// Additional test functions for create_tlab
