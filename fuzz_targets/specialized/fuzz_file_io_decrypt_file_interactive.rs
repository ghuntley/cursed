...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test decrypt_file_interactive with temp file
    // Example: decrypt_file_interactive(temp_path);
    // Example: decrypt_file_interactive(temp_path, data, size);
