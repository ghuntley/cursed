...
// Targets: new_parser in self_hosting_compiler/parser.csd:51
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test new_parser with fuzzed input
    // Example: new_parser(allocator, input);
    // Example: new_parser(input, size);
