...
// Targets: create_optimization_strategy in src/optimization/optimization_full/ml/mod.rs:162
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // create_optimization_strategy(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // create_optimization_strategy(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // create_optimization_strategy(data, 0);        // Zero size
        // create_optimization_strategy(data, 1);        // Single byte
        // create_optimization_strategy(data, size);     // Full size
        // create_optimization_strategy(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for create_optimization_strategy
