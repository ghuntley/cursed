...
// Targets: query in src/stdlib/database/connection.rs:121
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test packet parsing
    // Test query with network data
    // Example: query(data, size);
    // Example: query(sockfd, data, size);
