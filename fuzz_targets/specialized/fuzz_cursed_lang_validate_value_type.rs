...
// Targets: validate_value_type in stdlib/configz/mod_complex_syntax.csd:331
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_value_type(cursed_code);
...
// Additional test functions for validate_value_type
