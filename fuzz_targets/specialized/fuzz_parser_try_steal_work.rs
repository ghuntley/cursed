...
// Targets: try_steal_work in src/runtime/scheduler.rs:1047
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test try_steal_work with fuzzed input
    // Example: try_steal_work(allocator, input);
    // Example: try_steal_work(input, size);
...
// Additional test functions for try_steal_work
