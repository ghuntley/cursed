...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test generate_json_output with temp file
    // Example: generate_json_output(temp_path);
    // Example: generate_json_output(temp_path, data, size);
