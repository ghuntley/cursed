...
// Targets: is_large_file in stdlib/ioz_enhanced/mod.csd:182
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test is_large_file with temp file
    // Example: is_large_file(temp_path);
    // Example: is_large_file(temp_path, data, size);
...
// Additional test functions for is_large_file
