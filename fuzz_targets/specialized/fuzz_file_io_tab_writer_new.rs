...
// Targets: tab_writer_new in stdlib/tab_aesthetic/mod.csd:17
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test tab_writer_new with temp file
    // Example: tab_writer_new(temp_path);
    // Example: tab_writer_new(temp_path, data, size);
...
// Additional test functions for tab_writer_new
