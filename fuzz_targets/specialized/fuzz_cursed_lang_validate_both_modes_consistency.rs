...
// Targets: validate_both_modes_consistency in stdlib/testz/original_mod.csd:182
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_both_modes_consistency(cursed_code);
...
// Additional test functions for validate_both_modes_consistency
