...
// Targets: load_metadata in src/optimization/pgo/profile_storage.rs:254
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_metadata with temp file
    // Example: load_metadata(temp_path);
    // Example: load_metadata(temp_path, data, size);
...
// Additional test functions for load_metadata
