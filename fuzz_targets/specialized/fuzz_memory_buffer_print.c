...
// Targets: print in runtime/interface_runtime.c:336
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // print(data, 0);        // Zero size
        // print(data, 1);        // Single byte
        // print(data, size);     // Full size
        // print(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for print
