...
// Targets: validate_array_max_length in stdlib/validation/mod.csd:342
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_array_max_length(cursed_code);
...
// Additional test functions for validate_array_max_length
