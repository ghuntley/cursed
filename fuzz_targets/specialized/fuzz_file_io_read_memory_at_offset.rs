...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test read_memory_at_offset with temp file
    // Example: read_memory_at_offset(temp_path);
    // Example: read_memory_at_offset(temp_path, data, size);
