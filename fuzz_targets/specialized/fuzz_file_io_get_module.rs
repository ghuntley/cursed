...
// Targets: get_module in src/execution/execution_context.rs:370
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test get_module with temp file
    // Example: get_module(temp_path);
    // Example: get_module(temp_path, data, size);
