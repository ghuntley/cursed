...
// Targets: validate_completeness in src/runtime/interface_virtual_dispatch.rs:117
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_completeness(cursed_code);
...
// Additional test functions for validate_completeness
