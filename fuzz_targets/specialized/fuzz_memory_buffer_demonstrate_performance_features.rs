...
// Targets: demonstrate_performance_features in examples/stdlib_examples/vibez_example.csd:106
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_performance_features(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_performance_features(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_performance_features(data, 0);        // Zero size
        // demonstrate_performance_features(data, 1);        // Single byte
        // demonstrate_performance_features(data, size);     // Full size
        // demonstrate_performance_features(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_performance_features
