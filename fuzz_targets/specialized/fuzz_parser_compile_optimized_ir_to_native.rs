...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test compile_optimized_ir_to_native with fuzzed input
    // Example: compile_optimized_ir_to_native(allocator, input);
    // Example: compile_optimized_ir_to_native(input, size);
