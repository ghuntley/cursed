...
// Targets: validate_value_against_rule in stdlib/configz/mod_complex.csd:405
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_value_against_rule(cursed_code);
...
// Additional test functions for validate_value_against_rule
