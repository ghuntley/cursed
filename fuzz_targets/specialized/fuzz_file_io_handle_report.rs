...
// Targets: handle_report in src/cli/debug_cli.rs:365
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test handle_report with temp file
    // Example: handle_report(temp_path);
    // Example: handle_report(temp_path, data, size);
...
// Additional test functions for handle_report
