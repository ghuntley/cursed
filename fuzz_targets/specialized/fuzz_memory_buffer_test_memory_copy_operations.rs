...
// Targets: test_memory_copy_operations in stdlib/memory/test_mod.csd:147
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // test_memory_copy_operations(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // test_memory_copy_operations(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // test_memory_copy_operations(data, 0);        // Zero size
        // test_memory_copy_operations(data, 1);        // Single byte
        // test_memory_copy_operations(data, size);     // Full size
        // test_memory_copy_operations(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for test_memory_copy_operations
