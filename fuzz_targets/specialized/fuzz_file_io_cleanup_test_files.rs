...
// Targets: cleanup_test_files in stdlib/zip_zilla/test_zip_zilla.csd:23
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test cleanup_test_files with temp file
    // Example: cleanup_test_files(temp_path);
    // Example: cleanup_test_files(temp_path, data, size);
...
// Additional test functions for cleanup_test_files
