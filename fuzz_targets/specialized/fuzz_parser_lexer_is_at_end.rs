...
// Targets: lexer_is_at_end in src-zig/lexer.csd:137
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test lexer_is_at_end with fuzzed input
    // Example: lexer_is_at_end(allocator, input);
    // Example: lexer_is_at_end(input, size);
...
// Additional test functions for lexer_is_at_end
