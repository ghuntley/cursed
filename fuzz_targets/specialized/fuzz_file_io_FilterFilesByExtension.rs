...
// Targets: FilterFilesByExtension in stdlib/embed_that/mod.csd:149
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test FilterFilesByExtension with temp file
    // Example: FilterFilesByExtension(temp_path);
    // Example: FilterFilesByExtension(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // FilterFilesByExtension(path);
}


// Additional test functions for FilterFilesByExtension
