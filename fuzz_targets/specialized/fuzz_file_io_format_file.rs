...
// Targets: format_file in src/tools/formatter.rs:121
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test format_file with temp file
    // Example: format_file(temp_path);
    // Example: format_file(temp_path, data, size);
...
// Additional test functions for format_file
