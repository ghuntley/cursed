...
// Targets: save_metadata in src/optimization/pgo/profile_storage.rs:273
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test save_metadata with temp file
    // Example: save_metadata(temp_path);
    // Example: save_metadata(temp_path, data, size);
...
// Additional test functions for save_metadata
