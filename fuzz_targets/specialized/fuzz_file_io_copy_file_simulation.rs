...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test copy_file_simulation with temp file
    // Example: copy_file_simulation(temp_path);
    // Example: copy_file_simulation(temp_path, data, size);
