...
// Targets: demonstrate_interface_switching in examples/type_switch_basic.csd:132
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_interface_switching(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_interface_switching(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_interface_switching(data, 0);        // Zero size
        // demonstrate_interface_switching(data, 1);        // Single byte
        // demonstrate_interface_switching(data, size);     // Full size
        // demonstrate_interface_switching(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_interface_switching
