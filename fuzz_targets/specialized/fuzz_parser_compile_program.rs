...
// Targets: compile_program in src/bootstrap/stage2/main.csd:33
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test compile_program with fuzzed input
    // Example: compile_program(allocator, input);
    // Example: compile_program(input, size);
