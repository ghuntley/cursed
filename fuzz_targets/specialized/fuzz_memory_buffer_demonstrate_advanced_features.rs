...
// Targets: demonstrate_advanced_features in examples/docs_demo.csd:297
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_advanced_features(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_advanced_features(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_advanced_features(data, 0);        // Zero size
        // demonstrate_advanced_features(data, 1);        // Single byte
        // demonstrate_advanced_features(data, size);     // Full size
        // demonstrate_advanced_features(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_advanced_features
