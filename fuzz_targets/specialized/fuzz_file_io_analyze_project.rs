...
// Targets: analyze_project in src/tools/mod.rs:269
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test analyze_project with temp file
    // Example: analyze_project(temp_path);
    // Example: analyze_project(temp_path, data, size);
