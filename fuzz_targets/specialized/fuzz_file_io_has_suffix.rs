...
// Targets: has_suffix in stdlib/filesystem_complete/mod.csd:816
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test has_suffix with temp file
    // Example: has_suffix(temp_path);
    // Example: has_suffix(temp_path, data, size);
...
// Additional test functions for has_suffix
