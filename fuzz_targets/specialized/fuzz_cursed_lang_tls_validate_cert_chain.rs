...
// Targets: tls_validate_cert_chain in stdlib/tls_vibe/test_tls_vibe_working.csd:168
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // tls_validate_cert_chain(cursed_code);
...
// Additional test functions for tls_validate_cert_chain
