...
// Targets: get_public_input_assignment in src/stdlib/packages/crypto_zk/circuit_builder.rs:297
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // get_public_input_assignment(cursed_code);
...
// Additional test functions for get_public_input_assignment
