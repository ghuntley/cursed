...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test compile_with_packages with temp file
    // Example: compile_with_packages(temp_path);
    // Example: compile_with_packages(temp_path, data, size);
