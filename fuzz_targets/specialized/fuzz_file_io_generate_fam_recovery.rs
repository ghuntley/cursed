...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test generate_fam_recovery with temp file
    // Example: generate_fam_recovery(temp_path);
    // Example: generate_fam_recovery(temp_path, data, size);
