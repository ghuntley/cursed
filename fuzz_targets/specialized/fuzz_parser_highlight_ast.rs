...
// Targets: highlight_ast in src/lsp/semantic_highlighting.rs:78
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test highlight_ast with fuzzed input
    // Example: highlight_ast(allocator, input);
    // Example: highlight_ast(input, size);
...
// Additional test functions for highlight_ast
