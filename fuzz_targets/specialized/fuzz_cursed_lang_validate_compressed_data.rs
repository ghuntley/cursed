...
// Targets: validate_compressed_data in src/stdlib/squish_core/utils.rs:23
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_compressed_data(cursed_code);
...
// Additional test functions for validate_compressed_data
