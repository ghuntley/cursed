...
// Targets: test_sanitize_label_key in src/metrics/prometheus_exporter.rs:850
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // test_sanitize_label_key(cursed_code);
...
// Additional test functions for test_sanitize_label_key
