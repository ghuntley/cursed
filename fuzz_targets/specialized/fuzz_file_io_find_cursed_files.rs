...
// Targets: find_cursed_files in src/tools/doc_generator.rs:416
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test find_cursed_files with temp file
    // Example: find_cursed_files(temp_path);
    // Example: find_cursed_files(temp_path, data, size);
