...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test compile_to_optimized_wasm_ir with fuzzed input
    // Example: compile_to_optimized_wasm_ir(allocator, input);
    // Example: compile_to_optimized_wasm_ir(input, size);
