...
// Targets: validate_rule_structure in stdlib/grammar_drip/mod.csd:135
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_rule_structure(cursed_code);
...
// Additional test functions for validate_rule_structure
