...
// Targets: format_directory in src/tools/formatter.rs:163
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test format_directory with temp file
    // Example: format_directory(temp_path);
    // Example: format_directory(temp_path, data, size);
...
// Additional test functions for format_directory
