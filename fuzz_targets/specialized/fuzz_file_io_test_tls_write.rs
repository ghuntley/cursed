...
// Targets: test_tls_write in stdlib/tls_vibe/test_tls_vibe_working.csd:229
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_tls_write with temp file
    // Example: test_tls_write(temp_path);
    // Example: test_tls_write(temp_path, data, size);
...
// Additional test functions for test_tls_write
