...
// Targets: downloader_usage_example in examples/package_download_demo.rs:210
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test downloader_usage_example with temp file
    // Example: downloader_usage_example(temp_path);
    // Example: downloader_usage_example(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // downloader_usage_example(path);
}


// Additional test functions for downloader_usage_example
