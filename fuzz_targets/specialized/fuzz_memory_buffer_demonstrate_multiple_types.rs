...
// Targets: demonstrate_multiple_types in examples/type_switch_basic.csd:66
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_multiple_types(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_multiple_types(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_multiple_types(data, 0);        // Zero size
        // demonstrate_multiple_types(data, 1);        // Single byte
        // demonstrate_multiple_types(data, size);     // Full size
        // demonstrate_multiple_types(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_multiple_types
