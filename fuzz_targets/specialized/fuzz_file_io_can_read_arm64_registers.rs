...
// Targets: can_read_arm64_registers in src/runtime/platform/runtime_detector.rs:497
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test can_read_arm64_registers with temp file
    // Example: can_read_arm64_registers(temp_path);
    // Example: can_read_arm64_registers(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // can_read_arm64_registers(path);
}


// Additional test functions for can_read_arm64_registers
