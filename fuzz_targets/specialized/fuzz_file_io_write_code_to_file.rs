...
// Targets: write_code_to_file in self_hosting_compiler/codegen.csd:505
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test write_code_to_file with temp file
    // Example: write_code_to_file(temp_path);
    // Example: write_code_to_file(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // write_code_to_file(path);
}


// Additional test functions for write_code_to_file
