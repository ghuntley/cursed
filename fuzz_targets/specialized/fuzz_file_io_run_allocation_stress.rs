...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test run_allocation_stress with temp file
    // Example: run_allocation_stress(temp_path);
    // Example: run_allocation_stress(temp_path, data, size);
