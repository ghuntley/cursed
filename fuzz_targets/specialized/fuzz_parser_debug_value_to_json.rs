...
// Targets: debug_value_to_json in src/runtime/debug_output.rs:948
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test debug_value_to_json with fuzzed input
    // Example: debug_value_to_json(allocator, input);
    // Example: debug_value_to_json(input, size);
...
// Additional test functions for debug_value_to_json
