...
// Targets: demo_enhanced_input_generation in examples/exec_vibez_advanced_demo.csd:191
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // demo_enhanced_input_generation(cursed_code);
...
// Additional test functions for demo_enhanced_input_generation
