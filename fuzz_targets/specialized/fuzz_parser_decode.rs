...
// Targets: decode in src/stdlib/packages/crypto_signatures/signature_format.rs:61
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test decode with fuzzed input
    // Example: decode(allocator, input);
    // Example: decode(input, size);
