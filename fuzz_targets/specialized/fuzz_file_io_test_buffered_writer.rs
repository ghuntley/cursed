...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_buffered_writer with temp file
    // Example: test_buffered_writer(temp_path);
    // Example: test_buffered_writer(temp_path, data, size);
