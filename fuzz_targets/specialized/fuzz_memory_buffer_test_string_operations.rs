...
// Targets: test_string_operations in tests/testz/test_final_framework.csd:93
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // test_string_operations(buffer, data, size);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // test_string_operations(data, 0);        // Zero size
        // test_string_operations(data, 1);        // Single byte
        // test_string_operations(data, size);     // Full size
        // test_string_operations(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for test_string_operations
