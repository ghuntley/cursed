...
// Targets: parse_variable in stdlib/formatter/mod.csd:593
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test parse_variable with fuzzed input
    // Example: parse_variable(allocator, input);
    // Example: parse_variable(input, size);
...
// Additional test functions for parse_variable
