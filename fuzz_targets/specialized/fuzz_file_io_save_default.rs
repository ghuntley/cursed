...
// Targets: save_default in src/package_manager/config.rs:307
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test save_default with temp file
    // Example: save_default(temp_path);
    // Example: save_default(temp_path, data, size);
...
// Additional test functions for save_default
