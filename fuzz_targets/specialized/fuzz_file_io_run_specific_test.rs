...
// Targets: run_specific_test in examples/watch_build_example.csd:355
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test run_specific_test with temp file
    // Example: run_specific_test(temp_path);
    // Example: run_specific_test(temp_path, data, size);
...
// Additional test functions for run_specific_test
