...
// Targets: connect in src/stdlib/database/redis/driver.rs:43
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test packet parsing
    // Test connect with network data
    // Example: connect(data, size);
    // Example: connect(sockfd, data, size);
