...
// Targets: LoadImage in stdlib/embed_that/mod.csd:243
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test LoadImage with temp file
    // Example: LoadImage(temp_path);
    // Example: LoadImage(temp_path, data, size);
...
// Additional test functions for LoadImage
