...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test should_profile_value with temp file
    // Example: should_profile_value(temp_path);
    // Example: should_profile_value(temp_path, data, size);
