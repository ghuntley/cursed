...
// Targets: list_directory in stdlib/process/mod.csd:716
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test list_directory with temp file
    // Example: list_directory(temp_path);
    // Example: list_directory(temp_path, data, size);
