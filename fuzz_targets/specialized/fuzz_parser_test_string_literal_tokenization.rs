...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_string_literal_tokenization with fuzzed input
    // Example: test_string_literal_tokenization(allocator, input);
    // Example: test_string_literal_tokenization(input, size);
