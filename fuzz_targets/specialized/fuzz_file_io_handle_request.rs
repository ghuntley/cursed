...
// Targets: handle_request in src/web/mod.rs:43
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test handle_request with temp file
    // Example: handle_request(temp_path);
    // Example: handle_request(temp_path, data, size);
