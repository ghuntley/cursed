...
// Targets: with_level in src/stdlib/squish_core/zlib.rs:71
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test with_level with temp file
    // Example: with_level(temp_path);
    // Example: with_level(temp_path, data, size);
...
// Additional test functions for with_level
