...
// Targets: test_package_manager_exports_available in tests/test_lib_exports.rs:50
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_package_manager_exports_available with temp file
    // Example: test_package_manager_exports_available(temp_path);
    // Example: test_package_manager_exports_available(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // test_package_manager_exports_available(path);
}


// Additional test functions for test_package_manager_exports_available
