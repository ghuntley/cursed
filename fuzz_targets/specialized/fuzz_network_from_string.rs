...
// Targets: from_string in src/stdlib/packages/db_sql/mod.rs:91
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test packet parsing
    // Test from_string with network data
    // Example: from_string(data, size);
    // Example: from_string(sockfd, data, size);
