...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test read_wasm_memory_u32 with temp file
    // Example: read_wasm_memory_u32(temp_path);
    // Example: read_wasm_memory_u32(temp_path, data, size);
