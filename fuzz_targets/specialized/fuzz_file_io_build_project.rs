...
// Targets: build_project in stdlib/build_system/mod.csd:98
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test build_project with temp file
    // Example: build_project(temp_path);
    // Example: build_project(temp_path, data, size);
