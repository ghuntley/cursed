...
// Targets: write_build_manifest in stdlib/io_enhanced/mod.csd:332
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test write_build_manifest with temp file
    // Example: write_build_manifest(temp_path);
    // Example: write_build_manifest(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // write_build_manifest(path);
}


// Additional test functions for write_build_manifest
