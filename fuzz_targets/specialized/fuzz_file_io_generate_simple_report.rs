...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test generate_simple_report with temp file
    // Example: generate_simple_report(temp_path);
    // Example: generate_simple_report(temp_path, data, size);
