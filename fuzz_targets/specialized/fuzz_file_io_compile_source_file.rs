...
// Targets: compile_source_file in examples/watch_build_example.csd:311
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test compile_source_file with temp file
    // Example: compile_source_file(temp_path);
    // Example: compile_source_file(temp_path, data, size);
...
// Additional test functions for compile_source_file
