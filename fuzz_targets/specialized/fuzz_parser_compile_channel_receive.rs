...
// Targets: compile_channel_receive in src/codegen/llvm/expression_compiler.rs:1211
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test compile_channel_receive with fuzzed input
    // Example: compile_channel_receive(allocator, input);
    // Example: compile_channel_receive(input, size);
...
// Additional test functions for compile_channel_receive
