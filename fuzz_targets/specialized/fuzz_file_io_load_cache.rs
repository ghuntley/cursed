...
// Targets: load_cache in src/build_system/build_pipeline.rs:723
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_cache with temp file
    // Example: load_cache(temp_path);
    // Example: load_cache(temp_path, data, size);
...
// Additional test functions for load_cache
