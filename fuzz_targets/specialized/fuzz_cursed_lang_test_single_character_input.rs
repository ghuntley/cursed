...
// Targets: test_single_character_input in stdlib/formatter/test_formatter.csd:412
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // test_single_character_input(cursed_code);
...
// Additional test functions for test_single_character_input
