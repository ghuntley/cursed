...
// Targets: demo_file_compression in examples/squish_core_demo.csd:226
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test demo_file_compression with temp file
    // Example: demo_file_compression(temp_path);
    // Example: demo_file_compression(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // demo_file_compression(path);
}


// Additional test functions for demo_file_compression
