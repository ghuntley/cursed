...
// Targets: cursed_file_read in runtime/minimal_shims.c:87
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test cursed_file_read with temp file
    // Example: cursed_file_read(temp_path);
    // Example: cursed_file_read(temp_path, data, size);
