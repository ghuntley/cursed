...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test packet parsing
    // Test find_strongly_connected_components with network data
    // Example: find_strongly_connected_components(data, size);
    // Example: find_strongly_connected_components(sockfd, data, size);
...
void test_socket_operations(const uint8_t *data, size_t size) {
    ...
    // find_strongly_connected_components(sockfd, data, size);
