...
// Targets: test_type_registry_initialization in tests/type_switch_tests.rs:14
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // test_type_registry_initialization(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // test_type_registry_initialization(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // test_type_registry_initialization(data, 0);        // Zero size
        // test_type_registry_initialization(data, 1);        // Single byte
        // test_type_registry_initialization(data, size);     // Full size
        // test_type_registry_initialization(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for test_type_registry_initialization
