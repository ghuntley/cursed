...
// Targets: demonstrate_regular_switch in examples/type_switch_vs_regular_switch.csd:11
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_regular_switch(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_regular_switch(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_regular_switch(data, 0);        // Zero size
        // demonstrate_regular_switch(data, 1);        // Single byte
        // demonstrate_regular_switch(data, size);     // Full size
        // demonstrate_regular_switch(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_regular_switch
