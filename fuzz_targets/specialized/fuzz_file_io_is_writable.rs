...
// Targets: is_writable in stdlib/fs/mod.csd:561
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test is_writable with temp file
    // Example: is_writable(temp_path);
    // Example: is_writable(temp_path, data, size);
...
// Additional test functions for is_writable
