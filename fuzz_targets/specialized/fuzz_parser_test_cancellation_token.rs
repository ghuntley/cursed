...
// Targets: test_cancellation_token in src/runtime/async/task.rs:470
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_cancellation_token with fuzzed input
    // Example: test_cancellation_token(allocator, input);
    // Example: test_cancellation_token(input, size);
...
// Additional test functions for test_cancellation_token
