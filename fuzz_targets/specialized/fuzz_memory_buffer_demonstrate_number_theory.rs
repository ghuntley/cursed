...
// Targets: demonstrate_number_theory in examples/stdlib_examples/mathz_example.csd:136
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_number_theory(buffer, data, size);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_number_theory(data, 0);        // Zero size
        // demonstrate_number_theory(data, 1);        // Single byte
        // demonstrate_number_theory(data, size);     // Full size
        // demonstrate_number_theory(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_number_theory
