...
// Targets: load_style_config in stdlib/formatter/cli_integration.csd:441
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_style_config with temp file
    // Example: load_style_config(temp_path);
    // Example: load_style_config(temp_path, data, size);
...
// Additional test functions for load_style_config
