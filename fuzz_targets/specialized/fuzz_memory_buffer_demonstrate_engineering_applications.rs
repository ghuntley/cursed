...
// Targets: demonstrate_engineering_applications in examples/math_advanced_demo.csd:221
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_engineering_applications(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_engineering_applications(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_engineering_applications(data, 0);        // Zero size
        // demonstrate_engineering_applications(data, 1);        // Single byte
        // demonstrate_engineering_applications(data, size);     // Full size
        // demonstrate_engineering_applications(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_engineering_applications
