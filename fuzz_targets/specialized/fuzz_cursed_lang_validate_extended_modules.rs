...
// Targets: validate_extended_modules in comprehensive_stdlib_validation.csd:281
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_extended_modules(cursed_code);
...
// Additional test functions for validate_extended_modules
