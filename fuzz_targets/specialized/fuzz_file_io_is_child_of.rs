...
// Targets: is_child_of in stdlib/fs/mod.csd:797
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test is_child_of with temp file
    // Example: is_child_of(temp_path);
    // Example: is_child_of(temp_path, data, size);
...
// Additional test functions for is_child_of
