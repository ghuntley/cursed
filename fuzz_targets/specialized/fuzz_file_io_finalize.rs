...
// Targets: finalize in src/optimization/pgo/profile_collector.rs:145
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test finalize with temp file
    // Example: finalize(temp_path);
    // Example: finalize(temp_path, data, size);
...
// Additional test functions for finalize
