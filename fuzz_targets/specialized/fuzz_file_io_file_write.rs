...
// Targets: file_write in stdlib/pure_cursed_runtime/mod.csd:127
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test file_write with temp file
    // Example: file_write(temp_path);
    // Example: file_write(temp_path, data, size);
...
// Additional test functions for file_write
