...
// Targets: enable in src/ffi/debug_tools.rs:701
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test enable with temp file
    // Example: enable(temp_path);
    // Example: enable(temp_path, data, size);
...
// Additional test functions for enable
