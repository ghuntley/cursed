...
// Targets: optimize in src/stdlib/database/sqlite/utils.rs:45
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test packet parsing
    // Test optimize with network data
    // Example: optimize(data, size);
    // Example: optimize(sockfd, data, size);
