...
// Targets: demonstrate_basic_output in examples/stdlib_examples/vibez_example.csd:7
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_basic_output(buffer, data, size);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_basic_output(data, 0);        // Zero size
        // demonstrate_basic_output(data, 1);        // Single byte
        // demonstrate_basic_output(data, size);     // Full size
        // demonstrate_basic_output(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_basic_output
