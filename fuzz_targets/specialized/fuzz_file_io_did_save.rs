...
// Targets: did_save in src/lsp/minimal_server.rs:328
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test did_save with temp file
    // Example: did_save(temp_path);
    // Example: did_save(temp_path, data, size);
...
// Additional test functions for did_save
