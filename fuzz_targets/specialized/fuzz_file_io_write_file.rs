...
// Targets: write_file in benchmarks/cursed/compiler/compilation_speed_bench.csd:448
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test write_file with temp file
    // Example: write_file(temp_path);
    // Example: write_file(temp_path, data, size);
...
// Additional test functions for write_file
