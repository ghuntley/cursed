...
// Targets: io_move_file in src/execution/runtime_functions.rs:929
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test io_move_file with temp file
    // Example: io_move_file(temp_path);
    // Example: io_move_file(temp_path, data, size);
...
// Additional test functions for io_move_file
