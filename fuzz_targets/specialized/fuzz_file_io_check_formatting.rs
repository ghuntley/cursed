...
// Targets: check_formatting in src/bin/disabled/cursed_tools_original.rs:443
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test check_formatting with temp file
    // Example: check_formatting(temp_path);
    // Example: check_formatting(temp_path, data, size);
...
// Additional test functions for check_formatting
