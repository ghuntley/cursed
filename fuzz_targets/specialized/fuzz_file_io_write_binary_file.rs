...
// Targets: write_binary_file in stdlib/package_manager/registry_client.csd:579
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test write_binary_file with temp file
    // Example: write_binary_file(temp_path);
    // Example: write_binary_file(temp_path, data, size);
...
// Additional test functions for write_binary_file
