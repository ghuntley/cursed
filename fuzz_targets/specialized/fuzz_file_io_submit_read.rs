...
// Targets: submit_read in src/runtime/async_poller.rs:345
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test submit_read with temp file
    // Example: submit_read(temp_path);
    // Example: submit_read(temp_path, data, size);
