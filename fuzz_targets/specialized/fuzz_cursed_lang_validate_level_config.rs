...
// Targets: validate_level_config in src/optimization/optimization_levels.rs:463
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_level_config(cursed_code);
...
// Additional test functions for validate_level_config
