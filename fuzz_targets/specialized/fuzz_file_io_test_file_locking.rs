...
// Targets: test_file_locking in stdlib/filesystem_complete/test_filesystem_complete.csd:450
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_file_locking with temp file
    // Example: test_file_locking(temp_path);
    // Example: test_file_locking(temp_path, data, size);
...
// Additional test functions for test_file_locking
