...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test set_breakpoint_by_line with temp file
    // Example: set_breakpoint_by_line(temp_path);
    // Example: set_breakpoint_by_line(temp_path, data, size);
