...
// Targets: create_file in stdlib/vibe_life/mod.csd:185
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test create_file with temp file
    // Example: create_file(temp_path);
    // Example: create_file(temp_path, data, size);
