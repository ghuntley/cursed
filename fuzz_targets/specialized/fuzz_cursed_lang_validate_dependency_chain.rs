...
// Targets: validate_dependency_chain in stdlib/testz/original_mod.csd:351
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_dependency_chain(cursed_code);
...
// Additional test functions for validate_dependency_chain
