...
// Targets: validate_plugin_security in stdlib/plugin_vibes/mod.csd:221
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_plugin_security(cursed_code);
...
// Additional test functions for validate_plugin_security
