...
// Targets: ftp_store_file in stdlib/net_protocols/mod.csd:429
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test ftp_store_file with temp file
    // Example: ftp_store_file(temp_path);
    // Example: ftp_store_file(temp_path, data, size);
...
// Additional test functions for ftp_store_file
