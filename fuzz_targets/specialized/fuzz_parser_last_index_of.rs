...
// Targets: last_index_of in stdlib/fs_real/mod.csd:471
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test last_index_of with fuzzed input
    // Example: last_index_of(allocator, input);
    // Example: last_index_of(input, size);
