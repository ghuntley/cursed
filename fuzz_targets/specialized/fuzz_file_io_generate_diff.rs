...
// Targets: generate_diff in src/formatter/output.rs:53
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test generate_diff with temp file
    // Example: generate_diff(temp_path);
    // Example: generate_diff(temp_path, data, size);
