...
// Targets: validate_array_not_empty in stdlib/validation/mod.csd:312
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_array_not_empty(cursed_code);
...
// Additional test functions for validate_array_not_empty
