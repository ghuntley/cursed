...
// Targets: is_executable in stdlib/fs/mod.csd:571
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test is_executable with temp file
    // Example: is_executable(temp_path);
    // Example: is_executable(temp_path, data, size);
...
// Additional test functions for is_executable
