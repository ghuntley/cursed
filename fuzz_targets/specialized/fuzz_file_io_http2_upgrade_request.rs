...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test http2_upgrade_request with temp file
    // Example: http2_upgrade_request(temp_path);
    // Example: http2_upgrade_request(temp_path, data, size);
