...
// Targets: validate_stdlib_linking in stdlib/stdlib_linker/mod.csd:45
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_stdlib_linking(cursed_code);
...
// Additional test functions for validate_stdlib_linking
