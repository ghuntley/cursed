...
// Targets: example_complex_generators in stdlib/property_test/examples.csd:363
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test example_complex_generators with fuzzed input
    // Example: example_complex_generators(allocator, input);
    // Example: example_complex_generators(input, size);
...
// Additional test functions for example_complex_generators
