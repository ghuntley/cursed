...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test compile_ir_to_executable with temp file
    // Example: compile_ir_to_executable(temp_path);
    // Example: compile_ir_to_executable(temp_path, data, size);
