...
// Targets: write_bool in stdlib/serialization/mod.csd:205
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test write_bool with temp file
    // Example: write_bool(temp_path);
    // Example: write_bool(temp_path, data, size);
...
// Additional test functions for write_bool
