...
// Targets: getStats in src-zig/memory_profiler_aggregation.zig:588
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test getStats with temp file
    // Example: getStats(temp_path);
    // Example: getStats(temp_path, data, size);
