...
// Targets: parse_program in stdlib/compiler_core/mod_backup.csd:303
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test parse_program with fuzzed input
    // Example: parse_program(allocator, input);
    // Example: parse_program(input, size);
