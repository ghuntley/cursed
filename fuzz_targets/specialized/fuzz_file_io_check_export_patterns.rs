...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test check_export_patterns with temp file
    // Example: check_export_patterns(temp_path);
    // Example: check_export_patterns(temp_path, data, size);
