...
// Targets: save_cache in src/build_system/build_pipeline.rs:730
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test save_cache with temp file
    // Example: save_cache(temp_path);
    // Example: save_cache(temp_path, data, size);
...
// Additional test functions for save_cache
