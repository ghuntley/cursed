...
// Targets: validate_package_manager in stdlib/config_package/mod.csd:271
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_package_manager(cursed_code);
...
// Additional test functions for validate_package_manager
