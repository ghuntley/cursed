...
// Targets: write_to_pipe in stdlib/ipc/mod_simple.csd:43
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test write_to_pipe with temp file
    // Example: write_to_pipe(temp_path);
    // Example: write_to_pipe(temp_path, data, size);
...
// Additional test functions for write_to_pipe
