...
// Targets: demonstrate_json_processing in examples/type_switch_advanced.csd:68
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_json_processing(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_json_processing(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_json_processing(data, 0);        // Zero size
        // demonstrate_json_processing(data, 1);        // Single byte
        // demonstrate_json_processing(data, size);     // Full size
        // demonstrate_json_processing(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_json_processing
