...
// Targets: LoadConfig in stdlib/embed_that/mod.csd:273
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test LoadConfig with temp file
    // Example: LoadConfig(temp_path);
    // Example: LoadConfig(temp_path, data, size);
...
// Additional test functions for LoadConfig
