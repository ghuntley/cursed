...
// Targets: submit_write in src/runtime/async_poller.rs:366
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test submit_write with temp file
    // Example: submit_write(temp_path);
    // Example: submit_write(temp_path, data, size);
