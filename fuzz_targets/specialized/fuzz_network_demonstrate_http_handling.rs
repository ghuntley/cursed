...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test packet parsing
    // Test demonstrate_http_handling with network data
    // Example: demonstrate_http_handling(data, size);
    // Example: demonstrate_http_handling(sockfd, data, size);
...
void test_socket_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_http_handling(sockfd, data, size);
