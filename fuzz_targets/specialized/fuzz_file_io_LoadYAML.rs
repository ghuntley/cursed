...
// Targets: LoadYAML in stdlib/embed_that/mod.csd:261
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test LoadYAML with temp file
    // Example: LoadYAML(temp_path);
    // Example: LoadYAML(temp_path, data, size);
...
// Additional test functions for LoadYAML
