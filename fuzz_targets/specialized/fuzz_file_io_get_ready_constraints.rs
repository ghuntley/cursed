...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test get_ready_constraints with temp file
    // Example: get_ready_constraints(temp_path);
    // Example: get_ready_constraints(temp_path, data, size);
