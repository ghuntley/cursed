...
// Targets: loadFromFile in stdlib/package_manager/mod.csd:155
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test loadFromFile with temp file
    // Example: loadFromFile(temp_path);
    // Example: loadFromFile(temp_path, data, size);
