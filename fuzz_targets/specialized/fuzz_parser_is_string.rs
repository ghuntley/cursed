...
// Targets: is_string in stdlib/token_vibe/mod_backup.csd:104
// Risk Level: critical
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test is_string with fuzzed input
    // Example: is_string(allocator, input);
    // Example: is_string(input, size);
