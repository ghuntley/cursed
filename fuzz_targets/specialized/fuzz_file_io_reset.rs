...
// Targets: reset in src/stdlib/squish_core/zlib.rs:120
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test reset with temp file
    // Example: reset(temp_path);
    // Example: reset(temp_path, data, size);
...
// Additional test functions for reset
