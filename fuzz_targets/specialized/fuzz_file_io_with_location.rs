...
// Targets: with_location in src/runtime/stack_trace.rs:79
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test with_location with temp file
    // Example: with_location(temp_path);
    // Example: with_location(temp_path, data, size);
