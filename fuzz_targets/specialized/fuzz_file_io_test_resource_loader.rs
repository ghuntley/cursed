...
// Targets: test_resource_loader in src/stdlib/embed_that/resource_loader.rs:64
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_resource_loader with temp file
    // Example: test_resource_loader(temp_path);
    // Example: test_resource_loader(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // test_resource_loader(path);
}


// Additional test functions for test_resource_loader
