...
// Targets: test_struct_field_extraction in examples/ffi_demo.rs:556
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // test_struct_field_extraction(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // test_struct_field_extraction(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // test_struct_field_extraction(data, 0);        // Zero size
        // test_struct_field_extraction(data, 1);        // Single byte
        // test_struct_field_extraction(data, size);     // Full size
        // test_struct_field_extraction(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for test_struct_field_extraction
