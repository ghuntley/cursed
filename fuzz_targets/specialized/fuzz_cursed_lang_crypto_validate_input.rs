...
// Targets: crypto_validate_input in stdlib/crypto_complete/mod.csd:300
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // crypto_validate_input(cursed_code);
...
// Additional test functions for crypto_validate_input
