...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test check_tool_availability with temp file
    // Example: check_tool_availability(temp_path);
    // Example: check_tool_availability(temp_path, data, size);
