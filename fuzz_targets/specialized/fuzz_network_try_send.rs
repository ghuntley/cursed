...
// Targets: try_send in src/runtime/channels/channel_direction.rs:140
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test packet parsing
    // Test try_send with network data
    // Example: try_send(data, size);
    // Example: try_send(sockfd, data, size);
