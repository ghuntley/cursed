...
// Targets: child_token in src/runtime/async/task.rs:163
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test child_token with fuzzed input
    // Example: child_token(allocator, input);
    // Example: child_token(input, size);
...
// Additional test functions for child_token
