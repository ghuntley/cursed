...
// Targets: save_history in src/repl/enhanced_cursed_repl.rs:793
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test save_history with temp file
    // Example: save_history(temp_path);
    // Example: save_history(temp_path, data, size);
...
// Additional test functions for save_history
