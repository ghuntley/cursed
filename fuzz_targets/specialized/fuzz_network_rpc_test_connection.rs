...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test packet parsing
    // Test rpc_test_connection with network data
    // Example: rpc_test_connection(data, size);
    // Example: rpc_test_connection(sockfd, data, size);
...
void test_socket_operations(const uint8_t *data, size_t size) {
    ...
    // rpc_test_connection(sockfd, data, size);
