...
// Targets: run_single_test in stdlib/build_system/mod.csd:271
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test run_single_test with temp file
    // Example: run_single_test(temp_path);
    // Example: run_single_test(temp_path, data, size);
...
// Additional test functions for run_single_test
