...
// Targets: validateFunctionCall in src-zig/ffi_integration_enhanced.zig:482
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validateFunctionCall(cursed_code);
...
// Additional test functions for validateFunctionCall
