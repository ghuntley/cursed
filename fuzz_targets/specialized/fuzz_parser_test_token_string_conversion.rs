...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_token_string_conversion with fuzzed input
    // Example: test_token_string_conversion(allocator, input);
    // Example: test_token_string_conversion(input, size);
