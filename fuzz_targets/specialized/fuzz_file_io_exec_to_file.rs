...
// Targets: exec_to_file in stdlib/exec_slay/mod.csd:322
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test exec_to_file with temp file
    // Example: exec_to_file(temp_path);
    // Example: exec_to_file(temp_path, data, size);
...
// Additional test functions for exec_to_file
