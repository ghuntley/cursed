...
// Targets: test_file_output in stdlib/sus_log/test_sus_log.csd:149
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test test_file_output with temp file
    // Example: test_file_output(temp_path);
    // Example: test_file_output(temp_path, data, size);
...
// Additional test functions for test_file_output
