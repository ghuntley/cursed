...
// Targets: validate_score_type in examples/type_switch_vs_regular_switch.csd:333
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_score_type(cursed_code);
...
// Additional test functions for validate_score_type
