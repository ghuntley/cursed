...
// Targets: compile_to_c in self_hosting_compiler/codegen.csd:514
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test compile_to_c with temp file
    // Example: compile_to_c(temp_path);
    // Example: compile_to_c(temp_path, data, size);
...
// Additional test functions for compile_to_c
