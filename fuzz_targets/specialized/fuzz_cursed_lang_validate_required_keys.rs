...
// Targets: validate_required_keys in stdlib/configz/mod_with_arrays.csd:327
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_required_keys(cursed_code);
...
// Additional test functions for validate_required_keys
