...
// Targets: write_source_file in stdlib/formatter/formatter_cli.csd:186
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test write_source_file with temp file
    // Example: write_source_file(temp_path);
    // Example: write_source_file(temp_path, data, size);
...
// Additional test functions for write_source_file
