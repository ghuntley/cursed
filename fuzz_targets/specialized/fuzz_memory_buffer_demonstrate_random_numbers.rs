...
// Targets: demonstrate_random_numbers in examples/stdlib_examples/mathz_example.csd:157
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_random_numbers(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_random_numbers(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_random_numbers(data, 0);        // Zero size
        // demonstrate_random_numbers(data, 1);        // Single byte
        // demonstrate_random_numbers(data, size);     // Full size
        // demonstrate_random_numbers(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_random_numbers
