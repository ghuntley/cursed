...
// Targets: compile_with_debug in src/bin/cursed_debug.rs:122
// Risk Level: medium
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test compile_with_debug with fuzzed input
    // Example: compile_with_debug(allocator, input);
    // Example: compile_with_debug(input, size);
