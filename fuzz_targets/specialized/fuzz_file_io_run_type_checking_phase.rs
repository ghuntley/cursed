...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test run_type_checking_phase with temp file
    // Example: run_type_checking_phase(temp_path);
    // Example: run_type_checking_phase(temp_path, data, size);
