...
// Targets: wasm_validate_module_advanced in stdlib/wasm_mood/mod.csd:362
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // wasm_validate_module_advanced(cursed_code);
...
// Additional test functions for wasm_validate_module_advanced
