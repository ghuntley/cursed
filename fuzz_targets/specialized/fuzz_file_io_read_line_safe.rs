...
// Targets: read_line_safe in stdlib/vibez/core_functions.csd:119
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test read_line_safe with temp file
    // Example: read_line_safe(temp_path);
    // Example: read_line_safe(temp_path, data, size);
...
// Additional test functions for read_line_safe
