...
// Targets: validate_hostname_match in stdlib/tls_vibe/mod.csd:159
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_hostname_match(cursed_code);
...
// Additional test functions for validate_hostname_match
