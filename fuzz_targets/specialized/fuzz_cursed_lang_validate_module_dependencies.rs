...
// Targets: validate_module_dependencies in src/bootstrap/stage2/module_resolver.csd:164
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_module_dependencies(cursed_code);
...
// Additional test functions for validate_module_dependencies
