...
// Targets: load_history in src/repl/enhanced_cursed_repl.rs:772
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test load_history with temp file
    // Example: load_history(temp_path);
    // Example: load_history(temp_path, data, size);
...
// Additional test functions for load_history
