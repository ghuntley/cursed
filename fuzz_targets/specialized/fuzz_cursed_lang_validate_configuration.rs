...
// Targets: validate_configuration in stdlib/configz/mod_complex_syntax.csd:321
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_configuration(cursed_code);
...
// Additional test functions for validate_configuration
