...
// Targets: no_change in src/formatter/output.rs:395
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test no_change with temp file
    // Example: no_change(temp_path);
    // Example: no_change(temp_path, data, size);
...
// Additional test functions for no_change
