...
// Targets: worker_thread in stdlib/async_runtime/mod.csd:44
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test worker_thread with temp file
    // Example: worker_thread(temp_path);
    // Example: worker_thread(temp_path, data, size);
...
// Additional test functions for worker_thread
