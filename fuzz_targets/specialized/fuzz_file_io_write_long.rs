...
// Targets: write_long in stdlib/serialization/mod.csd:190
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test write_long with temp file
    // Example: write_long(temp_path);
    // Example: write_long(temp_path, data, size);
...
// Additional test functions for write_long
