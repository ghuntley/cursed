...
// Targets: initialize_optimization in src/optimization/optimization_full/pgo/mod.rs:151
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test initialize_optimization with temp file
    // Example: initialize_optimization(temp_path);
    // Example: initialize_optimization(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // initialize_optimization(path);
}


// Additional test functions for initialize_optimization
