...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test demonstrate_savepoint_transactions with temp file
    // Example: demonstrate_savepoint_transactions(temp_path);
    // Example: demonstrate_savepoint_transactions(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_savepoint_transactions(path);
}
