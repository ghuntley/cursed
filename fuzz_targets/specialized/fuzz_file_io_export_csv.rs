...
// Targets: export_csv in src/codegen/llvm/performance_monitor.rs:1121
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test export_csv with temp file
    // Example: export_csv(temp_path);
    // Example: export_csv(temp_path, data, size);
