...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test setup_instrumentation_infrastructure with fuzzed input
    // Example: setup_instrumentation_infrastructure(allocator, input);
    // Example: setup_instrumentation_infrastructure(input, size);
