...
// Targets: get_private_input_assignment in src/stdlib/packages/crypto_zk/circuit_builder.rs:304
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // get_private_input_assignment(cursed_code);
...
// Additional test functions for get_private_input_assignment
