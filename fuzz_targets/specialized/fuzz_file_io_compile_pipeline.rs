...
// Targets: compile_pipeline in stdlib/exec_slay/mod.csd:268
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test compile_pipeline with temp file
    // Example: compile_pipeline(temp_path);
    // Example: compile_pipeline(temp_path, data, size);
...
// Additional test functions for compile_pipeline
