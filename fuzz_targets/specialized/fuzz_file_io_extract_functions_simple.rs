...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test extract_functions_simple with temp file
    // Example: extract_functions_simple(temp_path);
    // Example: extract_functions_simple(temp_path, data, size);
