...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test save_optimization_report with temp file
    // Example: save_optimization_report(temp_path);
    // Example: save_optimization_report(temp_path, data, size);
