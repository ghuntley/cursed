...
// Targets: download_package in stdlib/build_system/mod.csd:89
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test download_package with temp file
    // Example: download_package(temp_path);
    // Example: download_package(temp_path, data, size);
