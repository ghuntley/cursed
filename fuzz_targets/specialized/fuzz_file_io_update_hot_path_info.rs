...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test update_hot_path_info with temp file
    // Example: update_hot_path_info(temp_path);
    // Example: update_hot_path_info(temp_path, data, size);
