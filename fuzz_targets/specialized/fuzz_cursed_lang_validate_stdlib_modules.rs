...
// Targets: validate_stdlib_modules in stdlib/testz/build_integration.csd:48
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // validate_stdlib_modules(cursed_code);
...
// Additional test functions for validate_stdlib_modules
