...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test packet parsing
    // Test demonstrate_connection_management with network data
    // Example: demonstrate_connection_management(data, size);
    // Example: demonstrate_connection_management(sockfd, data, size);
...
void test_socket_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_connection_management(sockfd, data, size);
