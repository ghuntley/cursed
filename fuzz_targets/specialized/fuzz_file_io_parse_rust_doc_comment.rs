...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test parse_rust_doc_comment with temp file
    // Example: parse_rust_doc_comment(temp_path);
    // Example: parse_rust_doc_comment(temp_path, data, size);
