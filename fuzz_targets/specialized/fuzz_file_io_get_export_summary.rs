...
// Targets: get_export_summary in src/metrics/mod.rs:621
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test get_export_summary with temp file
    // Example: get_export_summary(temp_path);
    // Example: get_export_summary(temp_path, data, size);
...
void test_path_operations(const uint8_t *data, size_t size) {
    ...
    // get_export_summary(path);
}


// Additional test functions for get_export_summary
