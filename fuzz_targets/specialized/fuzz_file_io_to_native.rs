...
// Targets: to_native in stdlib/path/mod.csd:601
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test to_native with temp file
    // Example: to_native(temp_path);
    // Example: to_native(temp_path, data, size);
...
// Additional test functions for to_native
