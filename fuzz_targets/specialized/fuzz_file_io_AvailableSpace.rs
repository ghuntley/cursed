...
// Targets: AvailableSpace in stdlib/slay_io/mod.csd:96
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test AvailableSpace with temp file
    // Example: AvailableSpace(temp_path);
    // Example: AvailableSpace(temp_path, data, size);
...
// Additional test functions for AvailableSpace
