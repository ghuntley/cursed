...
// Targets: test_sanitize_label_value in src/metrics/prometheus_exporter.rs:858
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // test_sanitize_label_value(cursed_code);
...
// Additional test functions for test_sanitize_label_value
