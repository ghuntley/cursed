...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test compile_to_ir_with_optimization with fuzzed input
    // Example: compile_to_ir_with_optimization(allocator, input);
    // Example: compile_to_ir_with_optimization(input, size);
