...
// Targets: quick_validate_certificate in src/stdlib/packages/crypto_pki/mod.rs:236
...
void test_cursed_syntax(const uint8_t *data, size_t size) {
    ...
    // quick_validate_certificate(cursed_code);
...
// Additional test functions for quick_validate_certificate
