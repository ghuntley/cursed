...
// Targets: ready in src/runtime/async_real.rs:69
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test ready with temp file
    // Example: ready(temp_path);
    // Example: ready(temp_path, data, size);
...
// Additional test functions for ready
