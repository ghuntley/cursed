...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test write_memory_at_offset with temp file
    // Example: write_memory_at_offset(temp_path);
    // Example: write_memory_at_offset(temp_path, data, size);
