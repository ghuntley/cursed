...
// Targets: demonstrate_advanced_constraints in examples/generics/advanced_constraints.csd:448
...
void test_buffer_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_advanced_constraints(buffer, data, size);
...
void test_string_operations(const uint8_t *data, size_t size) {
    ...
    // demonstrate_advanced_constraints(str);
...
void test_boundary_conditions(const uint8_t *data, size_t size) {
    // Test edge cases
    if (size > 0) {
        // demonstrate_advanced_constraints(data, 0);        // Zero size
        // demonstrate_advanced_constraints(data, 1);        // Single byte
        // demonstrate_advanced_constraints(data, size);     // Full size
        // demonstrate_advanced_constraints(NULL, 0);        // NULL pointer
    }
}


// Additional test functions for demonstrate_advanced_constraints
