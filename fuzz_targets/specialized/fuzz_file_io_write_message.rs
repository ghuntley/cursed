...
// Targets: write_message in src/runtime/debug_output.rs:300
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test write_message with temp file
    // Example: write_message(temp_path);
    // Example: write_message(temp_path, data, size);
