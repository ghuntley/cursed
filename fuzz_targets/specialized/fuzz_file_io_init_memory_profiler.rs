...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test init_memory_profiler with temp file
    // Example: init_memory_profiler(temp_path);
    // Example: init_memory_profiler(temp_path, data, size);
