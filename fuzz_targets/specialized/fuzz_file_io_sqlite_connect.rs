...
// Targets: sqlite_connect in stdlib/database_production/mod.csd:498
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test sqlite_connect with temp file
    // Example: sqlite_connect(temp_path);
    // Example: sqlite_connect(temp_path, data, size);
