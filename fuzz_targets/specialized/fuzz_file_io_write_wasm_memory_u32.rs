...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test write_wasm_memory_u32 with temp file
    // Example: write_wasm_memory_u32(temp_path);
    // Example: write_wasm_memory_u32(temp_path, data, size);
