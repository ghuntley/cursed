...
// Targets: init_workspace in src/package_manager/mod.rs:615
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test init_workspace with temp file
    // Example: init_workspace(temp_path);
    // Example: init_workspace(temp_path, data, size);
