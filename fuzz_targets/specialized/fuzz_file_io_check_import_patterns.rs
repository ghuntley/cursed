...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test check_import_patterns with temp file
    // Example: check_import_patterns(temp_path);
    // Example: check_import_patterns(temp_path, data, size);
