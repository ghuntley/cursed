...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    // Test spawn_cursed_program with temp file
    // Example: spawn_cursed_program(temp_path);
    // Example: spawn_cursed_program(temp_path, data, size);
