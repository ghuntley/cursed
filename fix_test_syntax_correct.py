#!/usr/bin/env python3
"""
Script to correctly fix CURSED variable declaration syntax.

Based on the CURSED grammar spec, the correct syntax is:
VarSpec = IdentifierList ( Type [ "=" ExpressionList ] | "=" ExpressionList )

So it should be: sus <identifier> <type> = <value>
NOT: sus <type> <identifier> = <value>
"""
...
def fix_incorrect_variable_declarations(content):
    """Fix sus <type> <identifier> back to sus <identifier> <type>."""
    # Fix patterns like "sus int normie" back to "sus normie int"
    # Fix patterns like "sus float value" back to "sus value float"
    
    patterns = [
        # Match: sus <type> <identifier> = <value>
        (r'sus (int|float|bool|str|normie|meal|tea|lit) ([a-zA-Z_][a-zA-Z0-9_]*)\s*=', r'sus \2 \1 ='),
        # Match: sus <type> <identifier> ;
        (r'sus (int|float|bool|str|normie|meal|tea|lit) ([a-zA-Z_][a-zA-Z0-9_]*)\s*;', r'sus \2 \1;'),
        # Match: sus <type> <identifier> at end of line
        (r'sus (int|float|bool|str|normie|meal|tea|lit) ([a-zA-Z_][a-zA-Z0-9_]*)\s*$', r'sus \2 \1'),
    ]
...
def fix_file(filepath):
    ...
    # Apply fixes
    content = fix_incorrect_variable_declarations(content)
