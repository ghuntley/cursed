...
@.str.0 = private unnamed_addr constant [119 x i8] c"Testing compiled error handling...") fam { yikes "Compiled error test" } sus err { vibez.spill("Caught compiled error:\00", align 1
