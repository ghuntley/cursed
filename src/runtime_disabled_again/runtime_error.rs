...
impl RuntimeError {
    ...
    pub fn new(base_error: CursedError, severity: ErrorSeverity, category: ErrorCategory) -> Self {
        RuntimeError {
            ...
            context: HashMap::new(),
            recoverable: matches!(severity, ErrorSeverity::Info | ErrorSeverity::Warning | ErrorSeverity::CursedError),
    ...
    fn categorize_base_error(error: &CursedError) -> (ErrorSeverity, ErrorCategory) {
        match error {
            CursedError::Io(_) => (ErrorSeverity::CursedError, ErrorCategory::Io),
            CursedError::Parse(_) => (ErrorSeverity::CursedError, ErrorCategory::Compilation),
            CursedError::Compile(_) => (ErrorSeverity::CursedError, ErrorCategory::Compilation),
            CursedError::Runtime(_) => (ErrorSeverity::CursedError, ErrorCategory::Runtime),
            CursedError::Type(_) => (ErrorSeverity::CursedError, ErrorCategory::Type),
            CursedError::TypeCompilation(_) => (ErrorSeverity::CursedError, ErrorCategory::Type),
            ...
            CursedError::TemplateError { .. } => (ErrorSeverity::CursedError, ErrorCategory::Runtime),
            CursedError::Panic { recoverable: true, .. } => (ErrorSeverity::CursedError, ErrorCategory::Runtime),
