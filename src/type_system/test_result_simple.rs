// TestResult Type System for CURSED - Simplified Implementation
...
mod tests {
    ...
    fn test_json_serialization() {
        ...
        assert!(json.contains("test_math"));
    ...
    fn test_xml_report_generation() {
        ...
        suite.add_test(TestResult::pass("test_1", "assert_eq", "Test passed"));
        report.add_suite(suite);
    ...
    fn test_html_report_generation() {
        ...
        assert!(html.contains("<title>CURSED Test Report</title>"));
    ...
    fn test_console_report_generation() {
        ...
        assert!(console.contains("CURSED Test Report"));
        assert!(console.contains("test_suite"));
        assert!(console.contains("✓"));
        assert!(console.contains("ALL TESTS PASSED"));
    }
}
