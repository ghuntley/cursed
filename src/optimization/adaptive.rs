...
mod tests {
    ...
    fn test_performance_trend() {
        ...
        for i in 0..20 {
            let time = Duration::from_millis(200 - i * 5); // Decreasing time = improving
    ...
    fn test_success_rate() {
        ...
        assert_eq!(success_rate.total_applications, 3);
        assert_eq!(success_rate.successful_applications, 2);
        assert_eq!(success_rate.success_rate(), 2.0 / 3.0);
    }
    
    #[test]
    fn test_learning_optimizer() {
        ...
        for i in 0..10 {
            let feedback = OptimizationFeedback {
                ...
                execution_time: Duration::from_millis(100 - i), // Improving performance
                memory_usage: 1024,
                success: true,
                error: None,
                timestamp: SystemTime::now(),
