...
use inkwell::{
    ...
    crate::types::{BasicType, BasicTypeEnum, VectorType, IntType, FloatType},
...
mod tests {
    ...
    fn test_vectorization_optimizer_creation() {
        ...
        // Verify default vector widths
        assert_eq!(optimizer.target_info.supported_widths["i32"], vec![4, 8, 16]);
        assert_eq!(optimizer.target_info.supported_widths["f32"], vec![4, 8, 16]);
        assert_eq!(optimizer.target_info.supported_widths["f64"], vec![2, 4, 8]);
    }
