...
mod tests {
    ...
    #[test]
    fn test_performance_calculator_creation() {
        let calculator = RealPerformanceCalculator::new();
        let history = calculator.performance_history.lock().unwrap();
        assert_eq!(history.len(), 0);
    }

    #[test]
    fn test_runtime_improvement_calculation() {
        let calculator = RealPerformanceCalculator::new();
        ...
        let current = BaselineMetrics {
            ...
            memory_accesses: 150,
            branch_count: 40,
            compile_time: Duration::from_millis(800),
            code_size_bytes: 3200,
        };
        
        let improvement = calculator.calculate_runtime_improvement(&baseline, &current);
        ...
        let snapshots = vec![
            ...
            PerformanceSnapshot {
                ...
                improvements: PerformanceImprovements {
                    ...
                    code_size_improvement: 0.2,
                    compilation_speedup: 1.1,
            ...
            PerformanceSnapshot {
                ...
                improvements: PerformanceImprovements {
                    ...
                    code_size_improvement: 0.3,
                    compilation_speedup: 1.2,
                    energy_efficiency: 0.3,
                },
            },
        ];
        
        let trend = calculator.calculate_trend(&snapshots, |s| s.improvements.runtime_improvement);
