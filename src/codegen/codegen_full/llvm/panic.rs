...
pub trait PanicCompiler {
    ...
    fn compile_panic_check(&mut self) -> crate::error::Result<()>;

    /// Generate LLVM IR to get panic message
    fn compile_get_panic_message(&mut self) -> crate::error::Result<()>;

    /// Generate LLVM IR for panic cleanup
    fn compile_panic_cleanup(&mut self) -> crate::error::Result<()>;
    ...
    fn compile_exit_recovery_scope(&mut self) -> crate::error::Result<()>;

    /// Generate LLVM IR to check if in recovery scope
    fn compile_in_recovery_scope(&mut self) -> crate::error::Result<()>;
...
impl<'ctx> LlvmPanicGenerator<'ctx> {
    ...
    fn get_panic_function(&mut self) -> crate::error::Result<()> {
    ...
    fn get_recover_function(&mut self) -> crate::error::Result<()> {
    ...
    fn get_has_panic_function(&mut self) -> crate::error::Result<()> {
    ...
    fn get_get_panic_message_function(&mut self) -> crate::error::Result<()> {
    ...
    fn get_enter_recovery_scope_function(&mut self) -> crate::error::Result<()> {
    ...
    fn get_exit_recovery_scope_function(&mut self) -> crate::error::Result<()> {
    ...
    fn get_in_recovery_scope_function(&mut self) -> crate::error::Result<()> {
    ...
    fn get_attempt_recovery_function(&mut self) -> crate::error::Result<()> {
