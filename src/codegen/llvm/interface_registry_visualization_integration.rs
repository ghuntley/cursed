...
impl<'ctx> InterfaceRegistryVisualizationIntegration<'ctx> for LlvmCodeGenerator<'ctx> {
    ...
    fn initialize_registry_visualization(&mut self) -> Result<(), Error> {
        ...
        let interfaces = <dyn InterfaceRegistryExtensionWithVisualization>::get_all_interfaces(&*self.interface_registry())?;
        ...
        for interface_name in &interfaces {
            ...
            if let Some(extensions) = <dyn InterfaceRegistryExtensionWithVisualization>::get_direct_extensions(&*self.interface_registry(), interface_name)? {
    ...
    fn visualize_interface_hierarchy(
        ...
        let hierarchy = <dyn InterfaceRegistryExtensionWithVisualization>::get_extension_hierarchy(&*self.interface_registry())?;
    ...
    fn check_interface_extension_relationship(
        ...
        self.check_extension_relationship(source_interface, target_interface)
    }
...
impl<'ctx> LlvmCodeGenerator<'ctx> {
    ...
    fn add_interface_context_to_error_message(
        ...
        match <dyn InterfaceRegistryExtensionWithVisualization>::get_direct_extensions(&*self.interface_registry(), source_interface) {
...
Error retrieving extension information for '{}': {}", 
        ...
        match <dyn InterfaceRegistryExtensionWithVisualization>::get_direct_implementors(&*self.interface_registry(), target_interface) {
