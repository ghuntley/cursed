    ...
    fn register_cryptz_functions(&mut self) {
        let cryptz_functions = vec![
            ...
            StdlibFunction {
                ...
                package: "cryptz".to_string(),
                return_type: "void".to_string(),
                param_types: vec!["hasher".to_string(), "string".to_string()],
                requires_gc: false,
                is_variadic: false,
            ...
            StdlibFunction {
                ...
                package: "cryptz".to_string(),
                return_type: "string".to_string(),
                param_types: vec!["hasher".to_string()],
                requires_gc: true,
                is_variadic: false,
            ...
            StdlibFunction {
                ...
                package: "cryptz".to_string(),
                return_type: "string".to_string(),
                param_types: vec!["bytes".to_string()],
                requires_gc: true,
                is_variadic: false,
            ...
            StdlibFunction {
                ...
                param_types: vec!["bytes".to_string(), "bytes".to_string(), "bytes".to_string()],
                requires_gc: true,
                is_variadic: false,
            ...
            StdlibFunction {
                ...
                package: "cryptz".to_string(),
                return_type: "crypto_result".to_string(),
                param_types: vec!["bytes".to_string(), "bytes".to_string(), "bytes".to_string(), "bytes".to_string()],
                requires_gc: true,
                is_variadic: false,
            ...
            StdlibFunction {
                ...
                package: "cryptz".to_string(),
                return_type: "crypto_result".to_string(),
                param_types: vec!["bytes".to_string(), "bytes".to_string(), "bytes".to_string(), "bytes".to_string(), "bytes".to_string()],
                requires_gc: true,
                is_variadic: false,
            ...
            StdlibFunction {
                ...
                param_types: vec!["bytes".to_string(), "bytes".to_string(), "i32".to_string(), "i32".to_string()],
                requires_gc: true,
                is_variadic: false,
            ...
            StdlibFunction {
                ...
                package: "cryptz".to_string(),
                return_type: "bytes".to_string(),
                param_types: vec!["bytes".to_string(), "bytes".to_string(), "i32".to_string(), "i32".to_string(), "i32".to_string(), "i32".to_string()],
                requires_gc: true,
                is_variadic: false,
            ...
            StdlibFunction {
                ...
                package: "cryptz".to_string(),
                return_type: "bool".to_string(),
                param_types: vec!["bytes".to_string(), "bytes".to_string()],
                requires_gc: false,
                is_variadic: false,
            ...
            StdlibFunction {
                ...
                package: "cryptz".to_string(),
                return_type: "bytes".to_string(),
                param_types: vec!["bytes".to_string(), "i32".to_string()],
                requires_gc: true,
                is_variadic: false,
    ...
    fn register_database_packages(&mut self) {
        ...
        let db_query_functions = vec![
            ...
            StdlibFunction {
                ...
                package: "sql_vibes".to_string(),
                return_type: "result_set".to_string(),
                param_types: vec!["prepared_statement".to_string(), "parameters...".to_string()],
                requires_gc: true,
                is_variadic: true,
            ...
            StdlibFunction {
                ...
                package: "sql_vibes".to_string(),
                return_type: "error".to_string(),
                param_types: vec!["prepared_statement".to_string()],
                requires_gc: false,
                is_variadic: false,
            ...
            StdlibFunction {
                ...
                package: "sql_vibes".to_string(),
                return_type: "error".to_string(),
                param_types: vec!["transaction".to_string(), "string".to_string()],
                requires_gc: false,
                is_variadic: false,
            ...
            StdlibFunction {
                ...
                package: "sql_vibes".to_string(),
                return_type: "i64".to_string(),
                param_types: vec!["result_set".to_string()],
                requires_gc: false,
                is_variadic: false,
            ...
            StdlibFunction {
                ...
                param_types: vec!["result_set".to_string(), "i64".to_string()],
                requires_gc: true,
                is_variadic: false,
            ...
            StdlibFunction {
                ...
                package: "sql_vibes".to_string(),
                return_type: "any".to_string(),
                param_types: vec!["row".to_string(), "i64".to_string()],
                requires_gc: true,
                is_variadic: false,
