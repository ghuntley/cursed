...
pub trait FunctionCompilation {
    ...
    fn compile_function_declaration(&mut self, func: &FunctionStatement) -> crate::error::Result<()>;
...
impl crate::codegen::llvm::LlvmCodeGenerator {
    ...
    fn compile_block_statement(&mut self, block: &crate::ast::block::BlockStatement) -> crate::error::Result<()> {
    ...
    fn compile_let_statement(&mut self, let_stmt: &crate::ast::LetStatement) -> crate::error::Result<()> {
    ...
    fn compile_expression_body(&mut self, expr: &Box<dyn Expression>) -> crate::error::Result<()> {
        use crate::ast::expressions::{Literal, LiteralValue};
    ...
    fn compile_identifier_expression(&mut self, identifier: &crate::ast::identifiers::Identifier) -> crate::error::Result<()> {
