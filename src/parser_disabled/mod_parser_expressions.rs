...
impl Parser {
    ...
    pub fn parse_expression(&mut self) -> crate::error::Result<()> {
        self.parse_expression_with_precedence(Precedence::Lowest)
    }
    
    /// Parse expression with given precedence level
    fn parse_expression_with_precedence(&mut self, precedence: Precedence) -> crate::error::Result<()> {
    ...
    fn parse_prefix_expression(&mut self) -> crate::error::Result<()> {
        match &self.current_token.token_type {
            ...
            _ => Err(CursedError::Parse(format!(
    ...
    fn parse_infix_expression(&mut self, left: Box<dyn Expression>) -> crate::error::Result<()> {
    ...
    fn parse_call_expression(&mut self, function: Box<dyn Expression>) -> crate::error::Result<()> {
    ...
    fn parse_index_expression(&mut self, left: Box<dyn Expression>) -> crate::error::Result<()> {
        let token = self.current_token.literal.clone();
    ...
    fn parse_dot_expression(&mut self, left: Box<dyn Expression>) -> crate::error::Result<()> {
        let token = self.current_token.literal.clone();
    ...
    /// Parse identifier
    fn parse_identifier(&mut self) -> crate::error::Result<()> {
    ...
    fn parse_integer_literal(&mut self) -> crate::error::Result<()> {
        let token = self.current_token.clone();
        
        let value = token.literal.parse::<i64>()
            .map_err(|_| CursedError::Parse(format!("Could not parse {} as integer", token.literal)))?;
    ...
    /// Parse float literal
    fn parse_float_literal(&mut self) -> crate::error::Result<()> {
        let token = self.current_token.clone();
        
        let value = token.literal.parse::<f64>()
            .map_err(|_| CursedError::Parse(format!("Could not parse {} as float", token.literal)))?;
    ...
    fn parse_string_literal(&mut self) -> crate::error::Result<()> {
        let token = self.current_token.clone();
        let value = token.literal.clone();
        self.advance_token()?;
    ...
    fn parse_boolean_literal(&mut self) -> crate::error::Result<()> {
        let token = self.current_token.clone();
    ...
    fn parse_nil_literal(&mut self) -> crate::error::Result<()> {
        let token = self.current_token.clone();
        self.advance_token()?;
    ...
    fn parse_grouped_expression(&mut self) -> crate::error::Result<()> {
        self.advance_token()?;
    ...
    fn parse_array_literal(&mut self) -> crate::error::Result<()> {
        let token = self.current_token.literal.clone();
    ...
    fn parse_hash_literal(&mut self) -> crate::error::Result<()> {
        let token = self.current_token.literal.clone();
    ...
    fn parse_function_literal(&mut self) -> crate::error::Result<()> {
        let token = self.current_token.literal.clone();
        ...
        let body = if let Ok(block_stmt) = self.parse_block_statement() {
            ...
            return Err(CursedError::Parse("Expected function body".to_string()));
        };
    ...
    fn parse_call_arguments(&mut self) -> crate::error::Result<()> {
        self.parse_expression_list(TokenType::RightParen)
    }
    
    /// Parse expression list separated by commas
    fn parse_expression_list(&mut self, end_token: TokenType) -> crate::error::Result<()> {
    ...
    fn parse_channel_receive(&mut self) -> crate::error::Result<()> {
    ...
    fn parse_channel_send(&mut self, left: Box<dyn Expression>) -> crate::error::Result<()> {
    ...
    fn parse_goroutine_spawn(&mut self) -> crate::error::Result<()> {
    ...
    fn parse_channel_type(&mut self) -> crate::error::Result<()> {
