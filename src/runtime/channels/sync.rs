...
mod tests {
    ...
    fn test_channel_selector() {
        ...
        selector.add_receive();
        selector.add_send();
        
        // Should complete quickly for try_select
        let result = selector.try_select();
        matches!(result, SelectResult::WouldBlock);
    }

    #[test]
    fn test_broadcast_channel() {
        let broadcast = BroadcastChannel::<i32>::new();
    ...
    fn test_channel_barrier() {
        let barrier = ChannelBarrier::new();
    ...
    fn test_barrier_wait_timeout() {
        ...
        let result = barrier.wait_timeout(Duration::from_millis(50));
    ...
    fn test_rate_limiter() {
        let limiter = ChannelRateLimiter::new(2, Duration::from_millis(100));
    ...
    fn test_rate_limiter_blocking() {
        let limiter = ChannelRateLimiter::new(1, Duration::from_millis(10));
