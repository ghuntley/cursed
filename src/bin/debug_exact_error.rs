...
fn main() {
    ...
    println!("🔍 Debugging exact error in demonstrateBasics...");
    
    // Test the exact function from the demo that fails
    let demo_func = r#"
...
"#;
    ...
    println!("Testing exact demonstrateBasics function...");
    let mut lexer = Lexer::new(demo_func.to_string());
