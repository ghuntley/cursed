...
impl<'ctx> ErrorPropagationCompiler<'ctx> {
    ...
    fn compile_expression(&mut self, expr: &dyn Expression) -> crate::error::Result<()> {
    ...
    fn create_result_ok(&self, value: BasicValueEnum<'ctx>, error_type: BasicTypeEnum<'ctx>) -> crate::error::Result<()> {
    ...
    fn create_result_err(&self, error: BasicValueEnum<'ctx>, success_type: BasicTypeEnum<'ctx>) -> crate::error::Result<()> {
    ...
    fn create_option_some(&self, value: BasicValueEnum<'ctx>) -> crate::error::Result<()> {
    ...
    fn create_option_none(&self, inner_type: BasicTypeEnum<'ctx>) -> crate::error::Result<()> {
...
impl<'ctx> ErrorPropagationCodegen<'ctx> for ErrorPropagationCompiler<'ctx> {
    ...
    fn compile_unwrap_or_expression(
        ...
        // CursedError path: use default value
        self.builder.position_at_end(error_block);
        self.builder.build_unconditional_branch(continue_block)
