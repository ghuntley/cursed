//! I/O functionality for certificate_generation
...
pub fn init_certificate_generation() -> IOResult<()> {
    ...
    println!("📁 I/O processing (certificate_generation) initialized");
    Ok(())
}

/// Test I/O functionality
pub fn test_certificate_generation() -> IOResult<()> {
    let handler = IOHandler::new();
