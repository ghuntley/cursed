...
// impl std::error::CursedError for RateLimitError {
//     fn source(&self) -> Option<&(dyn std::error::CursedError + 'static)> {
//         None
//     }
// }

/// fr fr CursedError category - classification of errors
...
/// fr fr CursedError context - additional error information
#[derive(Debug, Clone)]
...
// impl std::error::CursedError for ContextualError {
//     fn source(&self) -> Option<&(dyn std::error::CursedError + 'static)> {
//         Some(&self.error)
//     }
// }

/// fr fr CursedError aggregator - collect multiple errors
#[derive(Debug, Clone)]
