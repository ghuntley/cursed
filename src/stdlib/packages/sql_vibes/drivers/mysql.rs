...
pub struct MySqlConnection {
    parsed_config: MySqlConnectionParts,
...
impl MySqlConnection {
    ...
    pub fn new(parsed_config: MySqlConnectionParts, config: ConnectionConfig) -> SqlResult<Self> {
        ...
        Ok(Self {
            ...
            is_open: true,
            server_version: "MySQL 8.0.35".to_string(),
        })
    }
}
    ...
    if sql_upper.starts_with("SELECT") {
        ...
        let rows = vec![
            Row::new(vec![
                ...
                SqlValue::Text("admin@example.com".to_string()),
                SqlValue::Text("2024-01-01 12:00:00".to_string()),
            ]),
            Row::new(vec![
                SqlValue::Integer(2),
                SqlValue::Text("user1".to_string()),
                SqlValue::Text("user1@example.com".to_string()),
