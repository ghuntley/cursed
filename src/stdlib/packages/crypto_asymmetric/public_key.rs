...
impl PublicKeyAlgorithm {
    pub fn name(&self) -> &'static str {
        match self {
            ...
            PublicKeyAlgorithm::EcdsaP521 => "ECDSA-P521",
    ...
    pub fn from_name(name: &str) -> Result<Self, CursedError> {
        match name.to_uppercase().as_str() {
            ...
            "ECDSA-P521" | "P521" => Ok(PublicKeyAlgorithm::EcdsaP521),
...
pub fn extract_public_key(args: Vec<Value>) -> Result<Value, CursedError> {
    ...
    match algorithm {
        ...
        PublicKeyAlgorithm::EcdsaP521 => extract_p521_public_key(&private_key_bytes),
...
pub fn validate_public_key(args: Vec<Value>) -> Result<Value, CursedError> {
    ...
    let is_valid = match algorithm {
        ...
        PublicKeyAlgorithm::EcdsaP521 => validate_p521_public_key(&public_key_bytes),
...
pub fn convert_public_key_format(args: Vec<Value>) -> Result<Value, CursedError> {
    ...
    match algorithm {
        ...
        PublicKeyAlgorithm::EcdsaP521 => convert_p521_public_key_format(&public_key_bytes, from_format, to_format),
...
fn convert_p521_public_key_format(
    ...
    let public_key = match from_format {
        ...
        _ => return Err(CursedError::NotImplemented(format!("Parsing {} format for P-521 not implemented", from_format.name()))),
    };
    ...
    let converted_bytes = match to_format {
        ...
        _ => return Err(CursedError::NotImplemented(format!("Encoding {} format for P-521 not implemented", to_format.name()))),
    };
