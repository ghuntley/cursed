//! I/O functionality for key_generation
...
pub fn init_key_generation() -> IOResult<()> {
    ...
    println!("📁 I/O processing (key_generation) initialized");
    Ok(())
}

/// Test I/O functionality
pub fn test_key_generation() -> IOResult<()> {
    let handler = IOHandler::new();
