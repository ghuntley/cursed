//! I/O functionality for entropy_estimation
...
pub fn init_entropy_estimation() -> IOResult<()> {
    ...
    println!("📁 I/O processing (entropy_estimation) initialized");
    Ok(())
}

/// Test I/O functionality
pub fn test_entropy_estimation() -> IOResult<()> {
    let handler = IOHandler::new();
