...
// Result and query types
pub type ExecuteResult = usize;
pub type QueryStats = String;
pub type ResultMetadata = String;
pub type Query = String;
pub type QueryPlan = String;
pub type ExecutionStep = String;

// Transaction types
pub type TransactionOptions = String;
pub type TransactionState = String;
pub type TransactionIsolation = String;
pub type TransactionSavePoint = String;
