//! I/O functionality for iterator_utils
...
pub fn init_iterator_utils() -> IOResult<()> {
    ...
    println!("📁 I/O processing (iterator_utils) initialized");
    Ok(())
}

/// Test I/O functionality
pub fn test_iterator_utils() -> IOResult<()> {
    let handler = IOHandler::new();
