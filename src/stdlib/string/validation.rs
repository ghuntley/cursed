...
mod tests {
    ...
    fn test_is_alphabetic() {
        ...
        assert!(!is_alphabetic("hello world")); // Contains space
    }
    ...
    fn test_is_email() {
        ...
        assert!(is_email("test.email@domain.co.uk"));
    ...
    fn test_is_phone_number() {
        ...
        assert!(is_phone_number("+44 20 7946 0958"));
    ...
    fn test_balanced_brackets() {
        ...
        assert!(has_balanced_brackets("{[()]}"));
        assert!(has_balanced_brackets("hello [world (test)]"));
        assert!(!has_balanced_brackets("([)]"));
        assert!(!has_balanced_brackets("{[}]"));
        assert!(!has_balanced_brackets("("));
    }
