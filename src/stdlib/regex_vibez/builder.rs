...
mod tests {
    ...
    fn test_alternatives() {
        ...
        assert!(pattern.match_string("cat"));
        assert!(pattern.match_string("dog"));
        assert!(pattern.match_string("bird"));
        assert!(!pattern.match_string("fish"));
    }
    ...
    fn test_word_boundaries() {
        ...
        assert!(pattern.match_string("this is a test"));
        assert!(!pattern.match_string("testing"));
    }
    ...
    fn test_pattern_access() {
        ...
        assert_eq!(builder.pattern(), r"test\d");
    }
    ...
    fn test_clear_pattern() {
        ...
        assert!(pattern.match_string("new"));
        assert!(!pattern.match_string("test"));
    }
}
