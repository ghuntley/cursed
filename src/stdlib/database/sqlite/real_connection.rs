//! I/O functionality for real_connection
...
pub fn init_real_connection() -> IOResult<()> {
    ...
    println!("📁 I/O processing (real_connection) initialized");
    Ok(())
}

/// Test I/O functionality
pub fn test_real_connection() -> IOResult<()> {
    let handler = IOHandler::new();
