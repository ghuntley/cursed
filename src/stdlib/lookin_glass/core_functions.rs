//! I/O functionality for core_functions
...
pub fn init_core_functions() -> IOResult<()> {
    ...
    println!("📁 I/O processing (core_functions) initialized");
    Ok(())
}

/// Test I/O functionality
pub fn test_core_functions() -> IOResult<()> {
    let handler = IOHandler::new();
