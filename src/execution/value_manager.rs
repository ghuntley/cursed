...
mod tests {
    ...
    fn test_value_creation() {
        ...
        let int_val = manager.create_integer(42);
        assert_eq!(int_val, CursedValue::Integer(42));
        
        let float_val = manager.create_float(3.14);
        assert_eq!(float_val, CursedValue::Float(3.14));
        
        let string_val = manager.create_string("hello".to_string());
        assert_eq!(string_val, CursedValue::String("hello".to_string()));
        
        let bool_val = manager.create_boolean(true);
        assert_eq!(bool_val, CursedValue::Boolean(true));
    }

    #[test]
    fn test_value_arithmetic() {
        let a = CursedValue::Integer(10);
        let b = CursedValue::Integer(5);
        
        assert_eq!(a.add(&b), Some(CursedValue::Integer(15)));
        assert_eq!(a.subtract(&b), Some(CursedValue::Integer(5)));
        assert_eq!(a.multiply(&b), Some(CursedValue::Integer(50)));
        assert_eq!(a.divide(&b), Some(CursedValue::Integer(2)));
    }
    ...
    fn test_value_conversion() {
        ...
        let float_result = manager.convert_value(&int_val, &ValueType::Float);
        assert_eq!(float_result, Some(CursedValue::Float(42.0)));
        
        let string_result = manager.convert_value(&int_val, &ValueType::String);
        assert_eq!(string_result, Some(CursedValue::String("42".to_string())));
    }
    ...
    fn test_literal_parsing() {
        ...
        assert_eq!(manager.parse_literal("42"), Some(CursedValue::Integer(42)));
        assert_eq!(manager.parse_literal("3.14"), Some(CursedValue::Float(3.14)));
        assert_eq!(manager.parse_literal("true"), Some(CursedValue::Boolean(true)));
        assert_eq!(manager.parse_literal("\"hello\""), Some(CursedValue::String("hello".to_string())));
        assert_eq!(manager.parse_literal("nil"), Some(CursedValue::Nil));
    }
    ...
    fn test_value_formatting() {
        ...
        let int_val = CursedValue::Integer(42);
        assert_eq!(manager.format_value(&int_val), "42");
        
        let string_val = CursedValue::String("hello".to_string());
        assert_eq!(manager.format_value(&string_val), "\"hello\"");
        
        let bool_val = CursedValue::Boolean(true);
        assert_eq!(manager.format_value(&bool_val), "true");
    }
}
