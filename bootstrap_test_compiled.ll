...
; String constants
@.str.1 = private unnamed_addr constant [13 x i8] c"Test value: \00", align 1
@.str.0 = private unnamed_addr constant [23 x i8] c"Bootstrap Stage 2 Test\00", align 1
@.str.3 = private unnamed_addr constant [45 x i8] c"Bootstrap validation completed successfully!\00", align 1
@.str.2 = private unnamed_addr constant [9 x i8] c"Result: \00", align 1
define i32 @main() {
  %1 = getelementptr inbounds [23 x i8], [23 x i8]* @.str.0, i64 0, i64 0
  %2 = call i32 @puts(i8* %1)
  %3 = alloca i32, align 4
  store i32 42, i32* %3, align 4
  ; Variable test_value allocated at %3
  %4 = getelementptr inbounds [13 x i8], [13 x i8]* @.str.1, i64 0, i64 0
  %5 = call i32 @test_value_to_string()
  %6 = add i32 %4, %5
  ...
  %11 = getelementptr inbounds [9 x i8], [9 x i8]* @.str.2, i64 0, i64 0
  %12 = call i32 @result_to_string()
  %13 = add i32 %11, %12
  %14 = call i32 @puts(i8* %13)
  %15 = getelementptr inbounds [45 x i8], [45 x i8]* @.str.3, i64 0, i64 0
