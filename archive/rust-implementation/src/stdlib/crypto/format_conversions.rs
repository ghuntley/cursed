//! I/O functionality for format_conversions
...
pub fn init_format_conversions() -> IOResult<()> {
    ...
    println!("📁 I/O processing (format_conversions) initialized");
    Ok(())
}

/// Test I/O functionality
pub fn test_format_conversions() -> IOResult<()> {
    let handler = IOHandler::new();
