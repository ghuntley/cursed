//! Mathematical functionality for statistics
...
pub fn init_statistics() -> MathResult<()> {
    ...
    println!("🔢 Math processing (statistics) initialized");
    Ok(())
}

/// Test math functionality
pub fn test_statistics() -> MathResult<()> {
    let processor = MathProcessor::new();
