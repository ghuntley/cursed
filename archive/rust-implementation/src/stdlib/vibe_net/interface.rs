//! Network functionality for interface
...
pub fn init_interface() -> NetworkResult<()> {
    ...
    println!("🌐 Network processing (interface) initialized");
    Ok(())
}

/// Test network functionality
pub fn test_interface() -> NetworkResult<()> {
    let handler = NetworkHandler::new();
