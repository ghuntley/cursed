//! I/O functionality for type_disambiguation
...
pub fn init_type_disambiguation() -> IOResult<()> {
    ...
    println!("📁 I/O processing (type_disambiguation) initialized");
    Ok(())
}

/// Test I/O functionality
pub fn test_type_disambiguation() -> IOResult<()> {
    let handler = IOHandler::new();
