//! I/O functionality for communication
...
pub fn init_communication() -> IOResult<()> {
    ...
    println!("📁 I/O processing (communication) initialized");
    Ok(())
}

/// Test I/O functionality
pub fn test_communication() -> IOResult<()> {
    let handler = IOHandler::new();
