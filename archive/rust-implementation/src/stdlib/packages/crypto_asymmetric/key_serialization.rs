//! I/O functionality for key_serialization
...
pub fn init_key_serialization() -> IOResult<()> {
    ...
    println!("📁 I/O processing (key_serialization) initialized");
    Ok(())
}

/// Test I/O functionality
pub fn test_key_serialization() -> IOResult<()> {
    let handler = IOHandler::new();
