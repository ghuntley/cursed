//! I/O functionality for entropy_collection
...
pub fn init_entropy_collection() -> IOResult<()> {
    ...
    println!("📁 I/O processing (entropy_collection) initialized");
    Ok(())
}

/// Test I/O functionality
pub fn test_entropy_collection() -> IOResult<()> {
    let handler = IOHandler::new();
