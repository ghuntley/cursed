//! I/O functionality for connection_enum
...
pub fn init_connection_enum() -> IOResult<()> {
    ...
    println!("📁 I/O processing (connection_enum) initialized");
    Ok(())
}

/// Test I/O functionality
pub fn test_connection_enum() -> IOResult<()> {
    let handler = IOHandler::new();
