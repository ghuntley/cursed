//! String processing functionality for core
...
pub struct StringCoreProcessor {
    case_sensitive: bool,
}

impl StringCoreProcessor {
...
impl Default for StringCoreProcessor {
    fn default() -> Self {
        Self::new()
    }
}
...
pub fn init_core() -> StringResult<()> {
    let processor = StringCoreProcessor::new();
    ...
    println!("📝 String processing (core) initialized");
    Ok(())
}

/// Test string functionality
pub fn test_core() -> StringResult<()> {
    let processor = StringCoreProcessor::new();
