...
@.str.0 = private unnamed_addr constant [34 x i8] c"Number: %d, Float: %f, String: %s\00", align 1
define i32 @main() {
entry:
  %0 = getelementptr inbounds [34 x i8], [34 x i8]* @.str.0, i64 0, i64 0
  %0 = getelementptr inbounds [5 x i8], [5 x i8]* @.str.1, i64 0, i64 0
  %1 = call i32 (i8*, ...) @printf(i8* %0, i32 42, i32 3.14, i32 %0)
  ret i32 0
}
