// Pure WASM implementation without any std dependencies that might pull in POSIX
...
export fn cursed_wasm_version() [*:0]const u8 {
    return "CURSED v1.0.0-wasm-pure";
}
...
// Simple memory allocator using linear memory
var memory_offset: usize = 0x2000; // Start after initial memory
...
export fn cursed_wasm_init() i32 {
    memory_offset = 0x2000; // Reset memory offset
    return 0; // Success
}
