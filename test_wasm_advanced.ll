...
entry:
  ...
  ; Variable number allocated at %0
  %0 = getelementptr inbounds [10 x i8], [10 x i8]* @.str.0, i64 0, i64 0
  %1 = alloca i8*, align 4
  store i8* %0, i8** %1, align 4
  ; Variable text allocated at %1
  %1 = load i32, i32* %0, align 4
  %2 = add i32 %1, 10
  ...
  %6 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.2, i64 0, i64 0
  ...
  %11 = getelementptr inbounds [9 x i8], [9 x i8]* @.str.4, i64 0, i64 0
  %12 = call i32 @puts(i8* %11)
  %13 = load i32, i32* %3, align 4
  %14 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.2, i64 0, i64 0
  %15 = call i32 (i8*, ...) @printf(i8* %14, i32 %13)
  %14 = call i32 @add_numbers(i32 5, i32 7)
  %15 = alloca i32, align 4
  store i32 %14, i32* %15, align 4
  ; Variable sum allocated at %15
  %15 = getelementptr inbounds [6 x i8], [6 x i8]* @.str.5, i64 0, i64 0
...
label0:
  %20 = getelementptr inbounds [23 x i8], [23 x i8]* @.str.6, i64 0, i64 0
  %21 = call i32 @puts(i8* %20)
  br label %label2
label1:
  br label %label2
label2:
  %21 = getelementptr inbounds [1 x i8], [1 x i8]* @.str.7, i64 0, i64 0
  %21 = getelementptr inbounds [1 x i8], [1 x i8]* @.str.7, i64 0, i64 0
  %21 = getelementptr inbounds [32 x i8], [32 x i8]* @.str.8, i64 0, i64 0
  %22 = call i32 @puts(i8* %21)
  %22 = getelementptr inbounds [1 x i8], [1 x i8]* @.str.7, i64 0, i64 0
  %22 = alloca i32, align 4
  store i32 0, i32* %22, align 4
  ; Short declaration: i := 0 (i32)
  br label %label3
label3:
  %22 = load i32, i32* %22, align 4
  %23 = icmp slt i32 %22, 3
  br i1 %23, label %label4, label %label6
label4:
  %23 = getelementptr inbounds [17 x i8], [17 x i8]* @.str.9, i64 0, i64 0
...
label6:
  ...
  ; Variable numbers allocated at %29
  %29 = getelementptr inbounds [1 x i8], [1 x i8]* @.str.7, i64 0, i64 0
  %29 = getelementptr inbounds [1 x i8], [1 x i8]* @.str.7, i64 0, i64 0
  %29 = alloca [3 x i32], align 4
  %30 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.10, i64 0, i64 0
  %31 = getelementptr inbounds [3 x i32], [3 x i32]* %29, i64 0, i64 0
  store i32 %30, i32* %31, align 4
  %32 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.11, i64 0, i64 0
  %33 = getelementptr inbounds [3 x i32], [3 x i32]* %29, i64 0, i64 1
  store i32 %32, i32* %33, align 4
  %34 = getelementptr inbounds [2 x i8], [2 x i8]* @.str.12, i64 0, i64 0
  %35 = getelementptr inbounds [3 x i32], [3 x i32]* %29, i64 0, i64 2
  store i32 %34, i32* %35, align 4
  %34 = getelementptr inbounds [1 x i8], [1 x i8]* @.str.7, i64 0, i64 0
  %34 = getelementptr inbounds [1 x i8], [1 x i8]* @.str.7, i64 0, i64 0
  %34 = getelementptr inbounds [29 x i8], [29 x i8]* @.str.13, i64 0, i64 0
