...
@.str.0 = private unnamed_addr constant [19 x i8] c"default case works\00", align 1
define i32 @main() {
  ; Select statement - begin
declare i8* @cursed_select_prepare(i32)
declare i32 @cursed_select_add_case(i8*, i8*, i32, i8*)
declare i32 @cursed_select_execute(i8*, i1)
declare void @cursed_select_cleanup(i8*)
  %0 = call i8* @cursed_select_prepare(i32 0)
  %1 = call i32 @cursed_select_execute(i8* %0, i1 true)
  switch i32 %1, label %select_default [
    i32 -1, label %select_default
  ]
select_default:
  ; Execute select default case
  %2 = getelementptr inbounds [19 x i8], [19 x i8]* @.str.0, i64 0, i64 0
  ...
  br label %label0
label0:
  call void @cursed_select_cleanup(i8* %0)
