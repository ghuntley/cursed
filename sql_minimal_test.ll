...
; String constants
@.str.1 = private unnamed_addr constant [21 x i8] c"Starting SQL test...\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@.str.0 = private unnamed_addr constant [21 x i8] c"Test function works!\00", align 1
@.str.3 = private unnamed_addr constant [20 x i8] c"SQL test completed!\00", align 1
define i32 @main() {
  ...
  %3 = call i32 @test_function()
  %4 = getelementptr inbounds [20 x i8], [20 x i8]* @.str.3, i64 0, i64 0
  ; Converting complex expression to output
