...
; String constants
@.str.0 = private unnamed_addr constant [5 x i8] c"Done\00", align 1
define i32 @main() {
  ...
  store [3 x i32] %0, [3 x i32]* %4, align 4
  ; Variable arr allocated at %4
  %5 = getelementptr inbounds [5 x i8], [5 x i8]* @.str.0, i64 0, i64 0
