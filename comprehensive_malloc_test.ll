...
@.str.0 = private unnamed_addr constant [33 x i8] c"Testing comprehensive malloc fix\00", align 1
define i32 @main() {
  ...
  store double 42, double* %3, align 4
  ; Variable x allocated at %3
  %4 = getelementptr inbounds [12 x i8], [12 x i8]* @.str.2, i64 0, i64 0
  %5 = alloca i8*, align 4
  store i8* %4, i8** %5, align 4
  ; Variable y allocated at %5
  ...
  %12 = getelementptr inbounds [18 x i8], [18 x i8]* @.str.3, i64 0, i64 0
  ; Converting complex expression to output
