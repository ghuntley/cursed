...
; String constants
@.str.4 = private unnamed_addr constant [15 x i8] c"Loop completed\00", align 1
@.str.3 = private unnamed_addr constant [5 x i8] c"i = \00", align 1
@.str.1 = private unnamed_addr constant [1 x i8] c"\00", align 1
@.str.0 = private unnamed_addr constant [24 x i8] c"Testing loop statements\00", align 1
@.str.2 = private unnamed_addr constant [18 x i8] c"Breaking at i = 5\00", align 1
define i32 @main() {
  %1 = getelementptr inbounds [24 x i8], [24 x i8]* @.str.0, i64 0, i64 0
  %2 = call i32 @puts(i8* %1)
  %3 = alloca i32, align 4
  store i32 0, i32* %3, align 4
  ; Variable i allocated at %3
...
label0:
  %9 = getelementptr inbounds [18 x i8], [18 x i8]* @.str.2, i64 0, i64 0
  %10 = call i32 @puts(i8* %9)
  ; ERROR RECOVERY: Statement compilation failed
  %11 = getelementptr inbounds [5 x i8], [5 x i8]* @.str.3, i64 0, i64 0
  ...
  %18 = getelementptr inbounds [15 x i8], [15 x i8]* @.str.4, i64 0, i64 0
  %19 = call i32 @puts(i8* %18)
  ret i32 0
}

; COMPILATION SUMMARY: 1 errors encountered, 1 statements recovered
; WARNING: Error 1: Compiler error: Break statement outside of loop
