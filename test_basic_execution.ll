...
@.str.0 = private unnamed_addr constant [24 x i8] c"Hello, CURSED compiler!\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"%g\0A\00", align 1
@.str.1 = private unnamed_addr constant [28 x i8] c"Testing basic functionality\00", align 1
define i32 @main() {
entry:
  %0 = getelementptr inbounds [24 x i8], [24 x i8]* @.str.0, i64 0, i64 0
  %1 = call i32 @puts(i8* %0)
  %2 = getelementptr inbounds [28 x i8], [28 x i8]* @.str.1, i64 0, i64 0
  %3 = call i32 @puts(i8* %2)
  %4 = alloca double, align 4
  store double 42, double* %4, align 4
  ; Variable x allocated at %4
  %5 = getelementptr inbounds [15 x i8], [15 x i8]* @.str.2, i64 0, i64 0
