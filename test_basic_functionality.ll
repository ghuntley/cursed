...
; String constants
@.str.5 = private unnamed_addr constant [25 x i8] c"CURSED compiler working!\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"x =\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"y =\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@.str.4 = private unnamed_addr constant [8 x i8] c"x + y =\00", align 1
@.str.0 = private unnamed_addr constant [38 x i8] c"Testing basic CURSED functionality...\00", align 1
define i32 @main() {
  ...
  %15 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.3, i64 0, i64 0
  ; Converting complex expression to output
  ...
  %21 = getelementptr inbounds [8 x i8], [8 x i8]* @.str.4, i64 0, i64 0
  ; Converting complex expression to output
  ...
  ; Variable message allocated at %28
