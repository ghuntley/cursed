...
mod tests {
    ...
    fn test_vibez_spill() {
        ...
        let result = vibez::spill("Hello, Cursed!");
    ...
    fn test_mathz_functions() {
        ...
        assert_eq!(mathz::abs(-5), 5, "abs(-5) should be 5");
        assert_eq!(mathz::max(10, 20), 20, "max(10, 20) should be 20");
        assert_eq!(mathz::min(10, 20), 10, "min(10, 20) should be 10");
        assert!(mathz::sqrt(25.0) - 5.0 < 0.0001, "sqrt(25) should be approximately 5");
        
        // Test trigonometric functions
        let sin_pi_half = mathz::sin(std::f64::consts::PI / 2.0);
        assert!(sin_pi_half - 1.0 < 0.0001, "sin(π/2) should be approximately 1");
        
        let cos_pi = mathz::cos(std::f64::consts::PI);
    ...
    fn test_timez_functions() {
        ...
        let formatted = timez::format_time(now, "%Y-%m-%d");
    ...
    fn test_dot_registry() {
        ...
        let vibez_functions = registry.list_functions("vibez");
