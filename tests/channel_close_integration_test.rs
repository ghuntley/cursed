...
mod tests {
    ...
    fn test_try_operations_on_closed_channel() {
        ...
        assert!(channel.try_send(Object::Integer(200)).is_err());
    ...
    fn test_graceful_close_with_timeout() {
        ...
        let (zero_val, closed) = channel.receive().unwrap();
    ...
    fn test_channel_zero_values_by_type() {
        ...
        let (zero_int, closed) = int_channel.receive().unwrap();
        ...
        let (zero_float, closed) = float_channel.receive().unwrap();
        ...
        let (zero_bool, closed) = bool_channel.receive().unwrap();
        ...
        let (zero_string, closed) = string_channel.receive().unwrap();
        ...
        let (zero_unknown, closed) = unknown_channel.receive().unwrap();
        assert_eq!(zero_unknown, Object::Null);
        assert!(closed);
    }
    ...
    fn test_channel_state_consistency() {
        ...
        let (_, _) = channel.receive().unwrap();
    ...
    fn test_error_message_content() {
        ...
        let try_send_error = channel.try_send(Object::Integer(2)).unwrap_err();
    ...
    fn test_panic_protection() {
        ...
        for _ in 0..10 {
            ...
            let _ = channel.try_send(Object::Integer(1));
