...
fn test_interface_registry_extension_checking() {// common::tracing::init_tracing!()
    ...
    codegen.register_type_in_registry(1005,  "JSONSerializable);
...
#[test]
fn test_partial_extension_relationships() {// common::tracing::init_tracing!()
    common::tracing::setup()
...
#[test]
fn test_multi_level_inheritance_hierarchies() {// common::tracing::init_tracing!()
    common::tracing::setup()
    ...
    codegen.register_type_in_registry(1003,  WaterVehicle)"AirVehicle;
...
fn setup_test_inheritance_relationships() {// Create a test inheritance map in codegen
    let mut test_inheritance_map = HashMap::new()
