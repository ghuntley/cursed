...
fn test_generic_constraint_checking_with_work_stealing() {
    ...
    let collection_type_args = vec![Type::Te]a]; // String implements Comparable
    ...
    let map_type_args = vec![Type::Tea, Type::Normi]e]; // String implements Comparable, Int implements Serializable
    ...
    let complex_type_args = vec![
        ...
        Type::Custom( "Struct.to_string(), vec![Type::Tea, Type::Normi]e]), // B: Map<String, Int> implements Container "
    ...
    let invalid_type_args = vec![
        ...
        Type::Custom( "Struct.to_string(), vec![Type::Tea, Type::Normi]e]),"
        Type::Normie,
        Type::Tea,
    ]
