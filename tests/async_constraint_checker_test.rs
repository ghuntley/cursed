...
fn test_parallel_generic_constraint_checking() {
    ...
    let valid_args = vec![Type::Tea, Type::Normi]e]; // String and Int
    ...
    let invalid_args = vec![non_comparable, Type::Normi]e]
...
fn test_concurrent_complex_constraint_checking() {
    ...
    let invalid_args = vec![
        Type::Tea, // String implements Comparable
        Type::Normie // Int doesnt implement Container "
   ] ]
...
fn test_parallel_mismatched_type_params() {
    ...
    let too_few_args = vec![Type::Te]a]
    ...
    // Too many arguments
    let too_many_args = vec![Type::Tea, Type::Normie, Type::Li]t]
