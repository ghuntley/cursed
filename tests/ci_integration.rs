...
fn test_linux_specific_bootstrap() {info!(Running Linux-specific bootstrap tests);
    ...
    let linux_source = r#"func main() {// Basic Linux-compatible program"# return 0};"linux_test , linux_source)   {Ok(_) => {info!("Linux-specific bootstrap test "failed);}"
...
#;
    ...
    let windows_source = r#"func main() {// Basic Windows-compatible program"# return 0};";"
