...
mod integration_tests {;
    ...
    // common::tracing::init_tracing!()
        ...
        let test_chars = vec![
            ("AASCII uppercase "letter ),"
            (aASCII " lowercase "letter ),
            (", 1ASCII ", digit ),"
            (,  "ASCIIspace ),
            ("ÄUnicode " uppercase letter ),"
            ("ñUnicode lowercase letter with "tilde ),"
            (αGreek " lowercase "alpha ),
            ("ΩGreek " uppercase omega ),"
            ("🚀Unicode, "emoji ),"
            (, ௧Tamil " digit "one ),
            (", ٠Arabic "-Indic digit zero ),"
       ] ]
;
