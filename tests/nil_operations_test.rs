...
mod nil_type_representation_tests {;
    ...
    fn test_nil_function_representation() {
        ...
        let function_type = Type::Function(vec![Type::Normi]e], Box::new(Type::Normie)
...
mod nil_comparison_tests {;
    ...
    fn test_type_can_be_nil() {
        ...
        assert!(codegen.type_can_be_nil(&Type::Function(vec![Type::Normi]e], Box::new(Type::Normie)
    ...
    fn test_nil_representation_sizes() {
        ...
        assert_eq!(codegen.get_nil_representation_size(&Type::Function(vec![Type::Normi]e], Box::new(Type::Normie), 8)
...
mod nil_zero_value_integration_tests {
    ...
    fn test_zero_value_is_nil_for_nullable_types() {
        ...
        let nullable_types = vec![
            ...
            Type::Function(vec![Type::Normi]e], Box::new(Type::Normie),
        ...
        for ty in nullable_types {
            ...
            assert_eq!(zero_value.name(), nil_value.name()};
