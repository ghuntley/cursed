...
fn test_slice_len() -> Result<(), Box<dyn Error>> {
    ...
    assert!(len_value.get_type().is_int_type(), "Length should be an integer");
...
fn test_slice_cap() -> Result<(), Box<dyn Error>> {
    ...
    assert!(cap_value.get_type().is_int_type(), "Capacity should be an integer");
...
fn test_slice_copy() -> Result<(), Box<dyn Error>> {
    ...
    assert!(copied_slice.get_type().is_struct_type(), "Copied slice should be a struct");
...
fn test_slice_subslice() -> Result<(), Box<dyn Error>> {
    ...
    assert!(subslice.get_type().is_struct_type(), "Subslice should be a struct");
...
fn test_slice_append() -> Result<(), Box<dyn Error>> {
    ...
    assert!(appended_slice.get_type().is_struct_type(), "Appended slice should be a struct");
...
fn test_slice_index() -> Result<(), Box<dyn Error>> {
    ...
    assert!(
        element_value.get_type().is_int_type(), 
