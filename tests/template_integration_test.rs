...
fn create_test_data() -> HashMap<String, CursedObject> {
    ...
    user.insert("name".to_string(), CursedObject::String("Alice Johnson".to_string()));
    ...
    let posts = vec![
        {
            ...
            post.insert("title".to_string(), CursedObject::String("First Post".to_string()));
        ...
        {
            let mut post = HashMap::new();
            post.insert("title".to_string(), CursedObject::String("Second Post".to_string()));
...
fn test_template_engine_basic_rendering() {
    ...
    context.set("title", CursedObject::String("Test Page".to_string()));
...
fn test_template_syntax_parsing() {
    ...
    let mut parser = TemplateParser::new(simple_tokens);
...
"#;
    ...
    let mut context = TemplateContext::new();
    context.set("title", CursedObject::String("Test Page".to_string()));
    context.set("site_name", CursedObject::String("My Site".to_string()));
...
fn test_email_template_rendering() {
    ...
    email_data.insert("text".to_string(), CursedObject::String("Welcome to our service!".to_string()));
    ...
    assert!(result.contains("Welcome to our service!"));
}
...
fn test_global_context_variables() {
    ...
    engine.set_global("app_name", CursedObject::String("Test App".to_string())).unwrap();
...
fn test_template_performance_and_caching() {
    ...
    let mut context = TemplateContext::new();
    context.set("title", CursedObject::String("Performance Test".to_string()));
    context.set("content", CursedObject::String("Testing performance".to_string()));
    ...
    assert!(result1.contains("Performance Test"));
...
"#;
    ...
    org.insert("name".to_string(), CursedObject::String("Tech Corp".to_string()));
    ...
    let departments = vec![
        {
            ...
            manager.insert("name".to_string(), CursedObject::String("John Doe".to_string()));
            ...
            let employees = vec![
                {
                    ...
                    emp.insert("role".to_string(), CursedObject::String("Senior Developer".to_string()));
                ...
                },
                {
                    ...
                    emp.insert("role".to_string(), CursedObject::String("DevOps Engineer".to_string()));
                    emp.insert("skills".to_string(), CursedObject::Array(vec![
    ...
    assert!(result.contains("DevOps Engineer"));
...
fn test_template_middleware_integration() {
    ...
    let request = WebTemplateRequest {
        ...
        query: {
            ...
            query.insert("tab".to_string(), "settings".to_string());
            query
        },
        form: HashMap::new(),
        cookies: HashMap::new(),
...
fn test_template_rendering_performance() {
    ...
    println!("Rendered 100 templates in {:?}", duration);
