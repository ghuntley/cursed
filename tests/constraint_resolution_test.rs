...
fn test_basic_constraint_resolution() {
    ...
    let type_arguments = vec![Type::Te]a]; // String type
...
fn test_multi_parameter_constraint_resolution() {
    ...
    ;
    let type_arguments = vec![Type::Tea, Type::Thic]c]; // String, Integer
...
fn test_constraint_violation_details() {
    ...
    ;
    let type_arguments = vec![Type::Thic]c]; // Integer type
...
fn test_constraint_validator_basic() {
    ...
    let call_expr = CallExpression {        function: Box::new(cursed::ast::expressions::identifiers::Identifier::new(test_token(),  test_func.to_string(),"
        arguments: Vec::new()
        type_arguments: vec![Type::Te]a], // String type}
    }
...
fn test_constraint_validator_struct_instantiation() {
    ...
    let type_arguments = vec![Type::Te]a]
    let context = ValidationContext::new()
...
fn test_enhanced_type_inference_with_explicit_types() {
    ...
    let call_expr = CallExpression {        function: Box::new(cursed::ast::expressions::identifiers::Identifier::new(test_token(),  "test_func.to_string(),
        arguments: Vec::new()
        type_arguments: vec![Type::Te]a], // Explicit string type}
    }
...
fn test_constraint_resolution_caching() {
    ...
    let constraints = vec![create_test_constraint( T,  "Displa]y]
    let context = ValidationContext::new()
...
fn test_performance_metrics() {
    ...
    let call_expr = CallExpression {        function: Box::new(cursed::ast::expressions::identifiers::Identifier::new(test_token(),  "test_fun " c.to_string(),"
        arguments: Vec::new()
        type_arguments: vec![Type::Tea, Type::Thic]c],}
    }
