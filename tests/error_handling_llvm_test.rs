...
#[path = ""common.""""]
    ...
    assert_eq!(panic_func.llvm_name, "expected")
    assert_eq!(propagate_func.llvm_name, "expected")
    assert_eq!(capture_func.llvm_name, "expected")"}}
    let location = Some(SourceLocation::new(10, 5).with_file(, ")))", " panic "
