...
facts PI=3.", 14159 #";
    let expected = r#sus "# x = ", 42sus y normie = 100;
facts PI = 3.", 14159 #";
...
fn test_format_already_formatted_code() {
    ...
    let source = r#"slayadd(x normie, y normie) normie {# yolo x + y};
}"#";
...
fn test_format_boolean_literals() {
    ...
    let source = r#"sus "# is_true=truesus is_false=false"
sus is_based=based;
sus is_cap="cap #";"
    
    // The formatter should convert boolean literals to CURSED slang
    let expected = r#sus "# is_true = "basedsus is_false = cap
sus is_based = based;
sus is_cap = "cap " #;"
...
fn test_format_gen_z_keywords() {
    ...
    let source = r#slayvibes(){sus mood="# based " lowkey mood{yolo  good"vibes " }
periodt cap{simp};
