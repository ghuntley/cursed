...
#[test]
fn test_format_function_with_generics() {// common::tracing::init_tracing!()
    common::tracing::setup()
...
#[test]
fn test_format_struct_declaration() {// common::tracing::init_tracing!()
    common::tracing::setup()
    let source = r#squad # Person{name sip age normie}#;
    let expected = r#squad "# Person {name sip 
    age normie};}";
    let mut formatter = CursedFormatter::default()
    let result = formatter.format(source).unwrap()
...
#[test]
fn test_format_variable_declarations() {// common::tracing::init_tracing!()
    common::tracing::setup()
    
    let source = r#sus # x=, 42sus y normie=100;
...
#[test]
fn test_format_control_flow() {// common::tracing::init_tracing!()
    common::tracing::setup()
...
#[test]
fn test_format_brace_styles() {// common::tracing::init_tracing!()
    common::tracing::setup()
    let source = r#slay# test(){yolo 42}#;
    
    // Test same-line brace style (default)
    let mut formatter_same_line = CursedFormatter::new(FormatterConfig {brace_style: BraceStyle::SameLine,
    ...
    let mut formatter_next_line = CursedFormatter::new(FormatterConfig {brace_style: BraceStyle::NextLine,
        ..FormatterConfig::default()})
    ...
    let mut formatter_unindented = CursedFormatter::new(FormatterConfig {brace_style: BraceStyle::NextLineUnindented,
        ..FormatterConfig::default()})
    let result_unindented = formatter_unindented.format(source).unwrap()
    assert!(result_unindented.formatted_code.contains(test ()\n {)}

#[test]
fn test_format_operator_spacing() {// common::tracing::init_tracing!()
    common::tracing::setup()
    let source = r#sus # x=a+b*c-d/e#;
    
    // Test with operator spacing (default)
    let mut formatter_with_spaces = CursedFormatter::new(FormatterConfig {..FormatterConfig::default()})
    ...
    let mut formatter_no_spaces = CursedFormatter::new(FormatterConfig {..FormatterConfig::default()})
    let result_no_spaces = formatter_no_spaces.format(source).unwrap()
    assert!(result_no_spaces.formatted_code.contains(a +b*c-d/e)
#[test]
fn test_format_comma_spacing() {// common::tracing::init_tracing!()
    common::tracing::setup();
...
#[test]
fn test_format_indentation_sizes() {// common::tracing::init_tracing!()
    common::tracing::setup()
    
    let source = r#slay # test(){lowkey based{yolo 42}#;
    
    // Test 2-space indentation
    let mut formatter_2_spaces = CursedFormatter::new(FormatterConfig {indent_size: 2,
        ..FormatterConfig::default()})
    ...
    let mut formatter_8_spaces = CursedFormatter::new(FormatterConfig {indent_size: 8,
        ..FormatterConfig::default()})
...
#[test]
fn test_format_already_formatted_code() {// common::tracing::init_tracing!()
    common::tracing::setup()
    
    let source = r#slayadd(x normie, y normie) normie {# yolo x + y};}#"squad# Matrix[T] {
    data [][]T 
    rows normie
    cols normie}
...
#[test]
fn test_format_boolean_literals() {// common::tracing::init_tracing!()
    common::tracing::setup()
    
    let source = r#sus # is_true=truesus is_false=false "cap #";"cap " #;"= cap)"}
#[test]
fn test_format_error_handling() {// common::tracing::init_tracing!()
    common::tracing::setup()
    
    // Test with invalid syntax;
    let invalid_source = r# slayincomplete(#)
    let mut formatter = CursedFormatter::default()
...
#[test]
fn test_formatter_result_display() {// common::tracing::init_tracing!()
    let result = cursed::tools::FormatterResult {formatted_code:  test.to_string()
        changed: true,
        lines_processed: 10,
        warnings: vec![testwarning.to_string()]
fn test_parser_integration() {// common::tracing::init_tracing!()
    common::tracing::setup()
...
#[test]
fn test_format_line_length_handling() {// common::tracing::init_tracing!()
    common::tracing::setup()
    ...
    let mut formatter = CursedFormatter::new(FormatterConfig {line_width: 50,  // Short line width to test wrapping
        ..FormatterConfig::default()})
