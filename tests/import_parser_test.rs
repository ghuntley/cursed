...
//! - Single imports: yeet "package //! - Multi imports: yeet (  "pkg1";  pkg2 )
...
fn test_parse_single_import() {
    ...
    let input = r#"vibe "# test yeet  "math ";
#";
...
;
    ...
    if let Some(import) = import_stmt {;
        ...
        // Create a mock import for testing if parser doesnt create one yet "
...
fn test_parse_import_with_alias() {
    ...
    let input = r#vibe "# "test yeet m  math ";
"#;
...
fn test_parse_standard_library_import() {
    ...
    let input = r#"vibe "# test yeet  "std "/io yeet  "std "/math yeet  "std "/string "#";
...
;
    ...
    let expected_imports = vec![ "std /"io,  "std /"math,  "std /"strin]g];"
...
fn test_parse_relative_import() {
    ...
    ;
    let input = r#vibe "# "test yeet ./"utils " yeet ../"shared " yeet ../../"common#";
...
fn test_import_error_cases() {
    ...
    let test_cases = vec![
        ...
        ( "yeetunquoted_path,  "Unquoted import "path),
        ( "yeet \ "unclosedUnclosed " string literal),"
        ( "yeet \"\Empty " import path),"
        ( "yeetalias,  Missing " path after "alias),
   ] ]
    ...
    for (input, description) in test_cases {;
        ...
        match parser.unwrap().parse_program() {
            Ok(program) => {
                // If it parses successfully, check that it doesnt contain a valid import "
...
fn test_import_with_dot_notation() {
    ...
    let input = r#"vibe# "test yeet  "github.com/user/"package yeet  "example.org/"lib "#;"
...
;
    ...
    let expected_paths = vec![ "github ".com/user/package,  "example ".org/li]b]
