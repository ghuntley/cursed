...
#[test]
fn test_conversion_matrix_basic_functionality() {// common::tracing::init_tracing!()
    init_tracing()
...
#[test]
fn test_integer_to_float_conversion_matrix() {// common::tracing::init_tracing!()
    init_tracing()
...
#[test]
fn test_float_to_integer_conversion_matrix() {// common::tracing::init_tracing!()
    init_tracing()
...
#[test]
fn test_boolean_conversion_matrix() {// common::tracing::init_tracing!()
    init_tracing()
...
#[test]
fn test_all_integer_type_combinations() {// common::tracing::init_tracing!()
    init_tracing()
...
fn test_comprehensive_conversion_coverage() {// common::tracing::init_tracing!()
    init_tracing()
...
fn get_bit_width() {match type_     {Type::Normie // Was Smol => 8,
