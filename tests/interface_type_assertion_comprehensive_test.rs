...
fn test_basic_type_assertion_success() {
    ...
    info!(test_case =  "basic_type_assertion_successStarting ", test);"
...
fn test_nested_interface_hierarchies() {
    common::tracing::init_tracing!()
    info!(test_case =  "nested_interface_hierarchies,  "Startingtest)
...
fn test_debug_verbosity_levels() {
    common::tracing::init_tracing!()
    info!(test_case =  "debug_verbosity_levels,  Startingtest)
    ...
    let source = r#;
        ...
        slay checkErrorMessage() lit {}
            ...
            captcha {
                ...
                errorMessage = errorMessage +  "Error2:  + e.message + "\n ;"
            }
            ...
            captcha {
                ...
                errorMessage = errorMessage +  "Error3:  + e.message + "\n ;"
            }
