...
async fn test_project_template_integration() {
    ...
    assert_eq!(config.project.name, "test-cli-project", "Project name should match");
    assert!(!config.targets.is_empty(), "Generated project should have targets");
...
name = "test-project"
version = "0.1.0"
description = "A test CURSED project"
...
"#";
    ...
    fs::write(config_path, updated_config)
        .expect("Failed to update config with tools enabled");
}
