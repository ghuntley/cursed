...
fn test_prefix_expression() {let context = Context::create()
    ...
    // For a 32-bit integer representation of -5 in 2s complement, the unsigned value is 0xFFFFFFFB or 4294967291
    let signed_value = if extended & 0x80000000 != 0       {(extended as i64) - (1 << 32)} else {extended as i64}
