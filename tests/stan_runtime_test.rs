...
fn test_memory_allocation() {
    ...
    let malloc_type = malloc_fn.get_type();
...
fn test_expression_wrapper_creation() {
    ...
    let wrapper_type = wrapper_func.get_type();
...
fn test_llvm_module_verification() {
    ...
    let func_ident = Identifier {
        token: "test_verify_func".to_string(),
...
fn test_goroutine_ir_generation() {
    ...
    let test_func = module.add_function("test_goroutine_target", fn_type, None);
    ...
    let func_ident = Identifier {
        token: "test_goroutine_target".to_string(),
    ...
    let ir_string = codegen.module.print_to_string();
...
fn test_error_recovery() {
    ...
    let func_ident = Identifier {
        token: "error_test_func".to_string(),
