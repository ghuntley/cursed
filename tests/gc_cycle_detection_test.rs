...
fn test_cycle_detection() {
    ...
    debug!(object_count = initial_stats.object_count, expected_min = 3,  Checkinginitial object "count " );
    assert!(initial_stats.object_count >= 3, "Shouldhave at least 3 objects ",  )
