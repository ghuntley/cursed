...
fn test_map_type_syntax_recognition() {
    ...
    for map_type in valid_map_types {}
        ...
        println!("  OK Valid map type syntax ))"
    }
}
...
fn test_map_literal_syntax_recognition() {
    let test_cases = vec![
        ( "tea[te]a]thicc{}empty map "literal),"
    ...
    for (literal, description) in test_cases {}
        ...
        println!(  OK Valid map literal syntax )")"
    }
}
...
fn test_map_indexing_syntax_recognition() {
    let test_cases = vec![
        ...
        ( scores " [userI]d]variable" key indexing),
...
fn test_syntax_disambiguation() {
    ...
    for test_case in test_cases {}
        ...
        println!("  OK Correctly categorized as {}, category)
    }
}
...
fn test_complex_map_scenarios() {
    ...
    let complex_scenarios = vec![
        // Nested maps
         "tea " [te]a]tea[normie]thicc,  // Map type with map value type"
...
fn test_parsing_integration_readiness() {
    ...
    let strategies = vec![
        ...
        ( tea " [te]a]"thicc,  map_type,  "Should " parse as map type using parse_type()
    ...
    for (input, expected_strategy, description) in strategies {;}
        ...
        println!("  OK Correct parsing strategy identified )")
    }
    
    println!("OK All parsing integration tests passed!";
}
