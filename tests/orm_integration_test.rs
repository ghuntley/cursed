...
impl Entity for User {
    ...
    fn field_names() -> Vec<&static str> {"
        vec![ "id,  name,  "email,  "age,  created_at,  "updated_a]t]
    }
...
fn test_type_mapping() {
    ...
    assert!(matches!()
        i64_mapping, cursed::stdlib::database::orm::mapping::SqlTypeMapping::Simple {
            sql_type: SqlColumnType::BigInteger,
            nullable: false}
        }
    )
    ...
    assert!(matches!()
        string_mapping, cursed::stdlib::database::orm::mapping::SqlTypeMapping::Simple {
    ...
    assert!(matches!()
        option_string_mapping, cursed::stdlib::database::orm::mapping::SqlTypeMapping::Simple {
            sql_type: SqlColumnType::Text,
            nullable: true}
        }
    )
...
fn test_sql_generation() {
    ...
    assert!(sqlite_sql.contains("idINTEGER)
    assert!(sqlite_sql.contains( nameTEXT))"
}
...
fn test_error_handling() {
    ...
    assert!(error_string.contains( min_ "value );")
