...
#[test]
fn test_type_assertion_debug_configuration() {// Initialize tracing
    ...
    let config = TypeAssertionDebugConfig {print_all_assertions: true,
...
#[test]
fn test_register_runtime_type() {// Initialize tracing
    tracing_setup::init_test_tracing()
    ...
    // Enable debugging
    let config = TypeAssertionDebugConfig {print_all_assertions: false,
        print_failed_assertions: true,
        include_hierarchy: true,
        include_path_visualization: false,
        runtime_debug: true}
