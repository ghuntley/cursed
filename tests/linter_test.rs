...
mod tests {
    ...
    // init_tracing!();
        ...
        assert!(issue.message.contains("exceeds maximum length"));
    }
    ...
    // init_tracing!();
        ...
        let source = "line without trailing space\nline with trailing space \nanother clean line";
    ...
    // init_tracing!();
        ...
        assert!(mixed_indent_issues[0].message.contains("Mixed tabs and spaces"));
    }
    ...
    // init_tracing!();
        ...
        assert!(summary.contains("Linting complete"));
