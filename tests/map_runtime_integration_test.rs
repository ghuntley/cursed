...
impl<'ctx> MapRuntimeTester<'ctx> {
    ...
    fn compile_and_execute(&self, source: &str) -> Result<i32, Error> {
        ...
        let mut code_gen = LlvmCodeGenerator::new(self.context, "map_runtime_test", dummy_path);
    ...
    fn register_runtime_functions(&self, code_gen: &mut LlvmCodeGenerator<'ctx>) {
        ...
        code_gen.module().add_function("create_hashmap", create_map_type, Some(inkwell::module::Linkage::External));

        let insert_type = self.context.void_type().fn_type(&[void_ptr.into(), void_ptr.into(), void_ptr.into()], false);
        code_gen.module().add_function("hashmap_insert", insert_type, Some(inkwell::module::Linkage::External));

        let get_type = void_ptr.fn_type(&[void_ptr.into(), void_ptr.into()], false);
        code_gen.module().add_function("hashmap_get", get_type, Some(inkwell::module::Linkage::External));

        let has_key_type = bool_type.fn_type(&[void_ptr.into(), void_ptr.into()], false);
        code_gen.module().add_function("hashmap_has_key", has_key_type, Some(inkwell::module::Linkage::External));

        let size_type = i64_type.fn_type(&[void_ptr.into()], false);
        code_gen.module().add_function("hashmap_size", size_type, Some(inkwell::module::Linkage::External));
    }
...
#[test]
#[ignore = "Map iteration not yet fully implemented"] 
#[instrument]
...
#[test]
#[ignore = "Map access not yet fully implemented"]
#[instrument]
...
#[test]
#[ignore = "Map modification not yet fully implemented"]
#[instrument]
...
#[test]
#[ignore = "Nested maps not yet fully implemented"]
#[instrument]
