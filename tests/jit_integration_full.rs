...
fn test_variable_assignment() {
    ...
    assert!(output.contains("15"), "Expected output containing '15' (sum of 5 + 10), got:\n{}", output);
}
...
fn test_string_printing() {
    ...
    assert!(output.contains("Hello, CURSED!"), "Expected output containing 'Hello, CURSED!', got:\n{}", output);
}
