...
fn test_interface_type_assertion_failed() {
    ...
    let input = r#"
        ...
        slay main() tea {
            ...
            if ok {}
                return  "Should not "succeed} else {"}
...
fn test_interface_type_assertion_multiple() {
    ...
    let input = r#"
        ...
        slay main() tea {
            ...
            if ok1 && ok2 {}
                return  Both " assertions "succeeded} else if ok1 {}
                return  "Only " Shape assertion succeeded} else if ok2 {"}
                return  "Only Printable assertion "succeeded} else {"}
