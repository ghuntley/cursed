...
#[derive(Debug, Clone)]
pub struct BootstrapTestConfig {pub stage1_binary: String,
...
impl Default for BootstrapTestConfig    {fn default() {Self {stage1_binary: ./target/debug/cursed .to_string()
            test_data_dir: "./tests/bootstrap/"output .to_string()
            timeout_seconds: 30,
            enable_debug: false,
...
pub struct BootstrapTestMetrics {pub stage1_compile_time_ms: u64,
...
pub fn init_bootstrap_tests() {crate::common::init_tracing();
