...
fn run_test() {// Initialize tracing for the test
    ...
    ensure_temp_dir().map_err(|e| format!("Failed to create temp directory: {}, e)?)"tests /temp/range_test_{}.csd, generate_id()
...
#[test]
fn test_range_with_start_end() {// common::tracing::init_tracing!()
...
#[test]
fn test_array_index_value_iteration() {// common::tracing::init_tracing!()
...
#[test]
fn test_map_iteration() {// common::tracing::init_tracing!()
    ...
    let code = r#"        slay main() lit {sus scores = {Alice: 90,
            ...
            bestie value := flex scores {sum = sum + value}
...
fn test_map_key_value_iteration() {// common::tracing::init_tracing!()
    ...
    let code = r#"        slay main() lit {sus scores = {Alice: 90,
            ...
            bestie name, score := flex scores {fr Add score to sum
                sum = sum + score
