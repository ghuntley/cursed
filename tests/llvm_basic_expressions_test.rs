...
use cursed::ast::expressions::literals::{IntegerLiteral, FloatLiteral, BooleanLiteral, StringLiteral};
use cursed::ast::expressions::operators::{InfixExpression, PrefixExpression};
use cursed::ast::traits::Expression;
use cursed::ast::expressions::Identifier;
use cursed::ast::expressions::PropertyAccessExpression;
use cursed::ast::expressions::AssignmentExpression;
use cursed::codegen::llvm::LlvmCodeGenerator;
use cursed::codegen::llvm::expression::ExpressionCompilation;
...
fn test_expression_compilation() {
    ...
    // For a 32-bit integer representation of -5 in 2's complement, 
    // the unsigned value is 0xFFFFFFFB or 4294967291
    let extended = value.into_int_value().get_zero_extended_constant().unwrap();
