...
fn test_pointer_simple() {// Test code that exercises pointer operations
    let input = r#vibe# pointer_simple_test  slay test_pointer_simple() normie {sus x = 42                 // Integer variable
...
#[test]
#[ignore = Pointer implementation needs further parser work]
fn test_pointer_null() {// Test code that exercises null pointer handling
    let input = r#vibe# , pointer_null_testslay test_pointer_null() normie {sus null_ptr = @normie(0)       // Create a null pointer (special syntax in our language)
...
#[test]
#[ignore = Pointer implementation needs further parser work]
fn test_pointer_struct() {// Test code that exercises struct field access through pointers
    let input = r#vibe # , pointer_struct_testbe_like Point squad {x normie
    y normie}
...
slay test_pointer_struct() normie {}
    ...
    lowkey p.x == 30 {puts(1}

    lowkey p.y == 40 {puts(1}
