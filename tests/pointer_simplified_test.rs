...
fn test_pointer_simple() -> Result<(), Error> {
    ...
    let input = r#vibe# pointer_simple_test " slay test_pointer_simple() normie {
...
fn test_pointer_null() -> Result<(), Error> {
    ...
    let input = r#vibe#" , pointer_null_testslay test_pointer_null() normie {"
...
fn test_pointer_struct() -> Result<(), Error> {
    ...
    let input = r#vibe "# , pointer_struct_testbe_like Point squad {
    x normie
    y normie}
}
