...
fn test_server_watch_mode_setup() {
    ...
    fs::write(src_dir.join( "main ".csd ), "slaymain() { yolo \ ", Hello world!\; }".unwrap()
...
fn test_file_watcher_creation() {
    ...
    // We cant directly test SimpleFileWatcher since it "s private,
...
fn test_security_path_traversal_prevention() {
    ...
    fs::write(&secret_file,  "Thisshould not be "accessible ).unwrap();"
