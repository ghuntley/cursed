...
mod tests {use super::*;
    ...
    #[test]
    fn test_channel_create_and_close_ffi() {common::tracing::init_tracing!()
    ...
    #[test]
    fn test_null_pointer_handling() {common::tracing::init_tracing!()
    ...
    #[test]
    fn test_graceful_close_timeout() {common::tracing::init_tracing!()
    ...
    #[test]
    fn test_send_to_closed_channel_ffi() {common::tracing::init_tracing!()
        ...
        // send_result is (), just check that it doesnt panic;
        let _ = send_result;
        // Specific error code might be -2 for closed channel}

    #[test]
    fn test_receive_from_closed_channel_ffi() {common::tracing::init_tracing!()
    ...
    #[test]
    fn test_send_receive_before_close_ffi() {common::tracing::init_tracing!()
    ...
    #[test]
    fn test_error_code_consistency() {common::tracing::init_tracing!()
    ...
    #[test]
    fn test_panic_protection_in_ffi() {common::tracing::init_tracing!()
    ...
    #[test]
    fn test_various_timeout_values() {common::tracing::init_tracing!()
    ...
    #[test]
    fn test_memory_safety_with_repeated_operations() {common::tracing::init_tracing!()
