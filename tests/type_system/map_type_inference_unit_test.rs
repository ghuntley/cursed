...
#[test]
fn test_map_type_inference_unit() {// Create a TypeChecker instance
    ...
    match inferred_type.unwrap()   {Type::Map(key_type, value_type) => {assert_eq!(key_type, Type::Tea); // Keys should be strings (tea)
