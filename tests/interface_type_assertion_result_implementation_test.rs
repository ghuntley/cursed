...
#[test]
fn test_basic_type_assertion_structure() {// common::tracing::init_tracing!()
...
fn test_source_location_creation() {// common::tracing::init_tracing!()
    ...
    assert_eq!(source_location.source_line,  ".to_string()"}
#[test]
fn test_type_assertion_error_info_creation() {// common::tracing::init_tracing!()
    // Initialize tracing for this test
    init_tracing()
...
#[test]
fn test_type_assertion_compilation() {// common::tracing::init_tracing!()
    // Initialize tracing for this test
    init_tracing()
    
    // Create a simple test TypeAssertion AST node
    let type_assertion = TypeAssertion   {call:  dummy_name.to_string()
