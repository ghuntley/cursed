...
declare -i COMPILE_ERRORS=0
declare -i RUNTIME_ERRORS=0
declare -i OUTPUT_MISMATCHES=0
declare -i EXIT_CODE_ISSUES=0
declare -i INTERPRETER_ERRORS=0
...
echo "Found $total_files test files" >> $OUTPUT_FILE
...
for test_file in "${test_files[@]}"; do
    ...
    echo ""
    echo "[$TOTAL_TESTS/$total_files] Testing: $rel_path"
    echo "[$TOTAL_TESTS/$total_files] Testing: $rel_path" >> $OUTPUT_FILE
