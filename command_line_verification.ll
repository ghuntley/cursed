...
@.str.0 = private unnamed_addr constant [48 x i8] c"=== CURSED Command Line Module Verification ===\00", align 1
define i32 @main() {
  %0 = getelementptr inbounds [48 x i8], [48 x i8]* @.str.0, i64 0, i64 0
