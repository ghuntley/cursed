...
@.str.2 = private unnamed_addr constant [32 x i8] c"Testing archive_create function\00", align 1
@.str.0 = private unnamed_addr constant [31 x i8] c"Archive handling module loaded\00", align 1
@.str.5 = private unnamed_addr constant [1 x i8] c"\00", align 1
@.str.3 = private unnamed_addr constant [9 x i8] c"test.zip\00", align 1
...
define i32 @main() {
  ...
  %6 = getelementptr inbounds [9 x i8], [9 x i8]* @.str.3, i64 0, i64 0
  %7 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.4, i64 0, i64 0
  %8 = call i32 @archive_create(i32 %6, i32 %7)
  %9 = alloca i1, align 4
  store i1 %8, i1* %9, align 4
  ; Variable result allocated at %9
  %10 = getelementptr inbounds [1 x i8], [1 x i8]* @.str.5, i64 0, i64 0
  %11 = load i32, i32* %9, align 4
  %12 = getelementptr inbounds [1 x i8], [1 x i8]* @.str.5, i64 0, i64 0
  ret i32 0
}
