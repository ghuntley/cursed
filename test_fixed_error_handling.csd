// Fixed Error Handling Test for CURSED
// Using string concatenation instead of multiple arguments
...
slay test_multiple_errors() {
    ...
    bestie i := 0; i < 5; i++ {
        ...
        lowkey has_error {
            error_count++
            vibez.spill("Error handled for iteration " + string(i))
        }
    }
...
slay test_error_performance() {
    ...
    bestie i := 0; i < 100; i++ {
        ...
        lowkey has_error {
            vibez.spill("Processed error " + string(i))
        }
    }
...
slay test_error_monitoring() {
    ...
    bestie i := 0; i < 4; i++ {
        total_errors++
        vibez.spill("Monitored error type " + string(i))
    }
...
// Main test runner
slay main() {
    vibez.spill("Starting Basic Error Handling Tests...")
    ...
    vibez.spill("Basic Error Handling Tests Complete!")
}
