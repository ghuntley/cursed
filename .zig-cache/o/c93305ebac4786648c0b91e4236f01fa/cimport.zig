...
pub const struct_LLVMOpaqueError = opaque {};
pub const LLVMErrorRef = ?*struct_LLVMOpaqueError;
pub const LLVMErrorTypeId = ?*const anyopaque;
pub extern fn LLVMGetErrorTypeId(Err: LLVMErrorRef) LLVMErrorTypeId;
pub extern fn LLVMConsumeError(Err: LLVMErrorRef) void;
pub extern fn LLVMGetErrorMessage(Err: LLVMErrorRef) [*c]u8;
pub extern fn LLVMDisposeErrorMessage(ErrMsg: [*c]u8) void;
pub extern fn LLVMGetStringErrorTypeId() LLVMErrorTypeId;
pub extern fn LLVMCreateStringError(ErrMsg: [*c]const u8) LLVMErrorRef;
...
pub const LLVMJITSymbolFlags = extern struct {
    GenericFlags: u8 = @import("std").mem.zeroes(u8),
    TargetFlags: u8 = @import("std").mem.zeroes(u8),
};
pub const LLVMJITEvaluatedSymbol = extern struct {
    Address: LLVMOrcExecutorAddress = @import("std").mem.zeroes(LLVMOrcExecutorAddress),
    Flags: LLVMJITSymbolFlags = @import("std").mem.zeroes(LLVMJITSymbolFlags),
};
pub const struct_LLVMOrcOpaqueExecutionSession = opaque {};
pub const LLVMOrcExecutionSessionRef = ?*struct_LLVMOrcOpaqueExecutionSession;
pub const LLVMOrcErrorReporterFunction = ?*const fn (?*anyopaque, LLVMErrorRef) callconv(.c) void;
pub const struct_LLVMOrcOpaqueSymbolStringPool = opaque {};
pub const LLVMOrcSymbolStringPoolRef = ?*struct_LLVMOrcOpaqueSymbolStringPool;
pub const struct_LLVMOrcOpaqueSymbolStringPoolEntry = opaque {};
pub const LLVMOrcSymbolStringPoolEntryRef = ?*struct_LLVMOrcOpaqueSymbolStringPoolEntry;
pub const LLVMOrcCSymbolFlagsMapPair = extern struct {
    Name: LLVMOrcSymbolStringPoolEntryRef = @import("std").mem.zeroes(LLVMOrcSymbolStringPoolEntryRef),
    Flags: LLVMJITSymbolFlags = @import("std").mem.zeroes(LLVMJITSymbolFlags),
};
pub const LLVMOrcCSymbolFlagsMapPairs = [*c]LLVMOrcCSymbolFlagsMapPair;
pub const LLVMOrcCSymbolMapPair = extern struct {
    Name: LLVMOrcSymbolStringPoolEntryRef = @import("std").mem.zeroes(LLVMOrcSymbolStringPoolEntryRef),
    Sym: LLVMJITEvaluatedSymbol = @import("std").mem.zeroes(LLVMJITEvaluatedSymbol),
};
...
pub const LLVMOrcCSymbolAliasMapPair = extern struct {
    Name: LLVMOrcSymbolStringPoolEntryRef = @import("std").mem.zeroes(LLVMOrcSymbolStringPoolEntryRef),
    Entry: LLVMOrcCSymbolAliasMapEntry = @import("std").mem.zeroes(LLVMOrcCSymbolAliasMapEntry),
};
pub const LLVMOrcCSymbolAliasMapPairs = [*c]LLVMOrcCSymbolAliasMapPair;
pub const struct_LLVMOrcOpaqueJITDylib = opaque {};
pub const LLVMOrcJITDylibRef = ?*struct_LLVMOrcOpaqueJITDylib;
pub const LLVMOrcCSymbolsList = extern struct {
    Symbols: [*c]LLVMOrcSymbolStringPoolEntryRef = @import("std").mem.zeroes([*c]LLVMOrcSymbolStringPoolEntryRef),
    Length: usize = @import("std").mem.zeroes(usize),
};
pub const LLVMOrcCDependenceMapPair = extern struct {
    JD: LLVMOrcJITDylibRef = @import("std").mem.zeroes(LLVMOrcJITDylibRef),
    Names: LLVMOrcCSymbolsList = @import("std").mem.zeroes(LLVMOrcCSymbolsList),
};
...
pub const LLVMOrcCJITDylibSearchOrderElement = extern struct {
    JD: LLVMOrcJITDylibRef = @import("std").mem.zeroes(LLVMOrcJITDylibRef),
    JDLookupFlags: LLVMOrcJITDylibLookupFlags = @import("std").mem.zeroes(LLVMOrcJITDylibLookupFlags),
};
...
pub const LLVMOrcCLookupSetElement = extern struct {
    Name: LLVMOrcSymbolStringPoolEntryRef = @import("std").mem.zeroes(LLVMOrcSymbolStringPoolEntryRef),
    LookupFlags: LLVMOrcSymbolLookupFlags = @import("std").mem.zeroes(LLVMOrcSymbolLookupFlags),
};
pub const LLVMOrcCLookupSet = [*c]LLVMOrcCLookupSetElement;
pub const struct_LLVMOrcOpaqueMaterializationUnit = opaque {};
pub const LLVMOrcMaterializationUnitRef = ?*struct_LLVMOrcOpaqueMaterializationUnit;
pub const struct_LLVMOrcOpaqueMaterializationResponsibility = opaque {};
pub const LLVMOrcMaterializationResponsibilityRef = ?*struct_LLVMOrcOpaqueMaterializationResponsibility;
...
pub const struct_LLVMOrcOpaqueResourceTracker = opaque {};
pub const LLVMOrcResourceTrackerRef = ?*struct_LLVMOrcOpaqueResourceTracker;
pub const struct_LLVMOrcOpaqueDefinitionGenerator = opaque {};
pub const LLVMOrcDefinitionGeneratorRef = ?*struct_LLVMOrcOpaqueDefinitionGenerator;
pub const struct_LLVMOrcOpaqueLookupState = opaque {};
pub const LLVMOrcLookupStateRef = ?*struct_LLVMOrcOpaqueLookupState;
pub const LLVMOrcCAPIDefinitionGeneratorTryToGenerateFunction = ?*const fn (LLVMOrcDefinitionGeneratorRef, ?*anyopaque, [*c]LLVMOrcLookupStateRef, LLVMOrcLookupKind, LLVMOrcJITDylibRef, LLVMOrcJITDylibLookupFlags, LLVMOrcCLookupSet, usize) callconv(.c) LLVMErrorRef;
...
pub const struct_LLVMOrcOpaqueThreadSafeContext = opaque {};
pub const LLVMOrcThreadSafeContextRef = ?*struct_LLVMOrcOpaqueThreadSafeContext;
pub const struct_LLVMOrcOpaqueThreadSafeModule = opaque {};
pub const LLVMOrcThreadSafeModuleRef = ?*struct_LLVMOrcOpaqueThreadSafeModule;
pub const LLVMOrcGenericIRModuleOperationFunction = ?*const fn (?*anyopaque, LLVMModuleRef) callconv(.c) LLVMErrorRef;
pub const struct_LLVMOrcOpaqueJITTargetMachineBuilder = opaque {};
pub const LLVMOrcJITTargetMachineBuilderRef = ?*struct_LLVMOrcOpaqueJITTargetMachineBuilder;
pub const struct_LLVMOrcOpaqueObjectLayer = opaque {};
pub const LLVMOrcObjectLayerRef = ?*struct_LLVMOrcOpaqueObjectLayer;
pub const struct_LLVMOrcOpaqueObjectLinkingLayer = opaque {};
pub const LLVMOrcObjectLinkingLayerRef = ?*struct_LLVMOrcOpaqueObjectLinkingLayer;
pub const struct_LLVMOrcOpaqueIRTransformLayer = opaque {};
pub const LLVMOrcIRTransformLayerRef = ?*struct_LLVMOrcOpaqueIRTransformLayer;
pub const LLVMOrcIRTransformLayerTransformFunction = ?*const fn (?*anyopaque, [*c]LLVMOrcThreadSafeModuleRef, LLVMOrcMaterializationResponsibilityRef) callconv(.c) LLVMErrorRef;
pub const struct_LLVMOrcOpaqueObjectTransformLayer = opaque {};
pub const LLVMOrcObjectTransformLayerRef = ?*struct_LLVMOrcOpaqueObjectTransformLayer;
pub const LLVMOrcObjectTransformLayerTransformFunction = ?*const fn (?*anyopaque, [*c]LLVMMemoryBufferRef) callconv(.c) LLVMErrorRef;
pub const struct_LLVMOrcOpaqueIndirectStubsManager = opaque {};
pub const LLVMOrcIndirectStubsManagerRef = ?*struct_LLVMOrcOpaqueIndirectStubsManager;
pub const struct_LLVMOrcOpaqueLazyCallThroughManager = opaque {};
pub const LLVMOrcLazyCallThroughManagerRef = ?*struct_LLVMOrcOpaqueLazyCallThroughManager;
pub const struct_LLVMOrcOpaqueDumpObjects = opaque {};
pub const LLVMOrcDumpObjectsRef = ?*struct_LLVMOrcOpaqueDumpObjects;
...
pub const LLVMOrcExecutionSessionLookupHandleResultFunction = ?*const fn (LLVMErrorRef, LLVMOrcCSymbolMapPairs, usize, ?*anyopaque) callconv(.c) void;
...
pub extern fn LLVMOrcResourceTrackerRemove(RT: LLVMOrcResourceTrackerRef) LLVMErrorRef;
...
pub extern fn LLVMOrcMaterializationResponsibilityNotifyResolved(MR: LLVMOrcMaterializationResponsibilityRef, Symbols: LLVMOrcCSymbolMapPairs, NumPairs: usize) LLVMErrorRef;
pub extern fn LLVMOrcMaterializationResponsibilityNotifyEmitted(MR: LLVMOrcMaterializationResponsibilityRef) LLVMErrorRef;
pub extern fn LLVMOrcMaterializationResponsibilityDefineMaterializing(MR: LLVMOrcMaterializationResponsibilityRef, Pairs: LLVMOrcCSymbolFlagsMapPairs, NumPairs: usize) LLVMErrorRef;
pub extern fn LLVMOrcMaterializationResponsibilityFailMaterialization(MR: LLVMOrcMaterializationResponsibilityRef) void;
pub extern fn LLVMOrcMaterializationResponsibilityReplace(MR: LLVMOrcMaterializationResponsibilityRef, MU: LLVMOrcMaterializationUnitRef) LLVMErrorRef;
pub extern fn LLVMOrcMaterializationResponsibilityDelegate(MR: LLVMOrcMaterializationResponsibilityRef, Symbols: [*c]LLVMOrcSymbolStringPoolEntryRef, NumSymbols: usize, Result: [*c]LLVMOrcMaterializationResponsibilityRef) LLVMErrorRef;
...
pub extern fn LLVMOrcExecutionSessionCreateJITDylib(ES: LLVMOrcExecutionSessionRef, Result: [*c]LLVMOrcJITDylibRef, Name: [*c]const u8) LLVMErrorRef;
...
pub extern fn LLVMOrcJITDylibDefine(JD: LLVMOrcJITDylibRef, MU: LLVMOrcMaterializationUnitRef) LLVMErrorRef;
pub extern fn LLVMOrcJITDylibClear(JD: LLVMOrcJITDylibRef) LLVMErrorRef;
...
pub extern fn LLVMOrcLookupStateContinueLookup(S: LLVMOrcLookupStateRef, Err: LLVMErrorRef) void;
pub extern fn LLVMOrcCreateDynamicLibrarySearchGeneratorForProcess(Result: [*c]LLVMOrcDefinitionGeneratorRef, GlobalPrefx: u8, Filter: LLVMOrcSymbolPredicate, FilterCtx: ?*anyopaque) LLVMErrorRef;
pub extern fn LLVMOrcCreateDynamicLibrarySearchGeneratorForPath(Result: [*c]LLVMOrcDefinitionGeneratorRef, FileName: [*c]const u8, GlobalPrefix: u8, Filter: LLVMOrcSymbolPredicate, FilterCtx: ?*anyopaque) LLVMErrorRef;
pub extern fn LLVMOrcCreateStaticLibrarySearchGeneratorForPath(Result: [*c]LLVMOrcDefinitionGeneratorRef, ObjLayer: LLVMOrcObjectLayerRef, FileName: [*c]const u8, TargetTriple: [*c]const u8) LLVMErrorRef;
pub extern fn LLVMOrcCreateNewThreadSafeContext() LLVMOrcThreadSafeContextRef;
pub extern fn LLVMOrcThreadSafeContextGetContext(TSCtx: LLVMOrcThreadSafeContextRef) LLVMContextRef;
pub extern fn LLVMOrcDisposeThreadSafeContext(TSCtx: LLVMOrcThreadSafeContextRef) void;
pub extern fn LLVMOrcCreateNewThreadSafeModule(M: LLVMModuleRef, TSCtx: LLVMOrcThreadSafeContextRef) LLVMOrcThreadSafeModuleRef;
pub extern fn LLVMOrcDisposeThreadSafeModule(TSM: LLVMOrcThreadSafeModuleRef) void;
pub extern fn LLVMOrcThreadSafeModuleWithModuleDo(TSM: LLVMOrcThreadSafeModuleRef, F: LLVMOrcGenericIRModuleOperationFunction, Ctx: ?*anyopaque) LLVMErrorRef;
pub extern fn LLVMOrcJITTargetMachineBuilderDetectHost(Result: [*c]LLVMOrcJITTargetMachineBuilderRef) LLVMErrorRef;
pub extern fn LLVMOrcJITTargetMachineBuilderCreateFromTargetMachine(TM: LLVMTargetMachineRef) LLVMOrcJITTargetMachineBuilderRef;
...
pub extern fn LLVMOrcObjectLayerAddObjectFile(ObjLayer: LLVMOrcObjectLayerRef, JD: LLVMOrcJITDylibRef, ObjBuffer: LLVMMemoryBufferRef) LLVMErrorRef;
pub extern fn LLVMOrcObjectLayerAddObjectFileWithRT(ObjLayer: LLVMOrcObjectLayerRef, RT: LLVMOrcResourceTrackerRef, ObjBuffer: LLVMMemoryBufferRef) LLVMErrorRef;
pub extern fn LLVMOrcObjectLayerEmit(ObjLayer: LLVMOrcObjectLayerRef, R: LLVMOrcMaterializationResponsibilityRef, ObjBuffer: LLVMMemoryBufferRef) void;
...
pub extern fn LLVMOrcCreateLocalLazyCallThroughManager(TargetTriple: [*c]const u8, ES: LLVMOrcExecutionSessionRef, ErrorHandlerAddr: LLVMOrcJITTargetAddress, LCTM: [*c]LLVMOrcLazyCallThroughManagerRef) LLVMErrorRef;
...
pub extern fn LLVMOrcDumpObjects_CallOperator(DumpObjects: LLVMOrcDumpObjectsRef, ObjBuffer: [*c]LLVMMemoryBufferRef) LLVMErrorRef;
...
pub const LLVM_C_ORC_H = "";
pub const LLVM_C_ERROR_H = "";
pub const LLVMErrorSuccess = @as(c_int, 0);
...
pub const LLVMOpaqueError = struct_LLVMOpaqueError;
pub const LLVMOrcOpaqueExecutionSession = struct_LLVMOrcOpaqueExecutionSession;
pub const LLVMOrcOpaqueSymbolStringPool = struct_LLVMOrcOpaqueSymbolStringPool;
pub const LLVMOrcOpaqueSymbolStringPoolEntry = struct_LLVMOrcOpaqueSymbolStringPoolEntry;
pub const LLVMOrcOpaqueJITDylib = struct_LLVMOrcOpaqueJITDylib;
pub const LLVMOrcOpaqueMaterializationUnit = struct_LLVMOrcOpaqueMaterializationUnit;
pub const LLVMOrcOpaqueMaterializationResponsibility = struct_LLVMOrcOpaqueMaterializationResponsibility;
pub const LLVMOrcOpaqueResourceTracker = struct_LLVMOrcOpaqueResourceTracker;
pub const LLVMOrcOpaqueDefinitionGenerator = struct_LLVMOrcOpaqueDefinitionGenerator;
pub const LLVMOrcOpaqueLookupState = struct_LLVMOrcOpaqueLookupState;
pub const LLVMOrcOpaqueThreadSafeContext = struct_LLVMOrcOpaqueThreadSafeContext;
pub const LLVMOrcOpaqueThreadSafeModule = struct_LLVMOrcOpaqueThreadSafeModule;
pub const LLVMOrcOpaqueJITTargetMachineBuilder = struct_LLVMOrcOpaqueJITTargetMachineBuilder;
pub const LLVMOrcOpaqueObjectLayer = struct_LLVMOrcOpaqueObjectLayer;
pub const LLVMOrcOpaqueObjectLinkingLayer = struct_LLVMOrcOpaqueObjectLinkingLayer;
pub const LLVMOrcOpaqueIRTransformLayer = struct_LLVMOrcOpaqueIRTransformLayer;
pub const LLVMOrcOpaqueObjectTransformLayer = struct_LLVMOrcOpaqueObjectTransformLayer;
pub const LLVMOrcOpaqueIndirectStubsManager = struct_LLVMOrcOpaqueIndirectStubsManager;
pub const LLVMOrcOpaqueLazyCallThroughManager = struct_LLVMOrcOpaqueLazyCallThroughManager;
pub const LLVMOrcOpaqueDumpObjects = struct_LLVMOrcOpaqueDumpObjects;
