...
entry:
  ...
  ; Variable error_occurred allocated
...
label0:
  %5 = getelementptr inbounds [15 x i8], [15 x i8]* @.str.1, i64 0, i64 0
...
label1:
  br label %label2
label2:
  %8 = getelementptr inbounds [14 x i8], [14 x i8]* @.str.2, i64 0, i64 0
...
; String constants
@.str.3 = private unnamed_addr constant [18 x i8] c"Starting tests...\00", align 1
@.str.2 = private unnamed_addr constant [14 x i8] c"Test complete\00", align 1
@.str.4 = private unnamed_addr constant [16 x i8] c"Tests complete!\00", align 1
@.str.1 = private unnamed_addr constant [15 x i8] c"Error detected\00", align 1
@.str.0 = private unnamed_addr constant [29 x i8] c"Testing basic error handling\00", align 1
define i32 @main() {
entry:
  %0 = getelementptr inbounds [18 x i8], [18 x i8]* @.str.3, i64 0, i64 0
  %1 = call i32 @puts(i8* %0)
  %2 = add i32 0, 0
  ; Expression result: %2
  %3 = call i32 @test_basic()
  ; Expression result: %3
  %4 = getelementptr inbounds [16 x i8], [16 x i8]* @.str.4, i64 0, i64 0
