...
@.str.0 = private unnamed_addr constant [27 x i8] c"Hello from CURSED to LLVM!\00", align 1
...
define i32 @main() {
entry:
  ; String literal: Hello from CURSED to LLVM!
  %str_ptr.0 = getelementptr [27 x i8], [27 x i8]* @.str.0, i32 0, i32 0
