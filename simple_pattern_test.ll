...
define i8* @test_patterns(i32 %arg_0) personality i32 (...)* @__gxx_personality_v0 {
...
entry:
  ...
  %14 = getelementptr inbounds [6 x i8], [6 x i8]* @.str.3, i64 0, i64 0
  ret i8* null
}
...
; Function Attrs: uwtable noinline optnone
entry:
  %0 = getelementptr inbounds [13 x i8], [13 x i8]* @.str.4, i64 0, i64 0
  %1 = call i32 @test_start(i32 %0)
  %2 = call i32 @test_patterns(i32 1)
...
@.str.4 = private unnamed_addr constant [13 x i8] c"Pattern Test\00", align 1
