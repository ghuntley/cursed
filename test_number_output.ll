...
@.str.1 = private unnamed_addr constant [18 x i8] c"The answer is: 42\00", align 1
define i32 @main() {
  %0 = alloca i32, align 4
  store i32 42, i32* %0, align 4
  ; Variable number allocated at %0
  %1 = load i32, i32* %0, align 4
  %2 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.0, i64 0, i64 0
  %3 = call i32 (i8*, ...) @printf(i8* %2, i32 %1)
  %4 = getelementptr inbounds [18 x i8], [18 x i8]* @.str.1, i64 0, i64 0
  ; Converting complex expression to output
  %5 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.0, i64 0, i64 0
