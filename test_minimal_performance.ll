...
; String constants
@.str.1 = private unnamed_addr constant [25 x i8] c"Minimal performance test\00", align 1
@.str.2 = private unnamed_addr constant [14 x i8] c"test_function\00", align 1
@.str.0 = private unnamed_addr constant [10 x i8] c"Testing: \00", align 1
define i32 @main() {
  %1 = getelementptr inbounds [25 x i8], [25 x i8]* @.str.1, i64 0, i64 0
  %2 = call i32 @test_start(i32 %1)
  %3 = getelementptr inbounds [14 x i8], [14 x i8]* @.str.2, i64 0, i64 0
  %4 = call i32 @simple_load_test(i32 %3)
  %5 = alloca i1, align 4
  store i1 %4, i1* %5, align 4
  ; Variable result allocated at %5
  %6 = load i32, i32* %5, align 4
  %7 = call i32 @assert_true(i32 %6)
  %8 = call i32 @print_test_summary()
  ret i32 0
}
