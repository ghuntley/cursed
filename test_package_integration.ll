...
; String constants
@.str.0 = private unnamed_addr constant [25 x i8] c"Package integration test\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@.str.2 = private unnamed_addr constant [17 x i8] c"Integration test\00", align 1
define i32 @main() {
  ...
  %3 = getelementptr inbounds [17 x i8], [17 x i8]* @.str.2, i64 0, i64 0
  %4 = call i32 @test_start(i32 %3)
  %5 = call i32 @assert_true(i32 1)
