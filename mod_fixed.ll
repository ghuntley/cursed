...
define void @assert_eq_bool(i1 %actual, i1 %expected) {
entry:
...
entry:
  %0 = call i32 @print_test_summary()
  ; Expression result: %0
  %1 = icmp sgt i32 %test_failed, 0
  ; DEBUG FC: compile_if_statement_with_init called
  ; DEBUG FC: about to process condition
  br i1 %1, label %label0, label %label1
label0:
...
define i8* @example_test() {
entry:
  %0 = getelementptr inbounds [13 x i8], [13 x i8]* @.str.13, i64 0, i64 0
  ...
  %7 = getelementptr inbounds [6 x i8], [6 x i8]* @.str.14, i64 0, i64 0
...
@.str.13 = private unnamed_addr constant [13 x i8] c"Example Test\00", align 1
...
define i32 @main() {
  ...
  ; Variable current_test_name allocated at %4
  %5 = call i32 @example_test()
  %6 = call i32 @print_test_summary()
  ret i32 0
}
