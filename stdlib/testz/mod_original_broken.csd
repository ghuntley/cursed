...
slay next_random() drip {
    ...
    sus temp1 drip = random_state * 1103515245
    sus temp2 drip = temp1 + 12345
    sus temp3 drip = temp2 % 2147483648
    random_state = temp3
    damn random_state
}
...
slay random_int(min_val drip, max_val drip) drip {
    ...
    sus temp1 drip = max_val - min_val
    sus range drip = temp1 + 1
    sus raw_random drip = next_random()
    sus random_val drip = raw_random % range
    sus result drip = min_val + random_val
    damn result
}
