...
slay generate_html_report() tea {
    ...
    html_output = html_output + "    .pass { background-color: #d4edda; color: #155724; }\n"
    html_output = html_output + "    .fail { background-color: #f8d7da; color: #721c24; }\n"
    html_output = html_output + "    .skip { background-color: #fff3cd; color: #856404; }\n"
    html_output = html_output + "    .error { background-color: #f5c6cb; color: #721c24; }\n"
    html_output = html_output + "  </style>\n"
    html_output = html_output + "</head>\n"
