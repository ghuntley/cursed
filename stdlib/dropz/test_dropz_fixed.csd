...
slay test_file_handles() {
    ...
    sus (read_file, open_err) = dropz.open("handle_test.csd")
...
slay test_directory_operations() {
    ...
    sus is_regular_file lit = dropz.is_file("main.csd")
...
slay test_error_handling() {
    ...
    sus (file, open_err) = dropz.open("nonexistent.csd")
