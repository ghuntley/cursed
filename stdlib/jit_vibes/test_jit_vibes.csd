...
fr fr Test 1: JIT context creation
...
fr fr Test 2: Adding code to JIT buffer
...
fr fr Test 3: Setting optimization levels
...
assert_false(set_jit_optimization(&ctx3, 5)) fr fr Invalid level
print_test_summary()

fr fr Test 4: LLVM IR generation
...
fr fr Test 8: JIT context clearing
...
fr fr Test 12: Multiple code additions
...
fr fr Test 15: Complex JIT workflow
...
assert_true(len(complex_ir) > 100) fr fr Should be substantial IR
assert_true(compile_jit(&ctx15))
sus result15 := execute_jit(&ctx15)
assert_eq_int(result15, 0)
print_test_summary()

fr fr Test 16: JIT context reuse
...
fr fr Test 17: Optimization level bounds checking
...
fr fr Test 18: Statistics content validation
...
fr fr Stats should contain key information
print_test_summary()

fr fr Test 19: Execution without compilation
...
assert_eq_int(exec_fail, -1) fr fr Should fail
print_test_summary()

fr fr Test 20: JIT pipeline integration test
