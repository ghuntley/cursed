...
sus minimal_arr []drip = create_minimal_array()
...
sus bounds_test []drip = [100, 200, 300]
...
sus capacity_arr []drip = make_array_with_capacity(10)
assert_true(capacity(capacity_arr) >= 10)

// Test array memory safety
sus safe_arr []drip = [100, 200, 300]
