...
sus public_key []drip = ed25519_scalar_base_mult(test_scalar)
...
sus public_key2 []drip = ed25519_scalar_base_mult(different_scalar)
...
sus prime []drip = generate_safe_prime(bits)
...
sus prime2 []drip = generate_safe_prime(bits)
