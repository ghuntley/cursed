...
bestie i := 0; i < 20; i++ {
    ...
    # Property: counter should always be positive
    fr fr actual <= 0 {
...
mock_add_to_counter(-1)  # This might be considered an error
...
# ===============================
# Random Testing with Multiple Properties
# ===============================
...
bestie i := 0; i < 15; i++ {
    ...
    sus should_increment lit = testz_simple.random_boolean()
