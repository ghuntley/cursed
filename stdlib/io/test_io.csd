fr fr Comprehensive test suite for CURSED I/O module
yeet "testz"
yeet "io"
...
fr fr Test file size operations
...
fr fr Test file opening and closing
...
fr fr Test high-level file operations
...
fr fr Test buffered_write_line
...
fr fr Test network I/O helpers
...
fr fr Test read_json
(json_content, err) := read_json("config.json")
assert_eq_string(err, "")

fr fr Test write_json
