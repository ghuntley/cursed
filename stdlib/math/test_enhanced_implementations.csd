...
# Test enhanced mathematical function implementations
...
# Test sine of π/2 (approximately 1.5708)
sus sin_pi_half meal = math_sin_impl(1.5708)
assert_eq_float(sin_pi_half, 1.0, 0.1)  # Allow larger tolerance for approximation

# Test sine of π (approximately 3.14159)
sus sin_pi meal = math_sin_impl(3.14159)
assert_eq_float(sin_pi, 0.0, 0.1)

# Test sine of small angle
...
# Test cosine of π/2 (approximately 1.5708)
sus cos_pi_half meal = math_cos_impl(1.5708)
assert_eq_float(cos_pi_half, 0.0, 0.1)  # Allow larger tolerance for approximation

# Test cosine of π (approximately 3.14159)
sus cos_pi meal = math_cos_impl(3.14159)
assert_eq_float(cos_pi, -1.0, 0.1)

# Test cosine of small angle
