# Comprehensive test suite for binary_drip module
yeet "testz"
yeet "binary_drip"
...
# Test read_u16_le function
test_start("read_u16_le little-endian")
sus val16le mid = read_u16_le(test_data, 0)
assert_eq_int(val16le, 0x0201)  # 0x02 << 8 | 0x01
sus val16le2 mid = read_u16_le(test_data, 2)
assert_eq_int(val16le2, 0x0403)  # 0x04 << 8 | 0x03

# Test read_u16_be function
test_start("read_u16_be big-endian")
sus val16be mid = read_u16_be(test_data, 0)
assert_eq_int(val16be, 0x0102)  # 0x01 << 8 | 0x02
sus val16be2 mid = read_u16_be(test_data, 2)
assert_eq_int(val16be2, 0x0304)  # 0x03 << 8 | 0x04

# Test read_u32_le function
test_start("read_u32_le little-endian")
sus val32le normie = read_u32_le(test_data, 0)
assert_eq_int(val32le, 0x04030201)  # bytes 0x04, 0x03, 0x02, 0x01
sus val32le2 normie = read_u32_le(test_data, 4)
assert_eq_int(val32le2, 0x08070605)  # bytes 0x08, 0x07, 0x06, 0x05

# Test read_u32_be function
test_start("read_u32_be big-endian")
sus val32be normie = read_u32_be(test_data, 0)
assert_eq_int(val32be, 0x01020304)  # bytes 0x01, 0x02, 0x03, 0x04
sus val32be2 normie = read_u32_be(test_data, 4)
assert_eq_int(val32be2, 0x05060708)  # bytes 0x05, 0x06, 0x07, 0x08

# Test read_u64_le function
test_start("read_u64_le little-endian")
sus val64le thicc = read_u64_le(test_data, 0)
assert_eq_int(val64le, 0x0807060504030201)  # 8 bytes little-endian

# Test read_u64_be function
test_start("read_u64_be big-endian")
sus val64be thicc = read_u64_be(test_data, 0)
assert_eq_int(val64be, 0x0102030405060708)  # 8 bytes big-endian

# Test write_u8 function
...
assert_eq_int(out_of_bounds, 0)  # Should return 0 for out of bounds
