// Working CURSED Stringz Module Test
// Tests basic string operations with direct function calls
...
slay test_basic_stringz() {
    ...
    // Test StartsWith
    vibes stringz.StartsWith("hello world", "hello") {
    ...
    // Test EndsWith
    vibes stringz.EndsWith("hello world", "world") {
    ...
    // Test Equals
    vibes stringz.Equals("hello", "hello") {
