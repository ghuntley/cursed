...
slay test_snip_operations() {
    ...
    sus ints := normie[value]{1, 2, 3, 4, 5}
...
slay test_blender_operations() {
    ...
    sus ints := normie[value]{3, 1, 4, 1, 5}
...
slay test_twinning_operations() {
    ...
    sus ints1 := normie[value]{1, 2, 3}
    sus ints2 := normie[value]{1, 2, 3}
    sus ints3 := normie[value]{1, 2, 4}
...
slay test_special_features() {
    ...
    sus ints := normie[value]{1, 2, 3, 4, 5, 6}
