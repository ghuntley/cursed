...
slay test_bubble_sort() lit {
    sus arr drip[value] = [3, 1, 4, 1, 5, 9, 2, 6]
    sus sorted drip[value] = bubble_sort(arr)
    sus expected drip[value] = [1, 1, 2, 3, 4, 5, 6, 9]
...
slay test_quick_sort() lit {
    sus arr drip[value] = [64, 34, 25, 12, 22, 11, 90]
    sus sorted drip[value] = quick_sort(arr)
    sus expected drip[value] = [11, 12, 22, 25, 34, 64, 90]
...
slay test_merge_sort() lit {
    sus arr drip[value] = [12, 11, 13, 5, 6, 7]
    sus sorted drip[value] = merge_sort(arr)
    sus expected drip[value] = [5, 6, 7, 11, 12, 13]
...
slay test_heap_sort() lit {
    sus arr drip[value] = [4, 10, 3, 5, 1]
    sus sorted drip[value] = heap_sort(arr)
    sus expected drip[value] = [1, 3, 4, 5, 10]
...
slay test_binary_search() lit {
    sus arr drip[value] = [1, 3, 5, 7, 9, 11, 13, 15]
...
slay test_empty_array_sorting() lit {
    ...
    sus sorted drip[value] = quick_sort(empty_arr)
...
slay test_single_element() lit {
    sus single drip[value] = [42]
    sus sorted drip[value] = merge_sort(single)
...
slay test_large_array_performance() lit {
    sus large_arr drip[value] = []
    bestie (i drip = 0; i < 1000; i += 1) {
        large_arr = append(large_arr, 1000 - i)
    }
    
    sus sorted drip[value] = quick_sort(large_arr)
...
slay test_string_sorting() lit {
    sus strings tea[value] = ["zebra", "apple", "banana", "cherry"]
    sus sorted tea[value] = sort_strings(strings)
...
slay test_duplicate_elements() lit {
    sus arr drip[value] = [3, 1, 3, 1, 2, 2]
    sus sorted drip[value] = merge_sort(arr)
    sus expected drip[value] = [1, 1, 2, 2, 3, 3]
