...
# Test 3: Buffered channel creation
...
# Test 4: Buffered channel send operations
...
# Test 5: Buffered channel receive operations
...
# Test 8: Receive from closed channel
...
# Test 11: Multiple channel types
reset_channel_system()
init_channel_system()
...
# Test 14: Channel limits
reset_channel_system()
init_channel_system()

sus limit_channel normie = make_channel(MAX_BUFFER_SIZE + 1, "test")
assert_eq_int(limit_channel, -1)  # Should fail due to size limit

# Test successful creation within limits
...
# Test 15: Select statement basics
reset_channel_system()
init_channel_system()
...
# Should select first case (has data)
sus select_result normie = channel_select(cases, cap)
assert_eq_int(select_result, 0)  # First case should be selected
