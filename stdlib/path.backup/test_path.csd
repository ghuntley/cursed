...
fr fr Test absolute path checking
...
fr fr Test relative path checking
...
fr fr Test special path checking
...
path.debug_path_manager() fr fr Should print debug info
