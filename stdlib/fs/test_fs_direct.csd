fr fr Direct CURSED Filesystem Module Tests
fr fr Testing filesystem operations directly
...
vibez.spill("Starting filesystem tests...")

fr fr Test 1: Write file
sus test_path tea = "test_direct.txt"
...
vibez.spill("Basic file operations test complete!")
...
sus test_dir tea = "test_dir_direct"
...
vibez.spill("Directory operations test complete!")
...
vibez.spill("Path utilities test complete!")
...
vibez.spill("Non-existent file content: '" + nonexistent_content + "'")
