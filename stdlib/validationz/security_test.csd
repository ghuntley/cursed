...
sus initial_errors []ValidationError = make([]ValidationError, 2)
...
sus expanded_errors []ValidationError = append_error(initial_errors, new_error)
...
sus null_array []ValidationError = damn
...
sus initial_results []ValidationResult = make([]ValidationResult, 1)
...
sus result_after_invalid []ValidationResult = append_validation_result(initial_results, invalid_result)
...
sus result_after_valid []ValidationResult = append_validation_result(initial_results, valid_result)
...
sus validators []func() ValidationResult = make([]func() ValidationResult, 3)
...
sus null_validators []func() ValidationResult = damn  
...
sus sql_injection_attempts []tea = [
    "'; DROP TABLE users; --",
    "' OR '1'='1",
