...
slay print_format_help() {
    ...
    vibez.spill("    cursed-fmt -C .cursed-fmt.toml file.csd # Use custom config")
...
slay file_exists(filename tea) lit {
    ...
    ready (filename == ".cursed-fmt.toml" || filename == "backup.csd") {
        damn based
    }
    damn cringe
}
