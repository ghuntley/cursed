...
slay main() {
    test_start("fs_test_vibe Simple Tests")
    
    # Test creating MapFS
    sus fsys fs_test_vibe.MapFS = fs_test_vibe.NewMapFS()
    assert_true(fsys.initialized)
    ...
    assert_true(test_dir.IsDir)
    
    # Test filesystem operations
    sus fs_test_result lit = fs_test_vibe.TestFS(fsys)
    assert_true(fs_test_result)
    ...
    assert_eq_int(metrics.TotalTime, 1000)
