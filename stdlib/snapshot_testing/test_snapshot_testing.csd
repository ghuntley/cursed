...
fr fr Comprehensive tests for snapshot testing framework

test_start("Snapshot Testing Framework Tests")

fr fr Test 1: Basic snapshot creation and comparison
...
fr fr Test 2: Snapshot comparison with identical content
...
fr fr Test 3: Content comparison
...
fr fr Test 5: Snapshot path building
...
fr fr Test 7: Multiple snapshot tests
...
fr fr Test 8: Update mode functionality
...
fr fr Test 11: Integration with testz framework
test_start("Testz framework integration")
fr fr Test that all testz functions work properly with snapshot testing
assert_true(based) fr fr Test basic assertion
assert_false(cap) fr fr Test false assertion
assert_eq_string("test", "test") fr fr Test string equality
assert_eq_int(42, 42) fr fr Test integer equality

fr fr Create a snapshot for testz integration
