...
public class ClassName {
    ...
    private static Planet[] initSolarSystem() {
    ...
    private static void offsetMomentum(Planet[] bodies) {
    ...
    private static double energy(Planet[] bodies) {
        double e = 0.0;
    ...
    private static void advance(Planet[] bodies, double dt) {
        for (int i = 0; i < bodies.length; ++i) {
            Planet b = bodies[i];
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Energy delta: %.9f\n", finalEnergy - initialEnergy);
