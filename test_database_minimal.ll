...
@.str.0 = private unnamed_addr constant [53 x i8] c"🎉 Testing comprehensive database layer for CURSED\00", align 1
define i32 @main() {
  %0 = getelementptr inbounds [53 x i8], [53 x i8]* @.str.0, i64 0, i64 0
