fr fr Sample Math Utils Package for CURSED
fr fr Demonstrates package structure and functionality
...
fr fr/ Calculate the greatest common divisor of two numbers
...
fr fr/ Calculate the least common multiple of two numbers
slay lcm(a normie, b normie) normie {
    damn (a * b) / gcd(a, b)
}

fr fr/ Check if a number is prime
...
fr fr/ Calculate the nth Fibonacci number
...
fr fr/ Calculate the power of a number (base^exponent)
...
fr fr/ Calculate the square root using Newton's method
...
fr fr/ Calculate absolute value
...
fr fr/ Calculate the maximum of two numbers
...
fr fr/ Calculate the minimum of two numbers
...
fr fr/ Round a number to the nearest integer
...
fr fr Advanced features (only available with "advanced" feature)
...
fr fr Run tests when this module is executed directly
...
fr fr Test advanced features if available
#[cfg(feature = "statistics")]
{
