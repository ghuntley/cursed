...
@.str.0 = private unnamed_addr constant [44 x i8] c"greater") } otherwise { vibez.spill("lesser\00", align 1
...
entry:
  ...
  %str_ptr.1 = getelementptr [44 x i8], [44 x i8]* @.str.0, i32 0, i32 0
  call i32 @puts(i8* %str_ptr.1)
  %i = alloca i64, align 8
  store i64 0, i64* %i, align 8
  %str_ptr.3 = getelementptr [5 x i8], [5 x i8]* @.str.1, i32 0, i32 0
  call i32 @puts(i8* %str_ptr.3)
  %loaded.4 = load i64, i64* %i, align 8
