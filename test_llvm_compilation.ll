...
; String constants
@.str.4 = private unnamed_addr constant [17 x i8] c"Function result:\00", align 1
@.str.1 = private unnamed_addr constant [34 x i8] c"LLVM compilation test successful!\00", align 1
@.str.3 = private unnamed_addr constant [16 x i8] c"Loop iteration:\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@.str.0 = private unnamed_addr constant [1 x i8] c"\00", align 1
define i32 @main() {
  %0 = getelementptr inbounds [34 x i8], [34 x i8]* @.str.1, i64 0, i64 0
  ; Converting complex expression to output
  %1 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.2, i64 0, i64 0
  %2 = call i32 (i8*, ...) @printf(i8* %1, i32 %0)
  %3 = alloca i32, align 4
  store i32 10, i32* %3, align 4
  ; Variable count allocated at %3
...
label1:
  %8 = getelementptr inbounds [16 x i8], [16 x i8]* @.str.3, i64 0, i64 0
  ; Converting complex expression to output
...
label2:
  ...
  br label %label0
label3:
  %16 = call i32 @test_function(i32 42)
  %17 = alloca i32, align 4
  store i32 %16, i32* %17, align 4
  ; Variable result allocated at %17
  %18 = getelementptr inbounds [17 x i8], [17 x i8]* @.str.4, i64 0, i64 0
  ; Converting complex expression to output
