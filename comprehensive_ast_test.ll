...
@.str.0 = private unnamed_addr constant [9 x i8] c"Success!\00", align 1
@.str.1 = private unnamed_addr constant [13 x i8] c"Caught error\00", align 1
...
entry:
  ...
  %str_ptr.0 = getelementptr [9 x i8], [9 x i8]* @.str.0, i32 0, i32 0
  call i32 @puts(i8* %str_ptr.0)
  ; String literal: Caught error
  %str_ptr.1 = getelementptr [13 x i8], [13 x i8]* @.str.1, i32 0, i32 0
