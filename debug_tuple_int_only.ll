...
; String constants
@.str.0 = private unnamed_addr constant [14 x i8] c"created tuple\00", align 1
define i32 @main() {
  %1 = alloca { i8* }, align 8
  %2 = getelementptr inbounds { i8* }, { i8* }* %1, i32 0, i32 0
  store i8* 42, i8** %2, align 4
  %3 = alloca i32, align 4
  store i32 0, i32* %3, align 4
  ; Variable t allocated at %3
  %4 = getelementptr inbounds [14 x i8], [14 x i8]* @.str.0, i64 0, i64 0
