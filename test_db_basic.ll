...
; String constants
@.str.2 = private unnamed_addr constant [24 x i8] c"PostgreSQL support: YES\00", align 1
@.str.5 = private unnamed_addr constant [23 x i8] c"Database test complete\00", align 1
@.str.3 = private unnamed_addr constant [19 x i8] c"MySQL support: YES\00", align 1
@.str.4 = private unnamed_addr constant [20 x i8] c"SQLite support: YES\00", align 1
@.str.0 = private unnamed_addr constant [23 x i8] c"Database test starting\00", align 1
...
define i32 @main() {
  ...
  %3 = getelementptr inbounds [24 x i8], [24 x i8]* @.str.2, i64 0, i64 0
  ; Converting complex expression to output
  %4 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.1, i64 0, i64 0
  %5 = call i32 (i8*, ...) @printf(i8* %4, i32 %3)
  %6 = getelementptr inbounds [19 x i8], [19 x i8]* @.str.3, i64 0, i64 0
  ; Converting complex expression to output
  %7 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.1, i64 0, i64 0
  %8 = call i32 (i8*, ...) @printf(i8* %7, i32 %6)
  %9 = getelementptr inbounds [20 x i8], [20 x i8]* @.str.4, i64 0, i64 0
  ; Converting complex expression to output
