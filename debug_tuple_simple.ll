...
@.str.1 = private unnamed_addr constant [14 x i8] c"Tuple created\00", align 1
@.str.2 = private unnamed_addr constant [15 x i8] c"First element:\00", align 1
define i32 @main() {
  ...
  ; Variable my_tuple allocated at %5
  %6 = getelementptr inbounds [14 x i8], [14 x i8]* @.str.1, i64 0, i64 0
  ...
  ; Variable first allocated at %11
  %12 = getelementptr inbounds [15 x i8], [15 x i8]* @.str.2, i64 0, i64 0
