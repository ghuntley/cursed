...
; String constants
@.str.0 = private unnamed_addr constant [35 x i8] c"Testing exec_slay module import...\00", align 1
@.str.2 = private unnamed_addr constant [23 x i8] c"Basic test successful:\00", align 1
...
define i32 @main() {
  ...
  %4 = getelementptr inbounds [23 x i8], [23 x i8]* @.str.2, i64 0, i64 0
  ; Converting complex expression to output
