...
./zig-out/bin/cursed-compiler test_simple_output.💀 --mode interpret 2>/dev/null | grep -v "DEBUG\|ERROR\|INFO\|==="

echo "--- Compile Mode ---"
./zig-out/bin/cursed-compiler test_simple_output.💀 --mode compile -o test_simple_compiled 2>/dev/null
...
echo "--- Interpreter Mode ---"
./zig-out/bin/cursed-compiler test_mathz_simple.💀 --mode interpret 2>/dev/null | grep -v "DEBUG\|ERROR\|INFO\|==="

echo "--- Compile Mode ---" 
./zig-out/bin/cursed-compiler test_mathz_simple.💀 --mode compile -o test_mathz_compiled 2>/dev/null
...
# Cleanup
rm -f test_mathz_simple.💀 test_simple_output.💀 test_simple_compiled test_mathz_compiled
