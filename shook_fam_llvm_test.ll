...
@.str.0 = private unnamed_addr constant [19 x i8] c"Caught LLVM error:\00", align 1
...
define i64 @test_llvm_error_handling() {
entry:
  ret i64 0
}
...
define i32 @main() {
entry:
  %risky = alloca i64, align 8
  store i64 0, i64* %risky, align 8
  %str_ptr.1 = getelementptr [19 x i8], [19 x i8]* @.str.0, i32 0, i32 0
  call i32 @puts(i8* %str_ptr.1)
  %result = alloca i64, align 8
  %call_result.2 = call i64 @test_llvm_error_handling()
  store i64 %call_result.2, i64* %result, align 8
