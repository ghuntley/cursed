...
; String constants
@.str.0 = private unnamed_addr constant [8 x i8] c"integer\00", align 1
...
entry:
  ...
  %2 = call i8* @cursed_get_runtime_type_info(i8* null)
  %3 = add i1 0, 1
  br i1 %3, label %typeswitch_arm_0_1, label %typeswitch_check_1
typeswitch_arm_0_1:
  %3 = getelementptr inbounds [8 x i8], [8 x i8]* @.str.0, i64 0, i64 0
  %4 = bitcast i8* %3 to i8*
  br label %typeswitch_exit_0
  %5 = add i1 0, 0
  br i1 %5, label %typeswitch_arm_1_1, label %typeswitch_check_2
typeswitch_arm_1_1:
  %5 = getelementptr inbounds [7 x i8], [7 x i8]* @.str.1, i64 0, i64 0
  %6 = bitcast i8* %5 to i8*
  br label %typeswitch_exit_0
  %7 = add i1 0, 1
  br i1 %7, label %typeswitch_arm_2_1, label %typeswitch_default_1
typeswitch_arm_2_1:
...
typeswitch_default_1:
  ...
  unreachable
typeswitch_exit_0:
  %9 = phi i8* [ %9, %typeswitch_arm_0_1 ], [ %9, %typeswitch_arm_1_1 ], [ %9, %typeswitch_arm_2_1 ]
