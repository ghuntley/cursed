...
define i32 @add_numbers(i32 %x, i32 %y) {
entry:
  %1 = add i32 %x, %y
  ret i32 %1
}
...
; String constants
@.str.0 = private unnamed_addr constant [9 x i8] c"5 + 10 =\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
define i32 @main() {
  %1 = call i32 @add_numbers(i32 5, i32 10)
  %2 = alloca i32, align 4
  store i32 %1, i32* %2, align 4
  ; Variable result allocated at %2
  %3 = getelementptr inbounds [9 x i8], [9 x i8]* @.str.0, i64 0, i64 0
