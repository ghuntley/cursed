module.exports = grammar({
    ...
    rules: {
      ...
      method_receiver: $ => prec(1, seq(
        '(',
        optional($.identifier),
        choice($.pointer_type, $.type),
        ')'
      )),
      ...
      go_statement: $ => seq(
       ...
       error_statement: $ => choice(
         seq('yikes', field('value', $.expression)),
         seq('yikes', field('variable', $.identifier), ':=', field('value', $.expression))
       ),

       recovery_statement: $ => prec(1, seq(
         'fam',
         field('body', $.block),
         optional(seq(
           'sus',
