...
@.str.0 = private unnamed_addr constant [31 x i8] c"Testing basic functionality...\00", align 1
@.str.2 = private unnamed_addr constant [29 x i8] c"Test completed successfully!\00", align 1
define i32 @main() {
