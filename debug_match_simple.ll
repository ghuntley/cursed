...
@.str.0 = private unnamed_addr constant [6 x i8] c"found\00", align 1
...
entry:
  ...
  %3 = icmp eq i32 %1, 42
  br i1 %3, label %label0, label %label3
label0:
  %3 = getelementptr inbounds [6 x i8], [6 x i8]* @.str.0, i64 0, i64 0
  br label %label4
label6:
  br label %label3
label3:
  br label %label2
label2:
  %3 = getelementptr inbounds [10 x i8], [10 x i8]* @.str.1, i64 0, i64 0
  br label %label4
label7:
label5:
  ; Non-exhaustive match - panic
  call void @panic_non_exhaustive_match()
  unreachable
label4:
  %2 = phi i8* [ %3, %label6 ], [ %3, %label7 ]
  %4 = alloca i8*, align 4
