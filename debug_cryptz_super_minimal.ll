...
; String constants
@.str.0 = private unnamed_addr constant [24 x i8] c"Starting cryptz test...\00", align 1
@.str.2 = private unnamed_addr constant [21 x i8] c"Cryptz module loaded\00", align 1
...
define i32 @main() {
  ...
  %3 = getelementptr inbounds [21 x i8], [21 x i8]* @.str.2, i64 0, i64 0
  ; Converting complex expression to output
