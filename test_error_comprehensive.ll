...
; String constants
@.str.0 = private unnamed_addr constant [30 x i8] c"Testing error handling system\00", align 1
...
@.str.4 = private unnamed_addr constant [27 x i8] c"Error created successfully\00", align 1
@.str.5 = private unnamed_addr constant [29 x i8] c"Error handling test complete\00", align 1
...
define i32 @main() {
  ...
  %5 = getelementptr inbounds [27 x i8], [27 x i8]* @.str.4, i64 0, i64 0
  ; Converting complex expression to output
  %6 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.1, i64 0, i64 0
  %7 = call i32 (i8*, ...) @printf(i8* %6, i32 %5)
  %8 = getelementptr inbounds [29 x i8], [29 x i8]* @.str.5, i64 0, i64 0
  ; Converting complex expression to output
