...
@.str.0 = private unnamed_addr constant [161 x i8] c"Testing print - this should work") fr fr Test core functions directly sus timestamp_nanos normie = core.get_timestamp_nanos() vibez.spill("Core timestamp nanos:\00", align 1
