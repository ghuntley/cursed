...
slay main_character() {
    ...
    sus result_sub normie = mathz.subtract(50, 23)
    vibez.spill("50 - 23 =")
    vibez.spill(result_sub)
    
    sus result_mul normie = mathz.multiply(7, 8)
    vibez.spill("7 * 8 =")
    vibez.spill(result_mul)
    
    sus result_div normie = mathz.divide(84, 4)
    vibez.spill("84 / 4 =")
    ...
    vibez.spill("=== MATHZ VALIDATION COMPLETE ===")
}
