...
declare i64 @multiply_numbers(...)
declare i64 @subtract_and_double(...)

define i32 @main() {
entry:
  ; Variable: result2
  %result2 = alloca i64, align 8
  %result2_call = call i64 @subtract_and_double(i64 10, i64 5)
  store i64 %result2_call, ptr %result2, align 8
  ; Variable: result1
  %result1 = alloca i64, align 8
  %result1_call = call i64 @multiply_numbers(i64 10, i64 5)
  ...
  ; Call: vibez.spill
  %result1_call_0 = call i64 @multiply_numbers(i64 10, i64 5)
  call void @cursed_runtime_spill_int(i64 %result1_call_0)
  ; Call: vibez.spill
  call void @cursed_runtime_spill_string(ptr @.str.2)
  ; Call: vibez.spill
  %result2_call_1 = call i64 @subtract_and_double(i64 10, i64 5)
