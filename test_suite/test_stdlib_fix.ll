...
entry:
  ...
  ; Variable: final_text
  %final_text = alloca i64, align 8
  store i64 0, ptr %final_text, align 8
  ; Variable: text1
  ...
  ; Variable: num_str
  %num_str = alloca i64, align 8
  store i64 0, ptr %num_str, align 8
  ; Variable: num1
...
@.str.13 = private unnamed_addr constant [14 x i8] c"Final length:\00", align 1
@.str.14 = private unnamed_addr constant [34 x i8] c"Stdlib integration test completed\00", align 1
