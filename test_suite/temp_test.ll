...
entry:
  ...
  ; Call: vibez.spill
  %x_load_0 = load i64, ptr %x, align 8
  call void @cursed_runtime_spill_int(i64 %x_load_0)
  ; Call: vibez.spill
  call void @cursed_runtime_spill_string(ptr @.str.2)
  ; Call: vibez.spill
  %y_load_1 = load i64, ptr %y, align 8
  call void @cursed_runtime_spill_int(i64 %y_load_1)
  ; Call: vibez.spill
  call void @cursed_runtime_spill_string(ptr @.str.4)
  ; Call: vibez.spill
  %name_load_2 = load ptr, ptr %name, align 8
  call void @cursed_runtime_spill_string(ptr %name_load_2)
  ; Call: vibez.spill
