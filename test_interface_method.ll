...
define i32 @main() {
  ; Interface definition: Greeter
%interface.Greeter.vtable = type { i8* (i8*, i8*)* }
%interface.Greeter = type { i8*, %interface.Greeter.vtable* }
@interface.Greeter.descriptor = global { i8* getelementptr inbounds [8x i8], [8x i8]* @interface.Greeter.name, i32 0, i32 0, i32 1 }
@interface.Greeter.name = private unnamed_addr constant [8 x i8] c"Greeter\00"
  ret i32 0
}
