...
; String constants
@.str.10 = private unnamed_addr constant [57 x i8] c"Contract testing framework basic functionality verified!\00", align 1
@.str.2 = private unnamed_addr constant [14 x i8] c"test_contract\00", align 1
@.str.7 = private unnamed_addr constant [10 x i8] c"/api/test\00", align 1
@.str.9 = private unnamed_addr constant [9 x i8] c"response\00", align 1
@.str.4 = private unnamed_addr constant [9 x i8] c"TestImpl\00", align 1
@.str.6 = private unnamed_addr constant [10 x i8] c"test_data\00", align 1
@.str.0 = private unnamed_addr constant [24 x i8] c"Simple contract testing\00", align 1
@.str.1 = private unnamed_addr constant [12 x i8] c"UserService\00", align 1
@.str.3 = private unnamed_addr constant [14 x i8] c"TestInterface\00", align 1
@.str.5 = private unnamed_addr constant [12 x i8] c"test_schema\00", align 1
@.str.8 = private unnamed_addr constant [7 x i8] c"schema\00", align 1
define i32 @main() {
  %1 = getelementptr inbounds [24 x i8], [24 x i8]* @.str.0, i64 0, i64 0
  %2 = call i32 @test_start(i32 %1)
  %3 = getelementptr inbounds [12 x i8], [12 x i8]* @.str.1, i64 0, i64 0
  %4 = getelementptr inbounds [14 x i8], [14 x i8]* @.str.2, i64 0, i64 0
  %5 = call i32 @contract_test(i32 %3, i32 %4)
  %6 = alloca i1, align 4
  store i1 %5, i1* %6, align 4
  ; Variable result1 allocated at %6
  %7 = load i32, i32* %6, align 4
  %8 = call i32 @assert_true(i32 %7)
  %9 = getelementptr inbounds [14 x i8], [14 x i8]* @.str.3, i64 0, i64 0
  %10 = getelementptr inbounds [9 x i8], [9 x i8]* @.str.4, i64 0, i64 0
  %11 = call i32 @verify_interface_contract(i32 %9, i32 %10)
  %12 = alloca i1, align 4
  store i1 %11, i1* %12, align 4
  ; Variable result2 allocated at %12
  %13 = load i32, i32* %12, align 4
  %14 = call i32 @assert_true(i32 %13)
  %15 = getelementptr inbounds [12 x i8], [12 x i8]* @.str.5, i64 0, i64 0
  %16 = getelementptr inbounds [10 x i8], [10 x i8]* @.str.6, i64 0, i64 0
  %17 = call i32 @schema_validation_test(i32 %15, i32 %16)
  %18 = alloca i1, align 4
  store i1 %17, i1* %18, align 4
  ; Variable result3 allocated at %18
  %19 = load i32, i32* %18, align 4
  %20 = call i32 @assert_true(i32 %19)
  %21 = getelementptr inbounds [10 x i8], [10 x i8]* @.str.7, i64 0, i64 0
  %22 = getelementptr inbounds [7 x i8], [7 x i8]* @.str.8, i64 0, i64 0
  %23 = getelementptr inbounds [9 x i8], [9 x i8]* @.str.9, i64 0, i64 0
  %24 = call i32 @validate_api_contract(i32 %21, i32 %22, i32 %23)
  %25 = alloca i1, align 4
  store i1 %24, i1* %25, align 4
  ; Variable result4 allocated at %25
  %26 = load i32, i32* %25, align 4
  %27 = call i32 @assert_true(i32 %26)
  %28 = call i32 @calculate_contract_coverage(i32 10, i32 8)
  %29 = alloca double, align 4
  store double %28, double* %29, align 4
  ; Variable coverage allocated at %29
  %30 = load i32, i32* %29, align 4
  %31 = icmp eq i32 %30, 100
  %32 = call i32 @assert_true(i32 %31)
  %33 = call i32 @print_test_summary()
  %34 = getelementptr inbounds [57 x i8], [57 x i8]* @.str.10, i64 0, i64 0
