...
; String constants
@.str.2 = private unnamed_addr constant [26 x i8] c"Basic arithmetic result: \00", align 1
@.str.0 = private unnamed_addr constant [38 x i8] c"Testing LLVM optimization integration\00", align 1
