...
@.str.1 = private unnamed_addr constant [17 x i8] c"created test_obj\00", align 1
define i32 @main() {
entry:
  ...
  ; Variable test_obj allocated at %3
  %4 = getelementptr inbounds [17 x i8], [17 x i8]* @.str.1, i64 0, i64 0
  %5 = call i32 @puts(i8* %4)
  ; ERROR RECOVERY: Statement compilation failed: Compiler error: Complex function calls not yet supported
  ret i32 0
}

; COMPILATION SUMMARY: 1 errors encountered, 1 statements recovered
; WARNING: Error 1: Compiler error: Complex function calls not yet supported
