...
@.str.0 = private unnamed_addr constant [11 x i8] c"Result is:\00", align 1
define i32 @main() {
entry:
  ...
  %3 = getelementptr inbounds [11 x i8], [11 x i8]* @.str.0, i64 0, i64 0
  %4 = alloca i8*, align 4
  store i8* %3, i8** %4, align 4
  ; Variable msg allocated at %4
