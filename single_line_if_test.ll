...
@.str.0 = private unnamed_addr constant [54 x i8] c"true branch") } otherwise { vibez.spill("false branch\00", align 1
...
define i32 @main() {
entry:
  %str_ptr.0 = getelementptr [54 x i8], [54 x i8]* @.str.0, i32 0, i32 0
